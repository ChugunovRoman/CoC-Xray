...
void target_selector::add_evaluators() {
  ...
  add_evaluator(eWorldPropertyLoopholeTooMuchTimeFiring,
                xr_new<CPropertyEvaluatorMember<animation_planner>>(
                    (CPropertyStorage *)0,
                    eWorldPropertyLoopholeTooMuchTimeFiring, true, true,
...
void target_selector::add_actions() {
  ...
  action =
      xr_new<target_idle>(&object(), "idle", eWorldPropertyLoopholeIdle, 0);
  //	add_condition			(action,
  //eWorldPropertyLoopholeCanFireAtEnemy, true); 	add_condition
  //(action, eWorldPropertyLoopholeCanFire, true); 	add_condition
  //(action, eWorldPropertyLookedOut, true); 	add_condition
  // (action, eWorldPropertyLoopholeLastHitWasLongAgo,	true);
  ...
  action =
      xr_new<target_provider>(&object(), "lookout", eWorldPropertyLookedOut, 0);
  ...
  action =
      xr_new<target_fire>(&object(), "fire", eWorldPropertyLoopholeFire, 0);
