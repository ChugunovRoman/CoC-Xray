...
u32 const data_max_chunk_size =
    4096; // 4Kb on update ~	80		Kb/sec
...
enum ft_command_t // command byte to M_FILE_TRANSFER message ...
{
  ...
  abort_receive =
      0x01, // this command send by source site, if he aborts file receiving ..
  receive_rejected =
      0x02 // this command send by dest site, if he doesn't want file..
};

typedef fastdelegate::FastDelegate3<sending_status_t, u32, u32>
    sending_state_callback_t;
typedef fastdelegate::FastDelegate3<receiving_status_t, u32, u32>
