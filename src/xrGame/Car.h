...
private:
  ...
  static void ActorObstacleCallback(bool &do_colide, bool bo1, dContact &c,
...
public:
  ...
  float m_power_neutral_factor; // multiplier for power when accelerator is not
                                // pressed (0-1,0.25)
  bool b_exploded;
  ...
  struct SCarSound {
    ...
    float volume;
    u32 engine_start_delay; // snd_engine starts after engine_start_delay ms by
                            // snd_engine_start
...
public:
  ...
  // Hits
  virtual void HitSignal(float /**HitAmount/**/, Fvector & /**local_dir/**/,
