...
IC bool CLevelGraph::intersect(Fvector &dst, const Fvector &v1,
...
IC float CLevelGraph::compute_square(float fAngle, float fAngleOfView, float b1,
                                     float b0, float b3, float b2) const {
...
IC float
CLevelGraph::compute_high_square(float fAngle, float fAngleOfView,
                                 const CLevelGraph::CVertex *vertex) const {
...
IC float
CLevelGraph::compute_low_square(float fAngle, float fAngleOfView,
                                const CLevelGraph::CVertex *vertex) const {
  return (compute_square(
      fAngle, fAngleOfView, NORMALIZE_NODE_COVER_LOW(vertex, 0),
...
IC float
CLevelGraph::vertex_high_cover(const CLevelGraph::CVertex *vertex) const {
  float _cover = 0.f;
...
IC float
CLevelGraph::vertex_low_cover(const CLevelGraph::CVertex *vertex) const {
  float _cover = 0.f;
...
IC float
CLevelGraph::high_cover_in_direction(float angle,
                                     const CLevelGraph::CVertex *vertex) const {
...
IC float
CLevelGraph::low_cover_in_direction(float angle,
                                    const CLevelGraph::CVertex *vertex) const {
...
IC u32 CLevelGraph::check_position_in_direction(
    u32 start_vertex_id, const Fvector &start_position,
