...
private:
  ...
  CObject *TryPick(Fvector const &start_pos, Fvector const &dir,
                   float const dist);
  ...
  public:
    best_victim_selector(u16 except_id, Fvector const &pos,
  ...
  static bool
  shapes_compare_predicate(victims_shapes_list_t::value_type const &left,
  ...
  void fill_shots_list(victims_shapes_list_t &victims_shapres,
                       Fsphere const &query, shot_targets_t &dest_shots);
