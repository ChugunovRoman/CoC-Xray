...
#define WRITE_TO_LOG(S)                                                        \
  {                                                                            \
    Msg("%s,%s,%d,p[%.2f,%.2f,%.2f],%.2f,h[%.2f,%.2f],t[%.2f,%.2f]", *cName(), \
        S, Device.dwTimeGlobal, Position().x, Position().y, Position().z,      \
        m_fCurSpeed, m_head.current.yaw, m_head.target.yaw,                    \
...
extern u32 dwfChooseAction(u32 dwActionRefreshRate, float fMinProbability0,
