...
void CAI_Rat::update_morale() {
  ...
  case aiRatFreePassive: {
    if (m_fMorale < m_fMoraleNormalValue) {
      m_fMorale +=
          m_fMoraleRestoreQuant; //*(1.f - fDistance/m_fMoraleNullRadius);
      if (m_fMorale > m_fMoraleNormalValue)
  ...
  case aiRatUnderFire:
  case aiRatRetreat: {
    // m_fMorale += fDistance <= m_fMoraleNullRadius ? m_fMoraleRestoreQuant :
    // 0; m_fMorale += m_fMoraleRestoreQuant*(m_fMoraleNullRadius/fDistance);
