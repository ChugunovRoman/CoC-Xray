...
void CAI_Flesh::Load(LPCSTR section) {
  ...
  anim().AddAnim(eAnimAttackFromBack, "stand_attack_back_", -1, &velocity_none,
                 PS_STAND);
...
bool CAI_Flesh::ConeSphereIntersection(Fvector ConeVertex, float ConeAngle,
                                       Fvector ConeDir, Fvector SphereCenter,
                                       float SphereRadius) {
