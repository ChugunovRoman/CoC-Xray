...
//////////////////////////////////////////////////////////////////////////
void CControlManagerCustom::ta_fill_data(SAnimationTripleData &data, LPCSTR s1,
                                         LPCSTR s2, LPCSTR s3,
...
void CControlManagerCustom::seq_init() {
  ...
  SAnimationSequencerData *ctrl_data = (SAnimationSequencerData *)m_man->data(
...
void CControlManagerCustom::load_jump_data(LPCSTR s1, LPCSTR s2, LPCSTR s3,
                                           LPCSTR s4, u32 vel_mask_prepare,
...
void CControlManagerCustom::add_rotation_jump_data(LPCSTR left1, LPCSTR left2,
                                                   LPCSTR right1, LPCSTR right2,
...
void CControlManagerCustom::critical_wound(LPCSTR anim) {
  ...
  SControlCriticalWoundData *ctrl_data =
      (SControlCriticalWoundData *)m_man->data(this,
