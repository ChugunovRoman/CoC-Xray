...
void CPseudoGigant::Load(LPCSTR section) {
  ...
  // eAnimRunTurnRight); anim().accel_chain_add		(eAnimWalkDamaged,
  // eAnimRunDamaged);
  ...
  anim().AddAnim(eAnimRun, "stand_walk_fwd_", -1, &velocity_walk, PS_STAND,
                 "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
  anim().AddAnim(eAnimRunDamaged, "stand_walk_fwd_dmg_", -1, &velocity_walk_dmg,
                 PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
                 "fx_stand_r");
  ...
  // &velocity_turn,		PS_STAND, "fx_stand_f", "fx_stand_b",
  // "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimStandTurnRight,
  // "stand_turn_rs_",		-1, &velocity_turn,		PS_STAND,
  // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
  // anim().AddAnim(eAnimLieIdle, "stand_sleep_",			-1,
  // &velocity_none,		PS_LIE, "fx_stand_f", "fx_stand_b",
  // "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimSitIdle,
  // "sit_idle_",			-1, &velocity_none, PS_SIT,
  // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
  // anim().AddAnim(eAnimSleep,			"stand_sleep_",
  // -1, &velocity_none,		PS_LIE,		"fx_stand_f",
  // "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimWalkFwd,
  // "stand_walk_fwd_",		-1, &velocity_walk,		PS_STAND,
  // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
  // anim().AddAnim(eAnimWalkDamaged,	"stand_walk_fwd_dmg_",	-1,
  // &velocity_walk_dmg,	PS_STAND,	"fx_stand_f", "fx_stand_b",
  ...
  // -1, &velocity_run_dmg,	PS_STAND,	"fx_stand_f", "fx_stand_b",
  // "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimEat,
  // "stand_eat_", -1, &velocity_none,		PS_STAND,	"fx_stand_f",
  // "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimAttack,
  ...
  // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
  // anim().AddAnim(eAnimDie,			"stand_idle_",			-1,
  // &velocity_none, PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l",
  // "fx_stand_r"); anim().AddAnim(eAnimStandLieDown,	"stand_lie_down_",
  // -1, &velocity_none,		PS_STAND,	"fx_stand_f",
  // "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimLieToSleep,
  // "lie_to_sleep_",		-1, &velocity_none,		PS_LIE,
  // "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
  // anim().AddAnim(eAnimThreaten,		"stand_kick_",
  // -1, &velocity_none,		PS_STAND,	"fx_stand_f",
  // "fx_stand_b", "fx_stand_l", "fx_stand_r");

  // 	anim().AddAnim(eAnimRunTurnLeft,	"stand_run_left_",
  // -1, &velocity_run,		PS_STAND); anim().AddAnim(eAnimRunTurnRight,
  // "stand_run_right_",		-1, &velocity_run,
  // PS_STAND);
  ...
  ::Sound->create(m_sound_threaten_hit,
                  pSettings->r_string(section, "sound_threaten_hit"), st_Effect,
                  SOUND_TYPE_WORLD);
...
void CPseudoGigant::on_threaten_execute() {
  ...
  for (u32 i = 0; i < m_nearest.size(); i++) {
    ...
    dir.normalize();
    obj->m_pPhysicsShell->applyImpulse(dir,
                                       20 * obj->m_pPhysicsShell->getMass());
  }
