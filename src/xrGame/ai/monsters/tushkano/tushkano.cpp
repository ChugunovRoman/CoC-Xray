...
void CTushkano::Load(LPCSTR section) {
  ...
  // anim().AddAnim(eAnimStandDamaged,	"stand_idle_dmg_",		-1,
  // &velocity_none,				PS_STAND);
  anim().AddAnim(eAnimStandTurnLeft, "stand_turn_left_", -1, &velocity_turn,
                 PS_STAND);
  anim().AddAnim(eAnimStandTurnRight, "stand_turn_right_", -1, &velocity_turn,
                 PS_STAND);
  ...
  // &velocity_none, PS_SIT); anim().AddAnim(eAnimSitStandUp,
  // "sit_stand_up_",		-1, &velocity_none,
  // PS_SIT); anim().AddAnim(eAnimStandSitDown,	"stand_sit_down_",
