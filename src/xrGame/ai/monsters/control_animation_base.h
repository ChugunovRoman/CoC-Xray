...
public:
  ...
  void AddAnim(EMotionAnim ma, LPCSTR tn, int s_id, SVelocityParam *vel,
               EPState p_s);
  void AddAnim(EMotionAnim ma, LPCSTR tn, int s_id, SVelocityParam *vel,
  ...
  void AddTransition(EMotionAnim from, EMotionAnim to, EMotionAnim trans,
                     bool chain, bool skip_aggressive = false);
  void AddTransition(EMotionAnim from, EPState to, EMotionAnim trans,
                     bool chain, bool skip_aggressive = false);
  void AddTransition(EPState from, EMotionAnim to, EMotionAnim trans,
                     bool chain, bool skip_aggressive = false);
  ...
  void AddReplacedAnim(bool *b_flag, EMotionAnim pmt_cur_anim,
...
public:
  ...
  bool accel_chain_get(float cur_speed, EMotionAnim target_anim,
...
public:
  ...
  bool get_animation_info(EMotionAnim anim, u32 index, MotionID &motion,
                          float &length) const;
