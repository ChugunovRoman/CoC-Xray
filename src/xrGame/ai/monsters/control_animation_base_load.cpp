...
void CControlAnimationBase::AddAnim(EMotionAnim ma, LPCSTR tn, int s_id,
                                    SVelocityParam *vel, EPState p_s,
...
void CControlAnimationBase::AddTransition(EMotionAnim from, EMotionAnim to,
                                          EMotionAnim trans, bool chain,
...
void CControlAnimationBase::AddTransition(EMotionAnim from, EPState to,
                                          EMotionAnim trans, bool chain,
                                          bool skip_aggressive) {
  STransition new_item;
...
void CControlAnimationBase::AddTransition(EPState from, EMotionAnim to,
                                          EMotionAnim trans, bool chain,
                                          bool skip_aggressive) {
  STransition new_item;
...
void CControlAnimationBase::AddTransition(EPState from, EPState to,
                                          EMotionAnim trans, bool chain,
                                          bool skip_aggressive) {
  STransition new_item;
