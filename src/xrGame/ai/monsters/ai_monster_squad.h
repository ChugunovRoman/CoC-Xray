...
class CMonsterSquad {
public:
  DEFINE_MAP(const CEntity *, SSquadCommand, MEMBER_COMMAND_MAP,
...
public:
  squad_grouping_behaviour(CEntity *self, Fvector cohesion_factor,
                           Fvector separate_factor, float max_separate_range);
