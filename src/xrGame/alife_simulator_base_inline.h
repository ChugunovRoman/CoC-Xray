...
IC const CALifeSmartTerrainRegistry &
CALifeSimulatorBase::smart_terrains() const {
  VERIFY(initialized());
...
IC inventory::upgrade::Manager &
CALifeSimulatorBase::inventory_upgrade_manager() const {
  VERIFY(initialized());
