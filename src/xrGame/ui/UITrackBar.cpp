...
CUITrackBar::CUITrackBar()
    : m_f_min(0), m_f_max(1), m_f_val(0), m_f_opt_backup_value(0),
      m_f_step(0.01f), m_b_is_float(true), m_b_invert(false) {
...
void CUITrackBar::UpdatePosRelativeToMouse() {
  ...
  __fval =
      (__fmax - __fmin) * (fpos - btn_width / 2) / (window_width - btn_width) +
      __fmin;
