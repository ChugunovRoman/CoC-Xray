...
void ui_actor_state_wnd::UpdateActorInfo(CInventoryOwner *owner) {
  ...
  // fire burn protection progress bar
  {
    ...
    xr_sprintf(buf, sizeof(buf), "%s: %2.2f/%2.2f",
               *m_state[stt_fire]->m_hint_description_base, burn_value,
               max_power);
  ...
  // radiation protection progress bar
  {
    ...
    xr_sprintf(buf, sizeof(buf), "%s: %2.2f/%2.2f",
               *m_state[stt_radia]->m_hint_description_base, radi_value,
               max_power);
  ...
  // chemical burn protection progress bar
  {
    ...
    xr_sprintf(buf, sizeof(buf), "%s: %2.2f/%2.2f",
               *m_state[stt_acid]->m_hint_description_base, cmbn_value,
               max_power);
  ...
  // telepatic protection progress bar
  {
    ...
    xr_sprintf(buf, sizeof(buf), "%s: %2.2f/%2.2f",
               *m_state[stt_psi]->m_hint_description_base, tele_value,
               max_power);
  ...
  // wound protection progress bar
  {
    ...
    xr_sprintf(buf, sizeof(buf), "%s: %2.2f/%2.2f",
               *m_state[stt_wound]->m_hint_description_base, woun_value,
               max_power);
  ...
  // shock protection progress bar
  {
    ...
    xr_sprintf(buf, sizeof(buf), "%s: %2.2f/%2.2f",
               *m_state[stt_shock]->m_hint_description_base, shoc_value,
               max_power);
  ...
  // fire wound protection progress bar
  {
    ...
    xr_sprintf(buf, sizeof(buf), "%s: %2.2f/%2.2f",
               *m_state[stt_fire_wound]->m_hint_description_base, fwou_value,
               max_power);
  ...
  // power restore speed progress bar
  {
    ...
    xr_sprintf(buf, sizeof(buf), "%s: %2.2f",
               *m_state[stt_power]->m_hint_description_base, value);
...
void ui_actor_state_item::init_from_xml(CUIXml &xml, LPCSTR path) {
  ...
  m_hint_description_base =
      CStringTable().translate(xml.Read("hint_text", 0, "no hint"));
