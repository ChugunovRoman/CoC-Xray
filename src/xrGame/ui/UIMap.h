...
public:
  ...
  virtual bool GetPointerTo(
      const Fvector2 &src, float item_radius, Fvector2 &pos,
...
protected:
  virtual void Init_internal(const shared_str &name, CInifile &pLtx,
...
public:
  ...
  float CalcOpenRect(const Fvector2 &center_point, Frect &map_desired_rect,
                     float tgt_zoom);
