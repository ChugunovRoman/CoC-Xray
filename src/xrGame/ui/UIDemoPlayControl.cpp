...
void CUIDemoPlayControl::Init() {
  ...
  CUIXmlInit::Init3tButton(xml_doc, "demo_play_control:btn_restart", 0,
                           m_restart_btn);
  CUIXmlInit::Init3tButton(xml_doc, "demo_play_control:btn_decrease_speed", 0,
                           m_decrease_speed_btn);
  CUIXmlInit::Init3tButton(xml_doc, "demo_play_control:btn_play_pause", 0,
                           m_play_pause_btn);
  CUIXmlInit::Init3tButton(xml_doc, "demo_play_control:btn_increase_speed", 0,
                           m_increase_speed_btn);
  ...
  CUIXmlInit::InitWindow(xml_doc, "demo_play_control:rewind_property_boxes", 0,
                         &tmp_prop_boxes_wnd);
  ...
  AddCallback(
      m_play_pause_btn, BUTTON_CLICKED,
  ...
  AddCallback(
      m_rewind_until_btn, BUTTON_CLICKED,
  ...
  AddCallback(
      m_repeat_rewind_btn, BUTTON_CLICKED,
...
void CUIDemoPlayControl::InitRewindTypeList() {
  ...
  m_rewind_type->AddItem(st.translate("mpd_rewind_until_start").c_str(), NULL,
                         eRewindUntilStart);
  m_rewind_type->AddItem(st.translate("mpd_rewind_until_kill").c_str(), NULL,
                         eRewindUntilKill);
  m_rewind_type->AddItem(st.translate("mpd_rewind_until_die").c_str(), NULL,
                         eRewindUntilDie);
  m_rewind_type->AddItem(st.translate("mpd_rewind_until_arttake").c_str(), NULL,
                         eRewindUntilArtTake);
  m_rewind_type->AddItem(st.translate("mpd_rewind_until_artdrop").c_str(), NULL,
                         eRewindUntilArtDrop);
  m_rewind_type->AddItem(st.translate("mpd_rewind_until_artdeliver").c_str(),
                         NULL, eRewindUntilArtDeliver);
...
void CUIDemoPlayControl::OnRepeatRewind(CUIWindow *w, void *d) {
  ...
  case eRewindUntilArtTake: {
    rewind_result = m_demo_play_control->rewind_until(
        demoplay_control::on_artefactcapturing, m_last_rewind_target, tmpcb);
  }; break;
  case eRewindUntilArtDrop: {
    rewind_result = m_demo_play_control->rewind_until(
        demoplay_control::on_artefactloosing, m_last_rewind_target, tmpcb);
  }; break;
  case eRewindUntilArtDeliver: {
    rewind_result = m_demo_play_control->rewind_until(
        demoplay_control::on_artefactdelivering, m_last_rewind_target, tmpcb);
  }; break;
  default:
    NODEFAULT;
