...
void CUIOutfitInfo::InitFromXml(CUIXml &xml_doc) {
  ...
  */
  ...
  m_items[ALife::eHitTypeFireWound]->InitFromXml(xml_doc, base_str,
  ...
  m_items[ALife::eHitTypeExplosion]->InitFromXml(xml_doc, base_str,
  ...
  m_items[ALife::eHitTypeRadiation]->InitFromXml(xml_doc, base_str,
  ...
  m_items[ALife::eHitTypeTelepatic]->InitFromXml(xml_doc, base_str,
...
void CUIOutfitInfo::UpdateInfo(CCustomOutfit *cur_outfit,
  ...
  if (m_items[ALife::eHitTypeFireWound]) {
    ...
    if (slot_outfit) {
      ...
      slot =
          slot_outfit->GetBoneArmor(spine_bone) * slot_outfit->GetCondition();
