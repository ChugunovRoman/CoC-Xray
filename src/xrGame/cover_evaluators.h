...
public:
  ...
  IC void initialize(const Fvector &start_position, bool fake_call = false);
  IC void setup(const Fvector &enemy_position, float min_enemy_distance,
                float max_enemy_distance, float deviation = 0.f);
...
public:
  ...
  void setup(const Fvector &my_position, const Fvector &enemy_position,
