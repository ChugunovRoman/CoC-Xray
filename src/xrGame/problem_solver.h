...
template <typename _operator_condition, typename _condition_state,
          typename _operator, typename _condition_evaluator,
          typename _operator_id_type, bool _reverse_search = false,
...
private:
  typedef CProblemSolver<_operator_condition, _condition_state, _operator,
                         _condition_evaluator, _operator_id_type,
                         _reverse_search, _operator_ptr,
...
private:
  ...
  IC _edge_value_type estimate_edge_weight_impl(const _index_type &vertex_index,
                                                bool) const;

private:
  template <bool> struct helper {
    static IC _edge_value_type estimate_edge_weight_impl(
        self_type const &self, const _index_type &vertex_index) {
...
public:
  ...
  IC const _index_type &value(const _index_type &vertex_index,
                              const_iterator &i, bool reverse_search) const;
  IC void begin(const _index_type &vertex_index, const_iterator &b,
  ...
  IC void
  evaluate_condition(typename xr_vector<COperatorCondition>::const_iterator &I,
