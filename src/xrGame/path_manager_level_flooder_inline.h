...
#define CLevelFlooderPathManager                                               \
  CPathManager<CLevelGraph, _DataStorage,                                      \
               SFlooder<_dist_type, _index_type, _iteration_type>, _dist_type, \
...
TEMPLATE_SPECIALIZATION
IC bool
CLevelFlooderPathManager::is_goal_reached(const _index_type &node_index) {
  VERIFY(path);
...
IC _dist_type CLevelFlooderPathManager::evaluate(
    const _index_type &node_index1, const _index_type &node_index2,
...
TEMPLATE_SPECIALIZATION
IC bool
CLevelFlooderPathManager::is_accessible(const _index_type &vertex_id) const {
