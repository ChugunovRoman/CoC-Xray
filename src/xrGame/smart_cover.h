...
public:
  typedef intrusive_ptr<smart_cover::description, detail::intrusive_base_time>
      DescriptionPtr;
...
public:
  cover(object const &object, DescriptionPtr description, bool is_combat_cover,
        bool can_fire, luabind::object const &loopholes);
  ~cover();
  ...
  void evaluate_loophole(Fvector const &position, loophole *&source,
                         loophole *&result, float &value,
                         bool is_smart_cover_entered) const;
