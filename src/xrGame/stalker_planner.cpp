...
void CStalkerPlanner::add_evaluators() {
  ...
  add_evaluator(eWorldPropertyDanger, xr_new<CStalkerPropertyEvaluatorDangers>(
...
void CStalkerPlanner::add_actions() {
  ...
  // add_condition			(planner,eWorldPropertyAnomaly,
  // false);
  add_condition(planner, eWorldPropertyDanger, false);
  // add_condition			(planner,eWorldPropertyItems,
  // false);
  add_condition(planner, eWorldPropertyPuzzleSolved, false);
  add_effect(planner, eWorldPropertyPuzzleSolved, true);
  ...
  /* 	planner					=
     xr_new<CStalkerAnomalyPlanner>(m_object,"anomaly_planner"); add_condition
     (planner,eWorldPropertyAlive,		true); add_condition
     (planner,eWorldPropertyAnomaly,		true); add_effect
     (planner,eWorldPropertyAnomaly,		false); add_operator
     (eWorldOperatorAnomalyPlanner,planner);

          CStalkerActionBase		*action;

          action					=
     xr_new<CStalkerActionGatherItems>	(m_object,"gather_items"); add_condition
     (action,eWorldPropertyAlive,		true); add_condition
     (action,eWorldPropertyEnemy,		false); add_condition
     (action,eWorldPropertyAnomaly,		false); add_condition
     (action,eWorldPropertyDanger,		false); add_condition
     (action,eWorldPropertyItems,		true); add_effect
     (action,eWorldPropertyItems,		false); add_operator
     (eWorldOperatorGatherItems,			action); */
}
