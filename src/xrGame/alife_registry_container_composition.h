...
//	Description : ALife registry container class, composition of the
// registries
////////////////////////////////////////////////////////////////////////////
...
#define registry_type_list save_registry_type_list(CRelationRegistry)
    ...
    // typedef CALifeAbstractRegistry<u16, TALK_CONTACT_VECTOR >
    // CKnownContactsRegistry; add_to_registry_type_list(CKnownContactsRegistry)
    ...
    // typedef CALifeAbstractRegistry<u16, ARTICLE_VECTOR >
    // CEncyclopediaRegistry; add_to_registry_type_list(CEncyclopediaRegistry)
    ...
    //список новостей полученных актером, состоит из новостей симуляции и
    //сюжетных (скриптованых) новостей
