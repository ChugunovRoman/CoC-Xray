...
IC CGameLocationSelector::CBaseLocationSelector(
    CRestrictedObject *object, CLocationManager *location_manager)
    : inherited(object) {
...
TEMPLATE_SPECIALIZATION
IC void
CGameLocationSelector::set_selection_type(const ESelectionType selection_type) {
...
TEMPLATE_SPECIALIZATION
IC void
CGameLocationSelector::select_location(const _vertex_id_type start_vertex_id,
...
TEMPLATE_SPECIALIZATION
IC bool
CGameLocationSelector::accessible(const _vertex_id_type vertex_id) const {
