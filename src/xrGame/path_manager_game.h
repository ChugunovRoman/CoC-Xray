...
class CPathManager<CGameGraph, _DataStorage, _Parameters, _dist_type,
                   _index_type, _iteration_type>
    : public CPathManagerGeneric<CGameGraph, _DataStorage, _Parameters,
                                 _dist_type, _index_type, _iteration_type> {
protected:
  typedef CGameGraph _Graph;
  typedef typename CPathManagerGeneric<_Graph, _DataStorage, _Parameters,
                                       _dist_type, _index_type, _iteration_type>
      inherited;
