...
animation_action const &
action::animation(MonsterSpace::EBodyState const &target_body_state) const {
...
#ifndef MASTER_GOLD
    Msg("! There is no animation which can transfer bot to body_state [%i], "
        "selecting random transition",
        target_body_state);
