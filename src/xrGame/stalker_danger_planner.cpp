...
void CStalkerDangerPlanner::add_actions() {
  ...
  action =
      xr_new<CStalkerDangerUnknownPlanner>(m_object, "danger unknown planner");
  ...
  action =
      xr_new<CStalkerDangerGrenadePlanner>(m_object, "danger grenade planner");
  add_condition(action, eWorldPropertyDangerGrenade, true);
  add_effect(action, eWorldPropertyDanger, false);
  add_operator(eWorldOperatorDangerGrenadePlanner, action);

  action =
      xr_new<CStalkerDangerBySoundPlanner>(m_object, "danger by sound planner");
