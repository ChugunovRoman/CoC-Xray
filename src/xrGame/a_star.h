...
template <typename _dist_type, typename _priority_queue,
...
class CAStar : public CDijkstra<_dist_type, _priority_queue, _vertex_manager,
                                _vertex_allocator, euclidian_heuristics,
                                _data_storage_base,
...
protected:
  typedef CDijkstra<_dist_type, _priority_queue, _vertex_manager,
