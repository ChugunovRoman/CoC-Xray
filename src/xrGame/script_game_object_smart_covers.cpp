...
void CScriptGameObject::set_smart_cover_target_selector(
    luabind::functor<void> functor, luabind::object object) {
...
void CScriptGameObject::set_smart_cover_target_idle() {
  ...
  if (!stalker->g_Alive()) {
    ai().script_engine().script_log(
        ScriptStorage::eLuaMessageTypeError,
        "CAI_Stalker : do not call smart_cover_setup_idle_target when stalker "
        "is dead!");
    return;
  }
...
void CScriptGameObject::set_smart_cover_target_fire() {
  ...
  if (!stalker->g_Alive()) {
    ai().script_engine().script_log(
        ScriptStorage::eLuaMessageTypeError,
        "CAI_Stalker : do not call smart_cover_setup_fire_target when stalker "
        "is dead!");
    return;
  }
...
void CScriptGameObject::set_smart_cover_target_fire_no_lookout() {
  ...
  if (!stalker->g_Alive()) {
    ai().script_engine().script_log(
        ScriptStorage::eLuaMessageTypeError,
        "CAI_Stalker : do not call set_smart_cover_target_fire_no_lookout when "
        "stalker is dead!");
    return;
  }
...
void CScriptGameObject::set_smart_cover_target_default(bool value) {
  ...
  if (!stalker->g_Alive()) {
    ai().script_engine().script_log(
        ScriptStorage::eLuaMessageTypeError,
        "CAI_Stalker : do not call set_smart_cover_target_default when stalker "
        "is dead!");
    return;
  }
