...
public:
  struct CSavedSound {
    ...
    IC CSavedSound(u16 game_object_id, int sound_type, const Fvector &position,
                   float sound_power)
        : m_game_object_id(game_object_id), m_sound_type(sound_type),
          m_position(position), m_sound_power(sound_power) {}
  };
...
public:
  ...
  virtual void sound_callback(const CObject *object, int sound_type,
