...
void CMovementManager::show_game_path_info() {
  ...
  Msg("! Target point mask [%d][%d][%d][%d]", target_vertex_type[0],
      target_vertex_type[1], target_vertex_type[2], target_vertex_type[3]);
...
void CMovementManager::process_game_path() {
  ...
  case ePathStateBuildLevelPath: {
    ...
    u32 dest_level_vertex_id = ai().game_graph()
                                   .vertex(game_path().intermediate_vertex_id())
                                   ->level_vertex_id();
    ...
    level_path_builder().setup(object().ai_location().level_vertex_id(),
                               dest_level_vertex_id, true, &temp);
  ...
  case ePathStatePathVerification: {
    if (!game_selector().actual(object().ai_location().game_vertex_id(),
                                path_completed()))
