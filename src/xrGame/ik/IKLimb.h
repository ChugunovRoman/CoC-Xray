...
public:
  ...
  u16 foot_matrix_predict(Fmatrix &foot, Fmatrix &toe, float time,
...
private:
  ...
  bool blend_collide(ik_goal_matrix &m, const SCalculateData &cd,
                     const ik_goal_matrix &m0, const ik_goal_matrix &m1) const;
