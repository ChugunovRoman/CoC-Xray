...
void CWeaponAK74::script_register(lua_State *L) {
  module(
      L)[class_<CWeaponAK74, CGameObject>("CWeaponAK74").def(constructor<>()),

         class_<CWeapon, CGameObject>("CWeapon")
             .def(constructor<>())
             .def("can_kill", (bool (CWeapon::*)() const) & CWeapon::can_kill)
             .def("ready_to_kill",
                  (bool (CWeapon::*)() const) & CWeapon::ready_to_kill)
             .def("GetAddonsState",
                  (u8(CWeapon::*)() const) & CWeapon::GetAddonsState)
             .def("SetAddonsState", &CWeapon::SetAddonsState)
             .def("IsZoomed", (bool (CWeapon::*)() const) & CWeapon::IsZoomed)
             .def("GetZoomFactor",
                  (float (CWeapon::*)() const) & CWeapon::GetZoomFactor)
         ...
         class_<CWeaponMagazinedWGrenade, CGameObject>(
