...
public:
  ...
  IC void setup(const _Graph *graph, _DataStorage *_data_storage,
  ...
  IC void init_path();
  template <typename T>
  IC void create_path(T &vertex, _DataStorage &data_storage,
                      bool reverse_order);
