...
public:
  ...
  virtual void feel_sound_new(CObject *who, int type,
...
public:
  ...
  void HitMark(float P, Fvector dir, CObject *who, s16 element,
...
public:
  ...
  void g_SetSprintAnimation(u32 mstate_rl, MotionID &head, MotionID &torso,
                            MotionID &legs);
...
public:
  ...
  CScriptGameObject *ObjectWeLookingAt_script() {
    return m_pObjectWeLookingAt ? m_pObjectWeLookingAt->lua_game_object() : (0);
  }
...
// Alundaio
  ...
  float m_fFeelGrenadeTime; //время гранаты (сек) после которого актер чувствует
                            //гранату
#endif
  //-Alundaio
  ...
  //////////////////////////////////////////////////////////////////////////
public:
  void g_cl_CheckControls(u32 mstate_wf, Fvector &vControlAccel, float &Jump,
                          float dt);
...
public:
  ...
  virtual void
  PH_B_CrPr(); // actions & operations before physic correction-prediction steps
  virtual void
  PH_I_CrPr(); // actions & operations after correction before prediction steps
  virtual void
  PH_A_CrPr(); // actions & operations after phisic correction-prediction steps
               //	virtual void			UpdatePosStack	( u32
               //Time0, u32 Time1
               //);
  ...
  virtual void RenderIndicator(Fvector dpos, float r1, float r2,
...
protected:
  ...
  create_entity_condition(CEntityConditionSimple *ec);
