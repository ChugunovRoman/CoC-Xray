...
static u64 generate_time_impl(u32 years, u32 months, u32 days, u32 hours,
                              u32 minutes, u32 seconds, u32 milliseconds) {
...
static void split_time_impl(u64 time, u32 &years, u32 &months, u32 &days,
...
u64 generate_time(u32 years, u32 months, u32 days, u32 hours, u32 minutes,
                  u32 seconds, u32 milliseconds) {
  u64 const result = generate_time_impl(years, months, days, hours, minutes,
...
#endif // #if 0
  u32 l_years, l_months, l_days, l_hours, l_minutes, l_seconds, l_milliseconds;
  split_time_impl(result, l_years, l_months, l_days, l_hours, l_minutes,
                  l_seconds, l_milliseconds);
  u64 const new_result = generate_time_impl(
      l_years, l_months, l_days, l_hours, l_minutes, l_seconds, l_milliseconds);
  VERIFY(result == new_result);
  split_time_impl(result, years, months, days, hours, minutes, seconds,
                  milliseconds);
...
void split_time(u64 time, u32 &years, u32 &months, u32 &days, u32 &hours,
                u32 &minutes, u32 &seconds, u32 &milliseconds) {
  split_time_impl(time, years, months, days, hours, minutes, seconds,
                  milliseconds);
#ifdef DEBUG
  u64 const test_time = generate_time_impl(years, months, days, hours, minutes,
                                           seconds, milliseconds);
