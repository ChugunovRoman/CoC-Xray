...
void RELATION_REGISTRY::SetGoodwill(u16 from, u16 to,
...
void RELATION_REGISTRY::ForceSetGoodwill(u16 from, u16 to,
                                         CHARACTER_GOODWILL goodwill) {
  RELATION_DATA &relation_data = relation_registry().registry().objects(from);
...
void RELATION_REGISTRY::ChangeGoodwill(u16 from, u16 to,
...
void RELATION_REGISTRY::SetCommunityGoodwill(
    CHARACTER_COMMUNITY_INDEX from_community, u16 to_character,
    CHARACTER_GOODWILL goodwill) {
  static Ivector2 gw_limits =
...
CHARACTER_GOODWILL
RELATION_REGISTRY::GetRankRelation(CHARACTER_RANK_VALUE rank1,
