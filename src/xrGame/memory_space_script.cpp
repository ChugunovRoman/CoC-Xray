...
CScriptGameObject *
not_yet_visible_object(const MemorySpace::CNotYetVisibleObject &object) {
...
template <typename T>
CScriptGameObject *
get_memory_object(const MemorySpace::CMemoryObject<T> &memory_object) {
...
void CMemoryInfo::script_register(lua_State *L) {
  module(L)[
      ...
      class_<MemorySpace::CVisibleObject,
             MemorySpace::CMemoryObject<CGameObject>>("visible_memory_object")
      //			.def("visible",
      ...
      class_<MemorySpace::CSoundObject,
             MemorySpace::CMemoryObject<CGameObject>>("sound_memory_object")
