...
public:
  struct params : base::params {
    ...
    params(vec_arg factor, float arrive_range, float change_vel_range,
           float arrive_vel, float min_factor_dist = base::s_min_factor_dist)
...
public:
  struct params : base::params {
    ...
    params(plane_t plane, float conservativeness, float angle_change,
           float factor)
  ...
  struct params : base::params {
    ...
    params(float turn_factor, vec_arg thrust_factor,
        ...
        : base::params(thrust_factor, min_factor_dist),
          turn_factor(turn_factor), thrust_factor(thrust_factor) {}
...
public:
  struct params : base::params {
    ...
    params(vec_arg cohesion_factor, vec_arg separation_factor,
           float max_separate_range,
           float min_factor_dist = base::s_min_factor_dist,
           vec (*pf_random_dir)() = &detail::random_vec)
        : base::params(separation_factor, min_factor_dist),
          pf_random_dir(pf_random_dir), cohesion_factor(cohesion_factor),
