...
public:
  ...
  void restrict(ALife::_OBJECT_ID id, shared_str out_restrictors,
                shared_str in_restrictors);
  ...
  u32 accessible_nearest(ALife::_OBJECT_ID id, const Fvector &position,
                         Fvector &result);

  IC bool restriction_presented(shared_str restrictions,
