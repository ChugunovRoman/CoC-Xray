...
IC CObjectActionBase<_item_type>::CObjectActionBase(_item_type *item,
                                                    CAI_Stalker *owner,
...
template <typename _item_type>
IC void
CObjectActionBase<_item_type>::set_property(_condition_type condition_id,
                                            _value_type value) {
  VERIFY(m_storage);
...
IC CObjectActionMember<_item_type>::CObjectActionMember(
    _item_type *item, CAI_Stalker *owner, CPropertyStorage *storage,
