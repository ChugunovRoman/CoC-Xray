...
void CScriptBinderObjectWrapper::reload_static(
    CScriptBinderObject *script_binder_object, LPCSTR section) {
...
bool CScriptBinderObjectWrapper::net_Spawn_static(
    CScriptBinderObject *script_binder_object, SpawnType DC) {
...
void CScriptBinderObjectWrapper::net_Import_static(
    CScriptBinderObject *script_binder_object, NET_Packet *net_packet) {
...
void CScriptBinderObjectWrapper::shedule_Update_static(
    CScriptBinderObject *script_binder_object, u32 time_delta) {
...
void CScriptBinderObjectWrapper::save_static(
    CScriptBinderObject *script_binder_object, NET_Packet *output_packet) {
...
void CScriptBinderObjectWrapper::load_static(
    CScriptBinderObject *script_binder_object, IReader *input_packet) {
...
bool CScriptBinderObjectWrapper::install_upgrade_impl(LPCSTR section,
                                                      bool test) {
  return (
      luabind::call_member<bool>(this, "install_upgrade_impl", section, test));
}

bool CScriptBinderObjectWrapper::install_upgrade_impl_static(
    CScriptBinderObject *script_binder_object, LPCSTR section, bool test) {
  return (script_binder_object->CScriptBinderObject::install_upgrade_impl(
      section, test));
}