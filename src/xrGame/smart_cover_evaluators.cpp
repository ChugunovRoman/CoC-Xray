...
loophole_actual_evaluator::loophole_actual_evaluator(CAI_Stalker *object,
                                                     LPCSTR evaluator_name,
...
loophole_exitable_evaluator::loophole_exitable_evaluator(CAI_Stalker *object,
                                                         LPCSTR evaluator_name)
    : inherited(object ? object->lua_game_object() : 0, evaluator_name) {}
...
default_behaviour_evaluator::default_behaviour_evaluator(
    animation_planner *object, LPCSTR evaluator_name)
