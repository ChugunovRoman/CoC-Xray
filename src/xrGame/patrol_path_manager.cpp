...
IC bool
CPatrolPathManager::accessible(const CPatrolPath::CVertex *vertex) const {
...
void CPatrolPathManager::select_point(const Fvector &position,
  ...
  VERIFY3(m_path->vertex(m_curr_point_index) || show_restrictions(m_object),
          *m_path_name, *m_game_object->cName());

  m_game_object->callback(GameObject::ePatrolPathInPoint)(
      m_game_object->lua_game_object(), u32(ScriptEntity::eActionTypeMovement),
      m_curr_point_index);
