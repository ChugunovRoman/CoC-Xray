...
const DIALOG_SHARED_PTR &
CPhraseDialogManager::GetDialogByID(const shared_str &dialog_id) const {
...
void CPhraseDialogManager::AddDialog(DIALOG_SHARED_PTR &phrase_dialog) {
  DIALOG_VECTOR_IT it =
      std::find(m_ActiveDialogs.begin(), m_ActiveDialogs.end(), phrase_dialog);
