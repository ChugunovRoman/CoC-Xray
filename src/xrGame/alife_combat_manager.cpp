...
m_tpaCombatGroups[iGroupIndex]; CSE_ALifeGroupAbstract
...
(l_tpALifeSpaceRestrictor,"Unknown schedulable object class");
                        m_combat_type			=
...
smart_cast<CSE_ALifeSmartZone*>(tpALifeSchedulable2); if (smart_zone)
                                        m_combat_type		=
eCombatTypeSmartTerrain; else
                                        R_ASSERT2
(false,"Unknown schedulable object class");
                        }
                        else
                                m_combat_type			=
...
combat_type())) { #ifdef DEBUG if (psAI_Flags.test(aiALife)) {
                        Msg
