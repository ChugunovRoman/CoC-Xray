...
public:
  ...
  CHARACTER_GOODWILL
  GetCommunityGoodwill(CHARACTER_COMMUNITY_INDEX from_community,
...
public:
  struct FIGHT_DATA {
    ...
    ALife::ERelationType
        defender_to_attacker; //как относился атакованый к нападавшему во время
                              //начальной атаки
  };
  ...
  void FightRegister(u16 attacker, u16 defender,
