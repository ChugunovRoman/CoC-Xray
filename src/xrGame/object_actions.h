...
public:
  IC CObjectActionBase(_item_type *item, CAI_Stalker *owner,
...
public:
  IC CObjectActionMember(_item_type *item, CAI_Stalker *owner,
...
public:
  CObjectActionCommand(CInventoryItem *item, CAI_Stalker *owner,
...
public:
  CObjectActionShow(CInventoryItem *item, CAI_Stalker *owner,
                    CPropertyStorage *storage, LPCSTR action_name = "");
  virtual void initialize();
  virtual void execute();
};
...
public:
  CObjectActionHide(CInventoryItem *item, CAI_Stalker *owner,
                    CPropertyStorage *storage, LPCSTR action_name = "");
  virtual void execute();
...
public:
  CObjectActionReload(CInventoryItem *item, CAI_Stalker *owner,
...
public:
  CObjectActionFire(CInventoryItem *item, CAI_Stalker *owner,
                    CPropertyStorage *storage, _condition_type type,
                    LPCSTR action_name = "");
  virtual void initialize();
  virtual void execute();
...
public:
  CObjectActionFireNoReload(CInventoryItem *item, CAI_Stalker *owner,
                            CPropertyStorage *storage, _condition_type type,
                            LPCSTR action_name = "");
  virtual void initialize();
  virtual void execute();
...
public:
  CObjectActionStrapping(CInventoryItem *item, CAI_Stalker *owner,
                         CPropertyStorage *storage, LPCSTR action_name = "");
...
public:
  CObjectActionUnstrapping(CInventoryItem *item, CAI_Stalker *owner,
                           CPropertyStorage *storage, LPCSTR action_name = "");
...
public:
  CObjectActionQueueWait(CInventoryItem *item, CAI_Stalker *owner,
                         CPropertyStorage *storage, _condition_type type,
                         LPCSTR action_name = "");
  virtual void initialize();
  virtual void execute();
...
public:
  CObjectActionSwitch(CInventoryItem *item, CAI_Stalker *owner,
                      CPropertyStorage *storage, _condition_type type,
                      LPCSTR action_name = "");
  virtual void initialize();
  virtual void execute();
...
public:
  CObjectActionDrop(CInventoryItem *item, CAI_Stalker *owner,
                    CPropertyStorage *storage, LPCSTR action_name = "");
  virtual void initialize();
};
...
public:
  CObjectActionAim(CInventoryItem *item, CAI_Stalker *owner,
...
public:
  CObjectActionIdle(CInventoryItem *item, CAI_Stalker *owner,
                    CPropertyStorage *storage, LPCSTR action_name = "");
  virtual void initialize();
};
...
public:
  CObjectActionIdleMissile(CInventoryItem *item, CAI_Stalker *owner,
                           CPropertyStorage *storage, LPCSTR action_name = "");
  virtual void initialize();
};
...
public:
  CObjectActionThrowMissile(CInventoryItem *item, CAI_Stalker *owner,
                            CPropertyStorage *storage, LPCSTR action_name = "");
  virtual void initialize();
  virtual void execute();
};
