...
void stalker_low_cover_planner::add_evaluators() {
  add_evaluator(eWorldPropertyLowCover, xr_new<CStalkerPropertyEvaluatorConst>(
                                            true, "using low cover"));
  add_evaluator(
...
void stalker_low_cover_planner::add_actions() {
  ...
  action = xr_new<CStalkerActionGetReadyToKillLowCover>(m_object,
                                                        "get_ready_to_kill");
  ...
  action =
      xr_new<CStalkerActionHoldPositionLowCover>(m_object, "hold_position");
  add_condition(action, eWorldPropertyReadyToKill, true);
