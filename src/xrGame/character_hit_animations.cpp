...
*/
  ...
  base_bone =
      smart_cast<IKinematics *>(&ca)->LL_BoneID("bip01_spine1"); // bip01_spine1
...
IC void play_cycle(IKinematicsAnimated *CA, const MotionID &m, u8 channel,
                   CBlend *&blend_block, float base_power) {
...
void character_hit_animation_controller::PlayHitMotion(const Fvector &dir,
...
void character_hit_animation_controller::GetBaseMatrix(Fmatrix &m,
                                                       CEntityAlive &ea) const {
