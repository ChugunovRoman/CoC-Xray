...
void CInventoryOwner::script_register(lua_State *L) {
  module(
      L)[class_<CInventory>("CInventory")
             ...
             .enum_("slots")[luabind::value("NO_ACTIVE_SLOT", NO_ACTIVE_SLOT),
         ...
         class_<CInventoryOwner>("CInventoryOwner")
             ...
             .def("inventory", (CInventory & (CInventoryOwner::*)()) &
                                   CInventoryOwner::inventory)
