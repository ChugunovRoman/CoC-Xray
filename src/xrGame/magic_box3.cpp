...
void MagicBox3::ComputeVertices(Fvector *akVertex) const {
  ...
  akVertex[0] =
      Fvector().sub(m_kCenter, akEAxis[0]).sub(akEAxis[1]).sub(akEAxis[2]);
  akVertex[1] =
      Fvector().add(m_kCenter, akEAxis[0]).sub(akEAxis[1]).sub(akEAxis[2]);
  akVertex[2] =
      Fvector().add(m_kCenter, akEAxis[0]).add(akEAxis[1]).sub(akEAxis[2]);
  akVertex[3] =
      Fvector().sub(m_kCenter, akEAxis[0]).add(akEAxis[1]).sub(akEAxis[2]);
  akVertex[4] =
      Fvector().sub(m_kCenter, akEAxis[0]).sub(akEAxis[1]).add(akEAxis[2]);
  akVertex[5] =
      Fvector().add(m_kCenter, akEAxis[0]).sub(akEAxis[1]).add(akEAxis[2]);
  akVertex[6] =
      Fvector().add(m_kCenter, akEAxis[0]).add(akEAxis[1]).add(akEAxis[2]);
  akVertex[7] =
      Fvector().sub(m_kCenter, akEAxis[0]).add(akEAxis[1]).add(akEAxis[2]);
}
