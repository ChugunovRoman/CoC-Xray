...
IC bool
CDetailPathManager::completed(const Fvector &position, bool bRealCompleted,
...
IC void
CDetailPathManager::set_start_direction(const Fvector &start_direction) {
...
IC void CDetailPathManager::adjust_point(const Fvector2 &source, float yaw,
                                         float magnitude,
                                         Fvector2 &dest) const {
  dest.x = -_sin(yaw);
  dest.y = _cos(yaw);
...
IC void CDetailPathManager::assign_angle(float &angle, const float start_yaw,
...
IC void
CDetailPathManager::set_use_dest_orientation(const bool use_dest_orientation) {
...
IC void
CDetailPathManager::set_state_patrol_path(const bool state_patrol_path) {
...
IC const CDetailPathManager::VELOCITIES &
CDetailPathManager::velocities() const {
