...
class CGameObject : public CObject, public CScriptBinder {
...
public:
  virtual void make_Interpolation(){}; // interpolation from last visible to
...
private:
  DEFINE_MAP(GameObject::ECallbackType, CScriptCallbackExVoid, CALLBACK_MAP,
             CALLBACK_MAP_IT);
