...
CClimableObject::CClimableObject()
    : m_pStaticShell(NULL), m_radius(0), m_material(u16(-1)) {}
...
BOOL CClimableObject::net_Spawn(CSE_Abstract *DC) {
  ...
  m_radius =
      _max(_max(m_box.m_halfsize.x, m_box.m_halfsize.y), m_box.m_halfsize.z);
...
void CClimableObject::ObjectContactCallback(bool &do_colide, bool bo1,
                                            dContact &c,
                                            SGameMtl * /*material_1*/,
                                            SGameMtl * /*material_2*/) {
