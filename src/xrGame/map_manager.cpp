...
CMapLocation *CMapManager::AddUserLocation(const shared_str &spot_type,
                                           const shared_str &level_name,
                                           Fvector position) {
...
CMapLocation *CMapManager::AddRelationLocation(CInventoryOwner *pInvOwner) {
  ...
  CMapLocation *l = xr_new<CRelationMapLocation>(sname, pInvOwner->object_id(),
                                                 pActor->object_id());
...
void CMapManager::MapLocationsForEach(LPCSTR spot_type, u16 id,
