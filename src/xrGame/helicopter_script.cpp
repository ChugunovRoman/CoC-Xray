...
void CHelicopter::script_register(lua_State *L) {
  module(L)
      [class_<CHelicopter, CGameObject>("CHelicopter")
           ...
           .enum_(
               "movement_state")[value("eMovNone", int(eMovNone)),
           ...
           .def("SetEnemy", (void (CHelicopter::*)(CScriptGameObject *)) &
                                CHelicopter::SetEnemy)
           .def("SetEnemy",
                (void (CHelicopter::*)(Fvector *)) & CHelicopter::SetEnemy)
           ...
           .def("UseFireTrail",
                (bool (CHelicopter::*)(void)) & CHelicopter::UseFireTrail)
           .def("UseFireTrail",
                (void (CHelicopter::*)(bool)) & CHelicopter::UseFireTrail)
