...
CSE_ALifeItemWeapon *
CSE_ALifeAnomalousZone::tpfGetBestWeapon(ALife::EHitType &tHitType,
                                         float &fHitPower) {
...
pSettings->r_float(name(),"max_start_power"); u32
...
n = _GetItemCount(artefacts);
        VERIFY2					(!(n % 2),"Invalid parameters
count in line artefacts for anomalous zone");
        n						>>= 1;
