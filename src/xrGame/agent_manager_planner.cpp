...
void CAgentManagerPlanner::add_evaluators() {
  add_evaluator(ePropertyOrders, xr_new<CAgentManagerPropertyEvaluatorConst>(
  ...
  add_evaluator(ePropertyDanger, xr_new<CAgentManagerPropertyEvaluatorDanger>(
...
void CAgentManagerPlanner::add_actions() {
  ...
  action =
      xr_new<CAgentManagerActionReactOnDanger>(&object(), "react_on_danger");
  add_condition(action, ePropertyEnemy, false);
