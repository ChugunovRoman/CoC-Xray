...
public:
  ...
  ik_pick_query(ik_foot_geom::e_collide_point point, const Fvector &pos,
...
public:
  ik_foot_collider();
  void collide(SIKCollideData &cld, const ik_foot_geom &foot_geom,
               CGameObject *O, bool foot_step);
};
