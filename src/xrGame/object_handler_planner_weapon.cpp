...
void CObjectHandlerPlanner::add_operators(CWeapon *weapon) {
  ...
  // strapping
  action =
      xr_new<CObjectActionStrapping>(weapon, m_object, &m_storage, "strapping");
  add_condition(action, id, eWorldPropertyHidden, false);
  add_condition(action, id, eWorldPropertyStrapped, false);
  ...
  action = xr_new<CObjectActionStrappingToIdle>(weapon, m_object, &m_storage,
                                                "strapping to idle");
  add_condition(action, id, eWorldPropertyHidden, false);
  ...
  action = xr_new<CObjectActionUnstrappingToIdle>(weapon, m_object, &m_storage,
                                                  "unstrapping to idle");
  add_condition(action, id, eWorldPropertyHidden, false);
  add_condition(action, id, eWorldPropertyStrapped, false);
  add_condition(action, id, eWorldPropertyStrapped2Idle, true);
  ...
  // fire1
  action = xr_new<CObjectActionFire>(
      weapon, m_object, &m_storage, uid(id, eWorldPropertyQueueWait1), "fire1");
  add_condition(action, id, eWorldPropertyHidden, false);
  ...
  // fire2
  action = xr_new<CObjectActionFire>(
      weapon, m_object, &m_storage, uid(id, eWorldPropertyQueueWait2), "fire2");
  add_condition(action, id, eWorldPropertyHidden, false);
  ...
  // reload1
  action =
      xr_new<CObjectActionReload>(weapon, m_object, &m_storage, 0, "reload1");
  add_condition(action, id, eWorldPropertyHidden, false);
  ...
  // reload2
  action =
      xr_new<CObjectActionReload>(weapon, m_object, &m_storage, 1, "reload2");
  add_condition(action, id, eWorldPropertyHidden, false);
  ...
  // switch1
  action =
      xr_new<CObjectActionSwitch>(weapon, m_object, &m_storage, 0, "switch1");
  ...
  // switch2
  action =
      xr_new<CObjectActionSwitch>(weapon, m_object, &m_storage, 1, "switch2");
  add_condition(action, id, eWorldPropertySwitch1, true);
