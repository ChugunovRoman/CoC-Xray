...
IC void
CALifeMonsterPatrolPathManager::start_type(const EPatrolStartType &start_type) {
  m_start_type = start_type;
}

IC void
CALifeMonsterPatrolPathManager::route_type(const EPatrolRouteType &route_type) {
...
IC void
CALifeMonsterPatrolPathManager::use_randomness(const bool &use_randomness) {
