...
void interactive_motion_diagnostic(LPCSTR message, const MotionID &m,
                                   CPhysicsShell *s) {
#ifdef DEBUG
  if (!death_anim_debug)
    return;
  ...
  Msg("death anims - interactive_motion:- %s, motion: %s, obj: %s, model:  %s ",
...
void interactive_motion::setup(const MotionID &m, CPhysicsShell *s,
                               float _angle) {
