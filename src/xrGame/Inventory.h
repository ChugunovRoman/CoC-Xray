...
public:
  ...
  bool Slot(u16 slot_id, PIItem pIItem, bool bNotActivate = false,
...
public:
  ...
  void AddAvailableItems(TIItemContainer &items_container, bool for_trade,
