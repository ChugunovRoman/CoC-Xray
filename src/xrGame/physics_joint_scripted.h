...
public:
  ...
  void SetAxisSDfactors(float spring_factor, float damping_factor,
                        int axis_num) {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  void SetAxisDir(const float x, const float y, const float z,
                  const int axis_num) {
    physics_impl().SetAxisDir(x, y, z, axis_num);
  }
  void SetAxisDirVsFirstElement(const float x, const float y, const float z,
                                const int axis_num) {
