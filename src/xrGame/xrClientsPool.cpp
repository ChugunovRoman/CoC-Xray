...
xrClientsPool::xrClientsPool() { m_dclients.reserve(32); }
...
bool const
xrClientsPool::expired_client_deleter::operator()(dclient &right) const {
...
bool const
xrClientsPool::pooled_client_finder::operator()(dclient const &right) const {
