...
IC const GroupHierarchyHolder::MEMBER_REGISTRY &
CGroupHierarchyHolder::members() const {
  return (m_members);
}
...
IC GroupHierarchyHolder::SOUND_OBJECTS &
CGroupHierarchyHolder::sound_objects() const {
  VERIFY(m_sound_objects);
  return (*m_sound_objects);
}

IC GroupHierarchyHolder::HIT_OBJECTS &
CGroupHierarchyHolder::hit_objects() const {
