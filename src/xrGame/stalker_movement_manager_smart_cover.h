...
private:
  ...
  nearest_action(smart_cover::cover const &cover,
                 shared_str const &loophole_id0, shared_str const &loophole_id1,
                 Fvector const &position, Fvector &result_position,
  ...
  float enter_path(LoopholePath *result, Fvector const &position,
                   u32 const level_vertex_id, smart_cover::cover const &cover,
