...
MemorySpace::squad_mask_type
CAgentMemberManager::mask(const ALife::_OBJECT_ID &object_id) const {
...
CMemberOrder *
CAgentMemberManager::get_member(const ALife::_OBJECT_ID &object_id) {
