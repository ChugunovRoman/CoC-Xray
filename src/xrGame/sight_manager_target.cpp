...
void CSightManager::SetPointLookAngles(const Fvector &tPosition, float &yaw,
                                       float &pitch,
...
void CSightManager::SetFirePointLookAngles(const Fvector &tPosition, float &yaw,
                                           float &pitch,
                                           Fvector const &look_position,
                                           const CGameObject *object) {
  Fvector my_position = look_position;
