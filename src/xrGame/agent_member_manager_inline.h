...
IC const CAgentMemberManager::MEMBER_STORAGE &
CAgentMemberManager::members() const {
  return (m_members);
}
...
IC MemorySpace::squad_mask_type
CAgentMemberManager::mask(const CAI_Stalker *object) const {
...
IC CAgentMemberManager::iterator
CAgentMemberManager::member(MemorySpace::squad_mask_type mask) {
