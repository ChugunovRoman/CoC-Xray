...
FS_file_list_ex file_list_open_ex(CLocatorAPI *fs, LPCSTR path, u32 flags,
                                  LPCSTR mask) {
...
FS_file_list file_list_open_script_2(CLocatorAPI *fs, LPCSTR initial,
                                     LPCSTR folder, u32 flags) {
  return FS_file_list(fs->file_list_open(initial, folder, flags));
}

void dir_delete_script_2(CLocatorAPI *fs, LPCSTR path, LPCSTR nm,
                         int remove_files) {
  ...
  module(L)
       ...
       */
       ...
       class_<CLocatorAPI>("FS")
           ...
           .def("file_delete", (void (CLocatorAPI::*)(LPCSTR, LPCSTR))(
                                   &CLocatorAPI::file_delete))
           .def("file_delete",
                (void (CLocatorAPI::*)(LPCSTR))(&CLocatorAPI::file_delete))
           ...
           .def("exist", (const CLocatorAPI::file *(CLocatorAPI::*)(LPCSTR))(
                             &CLocatorAPI::exist))
           .def("exist",
                (const CLocatorAPI::file *(CLocatorAPI::*)(LPCSTR, LPCSTR))(
                    &CLocatorAPI::exist))

           .def("get_file_age", &CLocatorAPI::get_file_age)
           .def("get_file_age_str", &get_file_age_str)
           .def("r_open", (IReader * (CLocatorAPI::*)(LPCSTR, LPCSTR))(
                              &CLocatorAPI::r_open))
           .def("r_open",
                (IReader * (CLocatorAPI::*)(LPCSTR))(&CLocatorAPI::r_open))
           .def("r_close",
                (void (CLocatorAPI::*)(IReader *&))(&CLocatorAPI::r_close))

           .def("w_open", (IWriter * (CLocatorAPI::*)(LPCSTR, LPCSTR))(
                              &CLocatorAPI::w_open))
           .def("w_open",
                (IWriter * (CLocatorAPI::*)(LPCSTR))(&CLocatorAPI::w_close))
