...
IC bool CLevelManagerTemplate::actual() const {
  return (inherited::actual(m_object->object().ai_location().level_vertex_id(),
                            dest_vertex_id()));
}

TEMPLATE_SPECIALIZATION
IC void
CLevelManagerTemplate::build_path(const _vertex_id_type start_vertex_id,
...
TEMPLATE_SPECIALIZATION
IC void
CLevelManagerTemplate::before_search(const _vertex_id_type start_vertex_id,
                                     const _vertex_id_type dest_vertex_id) {
  if (m_object) {
...
TEMPLATE_SPECIALIZATION
IC bool
CLevelManagerTemplate::check_vertex(const _vertex_id_type vertex_id) const {
