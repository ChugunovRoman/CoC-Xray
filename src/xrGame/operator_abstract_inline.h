...
IC bool CAbstractOperator::applicable_reverse(
    const CSConditionState &condition, const CSConditionState &start,
...
template <typename T>
IC const typename CAbstractOperator::CSConditionState &
CAbstractOperator::apply(const CSConditionState &current,
                         const CSConditionState &effects,
...
TEMPLATE_SPECIALIZATION
IC const typename CAbstractOperator::CSConditionState &
CAbstractOperator::apply(const CSConditionState &condition,
...
TEMPLATE_SPECIALIZATION
IC typename CAbstractOperator::_edge_value_type
CAbstractOperator::min_weight() const {
  if (m_weight_actual)
    return (m_min_weight);
