...
public:
  ...
  enum EAction {
    ...
    on_artefactdelivering, // param contains the name of a player that delivered
                           // the art
    on_artefactcapturing,  // param contains the name of a player that captured
                           // the art
    on_artefactloosing // param contains the name of a player that loosed the
                       // art
  };
...
private:
  ...
  void __stdcall on_round_start_impl(u32 message, u32 subtype,
                                     NET_Packet &packet);
  ...
  void __stdcall on_artefactdelivering_impl(u32 message, u32 subtype,
                                            NET_Packet &packet);
  void __stdcall on_artefactcapturing_impl(u32 message, u32 subtype,
                                           NET_Packet &packet);
  void __stdcall on_artefactloosing_impl(u32 message, u32 subtype,
                                         NET_Packet &packet);
}; // class demoplay_control
