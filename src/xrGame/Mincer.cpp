...
void CMincer::Load(LPCSTR section) {
  ...
  m_telekinetics.set_throw_power(
      pSettings->r_float(section, "throw_out_impulse"));
...
void CMincer::AffectThrow(SZoneObjectInfo *O, CPhysicsShellHolder *GO,
...
void CMincer::AffectPullAlife(CEntityAlive *EA, const Fvector &throw_in_dir,
                              float dist) {
