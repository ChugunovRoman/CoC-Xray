...
void CWeaponAmmo::script_register(lua_State *L) {
  module(
      L)[class_<SCartridgeParam>("SCartridgeParam")
             .def(constructor<>())
             ...
             .def_readwrite("k_cam_dispersion",
                            &SCartridgeParam::k_cam_dispersion)
         ...
         class_<CCartridge>("CCartridge")
             ...
             .def_readwrite("bullet_material_idx",
                            &CCartridge::bullet_material_idx)
