...
public:
  ...
  virtual BOOL
  OnTouch(u16 eid_who, u16 eid_target,
  ...
  virtual void OnHit(u16 id_hitter, u16 id_hitted,
  ...
  virtual void
  net_Export_Update(NET_Packet &P, ClientID id_to,
                    ClientID id); // just incremental update for specific client
  virtual void
  net_Export_GameTime(NET_Packet &P); // update GameTime only for remote clients
