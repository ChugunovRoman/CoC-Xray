...
protected:
  ...
  virtual void FireBullet(const Fvector &pos, const Fvector &dir,
...
protected:
  ...
  void StartParticles(CParticlesObject *&pParticles, LPCSTR particles_name,
                      const Fvector &pos, const Fvector &vel = zero_vel,
