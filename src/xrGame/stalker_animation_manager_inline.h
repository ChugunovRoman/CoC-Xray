...
IC void
CStalkerAnimationManager::global_selector(AnimationSelector const &selector) {
...
IC void
CStalkerAnimationManager::global_callback(AnimationCallback const &callback) {
...
IC void
CStalkerAnimationManager::global_modifier(AnimationModifier const &modifier) {
