...
xr_sprintf(S1,"%s : ",tpALifeHumanAbstract1->name_replace());
                                ...
                                for ( ; I != E; ++I)
                                        S1			+=
xr_sprintf(S1,"%6d",*I); Msg				("%s",S);
                        }
                        {
                                string4096		S;
                                char			*S1 = S;
                                S1				+=
xr_sprintf(S1,"%s : ",tpALifeHumanAbstract2->name_replace());
...
tpALifeHumanAbstract2->brain().m_dwTotalMoney)) break;
                int				l_iItemCount1 = 0, l_iItemCount2
= 0; switch (k) { case 0 : {
...
(l_tpALifeAbstractGroup) {
                ...
                OBJECT_IT E = l_tpALifeAbstractGroup->m_tpMembers.end(); for ( ;
I != E; ++I) communicate_with_customer
...
(tpALifeHumanAbstract,l_iItemCount);
                        ITEM_P_IT I = m_temp_item_vector.begin(); ITEM_P_IT
