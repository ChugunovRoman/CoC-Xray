...
animation_planner::animation_planner(CAI_Stalker *object, LPCSTR action_name)
    : inherited(), m_time_object_hit(0), m_last_transition_time(0),
      m_default_idle_interval(0), m_default_lookout_interval(0),
      m_loophole_value(1000), m_head_speed(flt_max), m_idle_min_time(0.f),
      m_idle_max_time(0.f), m_lookout_min_time(0.f), m_lookout_max_time(0.f),
...
void animation_planner::add_evaluators() {
  ...
  add_evaluator(eWorldPropertyReadyToLookout,
                xr_new<CStalkerPropertyEvaluatorMember>(
                    (CPropertyStorage *)0, eWorldPropertyReadyToLookout, true,
                    true, "ready to lookout"));
  ...
  add_evaluator(eWorldPropertyReadyToFireNoLookout,
                xr_new<CStalkerPropertyEvaluatorMember>(
                    (CPropertyStorage *)0, eWorldPropertyReadyToFireNoLookout,
                    true, true, "ready to fire_no_lookout"));
...
void animation_planner::add_actions() {
  ...
  action = xr_new<non_animated_change_loophole>(m_object,
                                                "non-animated change loophole");
  add_condition(action, eWorldPropertySmartCoverEntered, true);
  add_condition(action, eWorldPropertyLoopholeActual, false);
  add_condition(action, eWorldPropertyReadyToIdle, true);
  ...
  action = xr_new<idle_2_lookout_transition>(
      m_object, "idle_2_lookout", "idle", "lookout", eWorldPropertyReadyToIdle,
  ...
  action = xr_new<fire_2_idle_transition>(m_object, "fire_2_idle", "fire",
                                          "idle", eWorldPropertyReadyToFire,
