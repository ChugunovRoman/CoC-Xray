...
void CObjectHandlerPlanner::add_evaluators(CMissile *missile) {
  ...
  add_evaluator(uid(id, eWorldPropertyThrow),
                xr_new<CObjectPropertyEvaluatorMissile>(missile, m_object,
                                                        CMissile::eThrowEnd));
...
void CObjectHandlerPlanner::add_operators(CMissile *missile) {
  ...
  // idle
  action =
      xr_new<CObjectActionIdleMissile>(missile, m_object, &m_storage, "idle");
  add_condition(action, id, eWorldPropertyHidden, false);
  ...
  // fire throw
  action =
      xr_new<CSObjectActionBase>(missile, m_object, &m_storage, "throwing");
  add_condition(action, id, eWorldPropertyHidden, false);
  ...
  action =
      xr_new<CSObjectActionBase>(missile, m_object, &m_storage, "threaten");
