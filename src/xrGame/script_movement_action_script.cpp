      ...
      [class_<CScriptMovementAction>("move")
           ...
           .enum_("path")
               [value("line", int(DetailPathManager::eDetailPathTypeSmooth)),
                ...
                value("criteria",
                      int(DetailPathManager::eDetailPathTypeSmoothCriteria)),
           ...
           // Monsters
           .def(
               constructor<MonsterSpace::EScriptMonsterMoveAction, Fvector *>())
           ...
           .def(constructor<MonsterSpace::EScriptMonsterMoveAction,
                            CScriptGameObject *, float>())
           .def(constructor<MonsterSpace::EScriptMonsterMoveAction, Fvector *,
                            float, MonsterSpace::EScriptMonsterSpeedParam>())
           .def(constructor<MonsterSpace::EScriptMonsterMoveAction,
                            CPatrolPathParams *, float,
