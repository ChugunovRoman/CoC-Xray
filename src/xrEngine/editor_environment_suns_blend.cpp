...
void blend::load(CInifile &config, shared_str const &section) {
  m_down_time =
      READ_IF_EXISTS(&config, r_float, section, "blend_down_time", 60.f);
  m_rise_time =
      READ_IF_EXISTS(&config, r_float, section, "blend_rise_time", 60.f);
