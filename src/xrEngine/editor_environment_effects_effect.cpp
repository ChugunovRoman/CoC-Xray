...
void effect::save(CInifile &config) {
  ...
  config.w_float(m_id.c_str(), "wind_blast_longitude",
                 rad2deg(wind_blast_direction.getH()));
}
...
void effect::fill(editor::property_holder_collection *collection) {
  ...
  m_property_holder->add_property(
      "id", "properties", "this option is resposible for effect identifier",
  ...
  m_property_holder->add_property(
      ...
      "this option is resposible for effect particles", particles.c_str(),
      particles, &*m_manager.environment().particle_ids().begin(),
  ...
  m_property_holder->add_property(
      "sound", "properties", "this option is resposible for effect sound",
      m_sound.c_str(), string_getter, string_setter, ".ogg",
      "Sound files (*.ogg)|*.ogg",
      detail::real_path("$game_sounds$", "").c_str(), "Select sound...",
      editor::property_holder::cannot_enter_text,
      editor::property_holder::remove_extension);
  m_property_holder->add_property(
      "wind gust factor", "properties",
      "this option is resposible for effect wind gust factor", wind_gust_factor,
      wind_gust_factor);
  m_property_holder->add_property(
      "wind blast strength", "properties",
      "this option is resposible for effect wind blast strength",
      wind_blast_strength, wind_blast_strength);
  m_property_holder->add_property(
      "wind blast start time", "properties",
      "this option is resposible for effect wind blast start time",
      wind_blast_in_time, wind_blast_in_time, 0.f, 1000.f);
  m_property_holder->add_property(
      "wind blast stop time", "properties",
  ...
  m_property_holder->add_property(
      "wind blast longitude", "properties",
