...
void line_edit_control::init(u32 str_buffer_size, init_mode mode) {
  ...
  if (mode == im_read_only) {
    ...
    assign_callback(DIK_C, ks_Ctrl,
                    Callback(this, &line_edit_control::copy_to_clipboard));
    assign_callback(DIK_INSERT, ks_Ctrl,
                    Callback(this, &line_edit_control::copy_to_clipboard));
    ...
    assign_callback(DIK_LEFT, ks_Ctrl,
    ...
    assign_callback(DIK_INSERT, ks_free,
    ...
    assign_callback(DIK_C, ks_Ctrl,
                    Callback(this, &line_edit_control::copy_to_clipboard));
    assign_callback(DIK_V, ks_Ctrl,
                    Callback(this, &line_edit_control::paste_from_clipboard));
    assign_callback(DIK_X, ks_Ctrl,
    ...
    assign_callback(DIK_INSERT, ks_Shift,
                    Callback(this, &line_edit_control::paste_from_clipboard));
    assign_callback(DIK_DELETE, ks_Shift,
                    Callback(this, &line_edit_control::cut_to_clipboard));
    ...
    assign_callback(DIK_BACK, ks_Ctrl,
...
void line_edit_control::create_char_pair(u32 const dik, char c, char c_shift,
                                         bool translate) {
  if (m_actions[dik]) {
    xr_delete(m_actions[dik]);
  }
...
void line_edit_control::assign_callback(u32 const dik, key_state state,
...
void line_edit_control::on_frame() {
  ...
  {
  Msg( " cur_time=%.2f re=%d acc=%.2f rep_time=%.2f", cur_time, bRepeat, fAccel,
  rep_time );
  }*/
}
