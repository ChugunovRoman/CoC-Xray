...
bool logical_string_predicate::operator()(LPCSTR const &first,
                                          LPCSTR const &second) const {
...
bool logical_string_predicate::operator()(shared_str const &first,
                                          shared_str const &second) const {
