...
property_collection<channel::sound_container_type, channel>::create() {
...
void channel::fill(editor::property_holder_collection *collection) {
  ...
  m_property_holder->add_property(
      "id", "properties", "this option is resposible for sound channel id",
  ...
  m_property_holder->add_property(
      ...
      m_sound_period.z, m_sound_period.z);
  m_property_holder->add_property(
      "period 3", "properties",
      "this option is resposible for maximum pause interval (in seconds)",
      m_sound_period.w, m_sound_period.w);
