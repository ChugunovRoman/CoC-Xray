...
flare::flare()
    : m_property_holder(0), m_opacity(0.f), m_position(0.f), m_radius(0.f),
      m_texture("") {}
...
void flare::fill(editor::property_holder_collection *collection) {
  ...
  properties->add_property(
      "texture", "flare", "this option is resposible for gradient texture",
  ...
  properties->add_property("opacity", "flare",
                           "this option is resposible for gradient opacity",
                           m_opacity, m_opacity);
  properties->add_property("position", "flare",
                           "this option is resposible for gradient position",
                           m_position, m_position);
  properties->add_property("radius", "flare",
