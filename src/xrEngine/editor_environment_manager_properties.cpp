...
LPCSTR s_properties[] = {"integer_property_0", "integer_property_1",
                         "integer_property_2"};
...
manager::manager() {
...

  {
    ...
    holder->add_property("integer", "category", "description",
                         s_test_property.m_property, getter, setter);
  }

  {
    ...
    holder->add_property("integer_limited", "category", "description",
                         s_test_property_limited.m_property, getter, setter, 0,
                         10);
  }

  {
    ...
    holder->add_property("integer_values", "category", "description",
                         s_test_property_limited.m_property, getter, setter,
                         s_properties, 3);
  }

  {
    ...
    holder->add_property("integer_enum", "category", "description",
                         s_test_property_enum.m_property, getter, setter,
                         s_properties_enum, 3);
  }

  {
    ...
    holder->add_property(
        "string", "category", "description", s_test_property2.m_property,
...

  {
    ...
    holder->add_property("string_values", "category", "description",
                         s_test_property3.m_property, getter, setter,
                         s_properties3, 3);
  }

  {
    ...
    holder->add_property("boolean", "category", "description",
                         s_test_property4.m_property, getter, setter);
  }

  {
    ...
    holder->add_property("boolean_values", "category", "description",
                         s_test_property5.m_property, getter, setter,
                         s_properties5);
  }

  {
    ...
    holder->add_property("color", "category", "description",
                         s_test_property6.m_property, getter, setter);
  }

  {
    ...
    holder->add_property("float", "category", "description",
                         s_test_property7.m_property, getter, setter);
  }
...

  {
    ...
    holder->add_property("float_enum", "category", "description",
                         s_test_property7_values_enum.m_property, getter,
