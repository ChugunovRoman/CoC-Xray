...
#define script_type_list save_type_list(CSE_ALifeAnomalousZone)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeTorridZone, CSE_ALifeCustomZone,
                                 CSE_Motion)
...
#define script_type_list save_type_list(CSE_ALifeZoneVisual)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeCreatureAbstract,
                                CSE_ALifeDynamicObjectVisual) private
    : float fHealth;
...
#define script_type_list save_type_list(CSE_ALifeCreatureActor)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeCreatureCrow,
                                CSE_ALifeCreatureAbstract)
...
#define script_type_list save_type_list(CSE_ALifeMonsterRat)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeMonsterZombie,
