...
void CScriptNetPacket::script_register(lua_State *L) {
  module(
      L)[def("script_server_object_version", &script_server_object_version),
         ...
         class_<NET_Packet>("net_packet")
             ...
             .def("w_stringZ",
                  (void (NET_Packet::*)(LPCSTR))(&NET_Packet::w_stringZ))
             ...
             .def("r_vec3",
                  ...
                  pure_out_value(_2))
             .def("r_float",
                  (void (NET_Packet::*)(float &))(&NET_Packet::r_float))
             ...
             .def("r_float_q16", (void (NET_Packet::*)(float &, float, float))(
                                     &NET_Packet::r_float_q16))
             .def("r_float_q8", (void (NET_Packet::*)(float &, float, float))(
