...
public:
  ...
  CScriptIniFile(LPCSTR szFileName, BOOL ReadOnly = TRUE,
                 BOOL bLoadAtStart = TRUE, BOOL SaveAtEnd = TRUE,
                 LPCSTR path = NULL);
  ...
  void w_fvector2(LPCSTR S, LPCSTR L, const Fvector2 &V,
                  LPCSTR comment /* = 0 */);
  void w_fvector3(LPCSTR S, LPCSTR L, const Fvector3 &V,
                  LPCSTR comment /* = 0 */);
  void w_fvector4(LPCSTR S, LPCSTR L, const Fvector4 &V,
                  LPCSTR comment /* = 0 */);
