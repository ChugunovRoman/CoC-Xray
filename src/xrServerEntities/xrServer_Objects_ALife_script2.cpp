...
void CSE_ALifeObjectProjector::script_register(lua_State *L) {
  module(L)[luabind_class_dynamic_alife1(CSE_ALifeObjectProjector,
...
void CSE_ALifeHelicopter::script_register(lua_State *L) {
  module(L)[luabind_class_dynamic_alife3(
      CSE_ALifeHelicopter, "cse_alife_helicopter", CSE_ALifeDynamicObjectVisual,
...
void CSE_ALifeObjectClimable::script_register(lua_State *L) {
  module(L)[luabind_class_abstract2(CSE_ALifeObjectClimable,
                                    "cse_alife_object_climable", CSE_Shape,
                                    CSE_Abstract)];
}
