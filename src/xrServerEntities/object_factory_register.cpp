...
void CObjectFactory::register_classes() {
  ...
  //  [8/15/2006]
  ADD(CWeaponMagazined, CSE_ALifeItemWeaponMagazined, CLSID_OBJECT_W_MAGAZINED,
      "wpn_wmagaz");
  //  [8/15/2006]
  //  [8/17/2006]
  ...
  ADD(CWeaponFORT, CSE_ALifeItemWeaponMagazined, CLSID_OBJECT_W_FORT,
      "wpn_fort");
  ADD(CWeaponBinoculars, CSE_ALifeItemWeaponMagazined, CLSID_OBJECT_W_BINOCULAR,
      "wpn_binocular");
  ...
  // Equipment outfit
  ADD(CCustomOutfit, CSE_ALifeItemCustomOutfit, CLSID_EQUIPMENT_STALKER,
      "equ_stalker");
