...
// ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError, "CWeapon
...
protected:
  ...
  bool parse_namespace(LPCSTR caNamespaceName, LPSTR b, u32 const b_size,
                       LPSTR c, u32 const c_size);
...
public:
  ...
  bool load_buffer(lua_State *L, LPCSTR caBuffer, size_t tSize,
  ...
  static bool print_output(lua_State *L, LPCSTR caScriptName,
                           int iErorCode = 0);
