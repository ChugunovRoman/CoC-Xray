...
DECLARE_SPECIALIZATION(IKinematicsAnimated, IRenderVisual,
...
DECLARE_SPECIALIZATION(IKinematicsAnimated, IKinematics,
                       dcast_PKinematicsAnimated);
#undef cast_type_list
...
template <>
extern Feel::Sound *
SmartDynamicCast::smart_cast<Feel::Sound, ISpatial>(ISpatial *p);
...
DECLARE_SPECIALIZATION(CPhysicsShellHolder, CGameObject,
...
cast_effector_shot); #		undef cast_type_list #		define
cast_type_list save_cast_list	(CCameraShotEffector,		CCameraEffector)

                DECLARE_SPECIALIZATION	(CEffectorZoomInertion, CCameraEffector,
cast_effector_zoom_inertion); #		undef cast_type_list #		define
cast_type_list save_cast_list	(CEffectorZoomInertion,	CCameraEffector)
*/
...
DECLARE_SPECIALIZATION(CSE_ALifeGroupAbstract, CSE_Abstract,
                       cast_group_abstract);
#undef cast_type_list
...
DECLARE_SPECIALIZATION(CSE_ALifeInventoryItem, CSE_Abstract,
                       cast_inventory_item);
#undef cast_type_list
#define cast_type_list save_cast_list(CSE_ALifeInventoryItem, CSE_Abstract)

DECLARE_SPECIALIZATION(CSE_ALifeTraderAbstract, CSE_Abstract,
...
DECLARE_SPECIALIZATION(CSE_ALifeDynamicObject, CSE_Abstract,
...
DECLARE_SPECIALIZATION(CSE_ALifeMonsterAbstract, CSE_Abstract,
                       cast_monster_abstract);
#undef cast_type_list
#define cast_type_list save_cast_list(CSE_ALifeMonsterAbstract, CSE_Abstract)

DECLARE_SPECIALIZATION(CSE_ALifeHumanAbstract, CSE_Abstract,
                       cast_human_abstract);
#undef cast_type_list
#define cast_type_list save_cast_list(CSE_ALifeHumanAbstract, CSE_Abstract)

DECLARE_SPECIALIZATION(CSE_ALifeAnomalousZone, CSE_Abstract,
                       cast_anomalous_zone);
#undef cast_type_list
...
DECLARE_SPECIALIZATION(CSE_ALifeCreatureAbstract, CSE_Abstract,
...
DECLARE_SPECIALIZATION(CSE_ALifeOnlineOfflineGroup, CSE_Abstract,
