...
tfGetActionType(CSE_ALifeSchedulable *tpALifeSchedulable, int iGroupIndex,
...
virtual void __stdcall on_render(CDUInterface *du, ISE_AbstractLEOwner *owner,
...
#define script_type_list save_type_list(CSE_ALifeObject)
    ...
    SERVER_ENTITY_DECLARE_BEGIN0(CSE_ALifeGroupAbstract) ALife::OBJECT_VECTOR
    m_tpMembers;
...
void detach(CSE_ALifeInventoryItem *tpALifeInventoryItem,
            ALife::OBJECT_IT *I = 0, bool bALifeRequest = true,
...
#define script_type_list save_type_list(CSE_ALifeLevelChanger)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeSmartZone, CSE_ALifeSpaceRestrictor,
...
#define script_type_list save_type_list(CSE_ALifeObjectProjector)
    ...
    SERVER_ENTITY_DECLARE_BEGIN3(CSE_ALifeHelicopter,
                                 CSE_ALifeDynamicObjectVisual, CSE_Motion,
...
#define script_type_list save_type_list(CSE_ALifeObjectBreakable)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(CSE_ALifeObjectClimable, CSE_Shape,
                                 CSE_ALifeDynamicObject)
