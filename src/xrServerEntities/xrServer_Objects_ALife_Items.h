...
#define script_type_list save_type_list(CSE_ALifeInventoryItem)
    ...
    SERVER_ENTITY_DECLARE_BEGIN2(
        CSE_ALifeItem, CSE_ALifeDynamicObjectVisual,
...
// void							set_addon_flags(const Flags8
// &_flags) { m_addon_flags.flags = _flags.flags; }
...
#define script_type_list save_type_list(CSE_ALifeItemWeaponAutoShotGun)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeItemDetector,
                                CSE_ALifeItem) u32 m_ef_detector_type;
...
#define script_type_list save_type_list(CSE_ALifeItemDetector)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeItemArtefact,
                                CSE_ALifeItem) float m_fAnomalyValue;
...
#define script_type_list save_type_list(CSE_ALifeItemArtefact)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeItemPDA,
                                CSE_ALifeItem) u16 m_original_owner;
...
#define script_type_list save_type_list(CSE_ALifeItemPDA)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeItemDocument,
                                CSE_ALifeItem) shared_str m_wDoc;
...
#define script_type_list save_type_list(CSE_ALifeItemDocument)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeItemGrenade,
                                CSE_ALifeItem) u32 m_ef_weapon_type;
...
#define script_type_list save_type_list(CSE_ALifeItemExplosive)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeItemBolt,
                                CSE_ALifeItem) u32 m_ef_weapon_type;
...
#define script_type_list save_type_list(CSE_ALifeItemBolt)
    ...
    SERVER_ENTITY_DECLARE_BEGIN(CSE_ALifeItemCustomOutfit,
                                CSE_ALifeItem) u32 m_ef_equipment_type;
