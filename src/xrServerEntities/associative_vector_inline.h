...
_associative_vector::begin() const {
  actualize();
  return (inherited::begin());
}
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::size_type
_associative_vector::max_size() const {
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::mapped_type &
_associative_vector::operator[](const key_type &key) {
  iterator I = find(key);
  if (I != end())
    return ((*I).second);
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::key_compare
_associative_vector::key_comp() const {
  return (key_compare());
}

TEMPLATE_SPECIALIZATION
IC typename _associative_vector::value_compare
_associative_vector::value_comp() const {
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::size_type
_associative_vector::erase(const key_type &key) {
  iterator I = find(key);
  if (I == end())
    return (0);
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::iterator
_associative_vector::lower_bound(const key_type &key) {
  actualize();
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::iterator
_associative_vector::upper_bound(const key_type &key) {
  actualize();
  value_compare &self = *this;
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::iterator
_associative_vector::insert(iterator where, const value_type &value) {
  if ((where != end()) && (operator()(*where, value)) &&
      ((where - begin()) == size()) && (!operator()(value, *(where + 1))) &&
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::iterator
_associative_vector::find(const key_type &key) {
  actualize();
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::size_type
_associative_vector::count(const key_type &key) const {
  actualize();
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::self_type &
_associative_vector::operator=(const self_type &right) {
