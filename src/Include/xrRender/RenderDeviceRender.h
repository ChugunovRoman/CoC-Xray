...
public:
  ...
  virtual void Create(HWND hWnd, u32 &dwWidth, u32 &dwHeight, float &fWidth_2,
                      float &fHeight_2, bool) = 0;
  virtual void SetupGPU(BOOL bForceGPU_SW, BOOL bForceGPU_NonPure,
  ...
  virtual void ResourcesGetMemoryUsage(u32 &m_base, u32 &c_base, u32 &m_lmaps,
                                       u32 &c_lmaps) = 0;
