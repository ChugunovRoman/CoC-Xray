...
const char *TiXmlDocument::Parse(TiXmlDocument *, const char *p,
...
//0, TIXML_ENCODING_UNKNOWN ); 			return;
//		}
//		(*tag) += (char) c ;
//
//		if ( c == '>' )
...
const char *TiXmlElement::Parse(TiXmlDocument *document, const char *p,
...
const char *TiXmlUnknown::Parse(TiXmlDocument *document, const char *p,
                                TiXmlParsingData *data,
                                TiXmlEncoding encoding) {
  p = SkipWhiteSpace(p, encoding);
...
const char *TiXmlComment::Parse(TiXmlDocument *document, const char *p,
                                TiXmlParsingData *data,
                                TiXmlEncoding encoding) {
  value = "";
...
const char *TiXmlAttribute::Parse(TiXmlDocument *document, const char *p,
                                  TiXmlParsingData *data,
                                  TiXmlEncoding encoding) {
  p = SkipWhiteSpace(p, encoding);
  if (!p || !*p)
...
const char *TiXmlText::Parse(TiXmlDocument *document, const char *p,
                             TiXmlParsingData *data, TiXmlEncoding encoding) {
  value = "";
...
const char *TiXmlDeclaration::Parse(TiXmlDocument *document, const char *p,
                                    TiXmlParsingData *data,
