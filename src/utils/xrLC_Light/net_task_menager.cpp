...
#ifdef _DEBUG
LPCSTR libraries = "XRLC_LightStab.dll,XRLC_Light.dll,xrCore.dll,xrCDB.dll,DXT."
                   "dll,BugTrapD.dll,msvcr80.dll,Microsoft.VC80.CRT.manifest";
#else
LPCSTR libraries = "XRLC_LightStab.dll,XRLC_Light.dll,xrCore.dll,xrCDB.dll,DXT."
                   "dll,BugTrap.dll,msvcr80.dll,Microsoft.VC80.CRT.manifest";
#endif
