...
public:
  xrMU_Reference()
      : model(0), sector(u16(-1)), flags(Flags32().assign(0)),
        xform(Fidentity) {}
...
typedef vector_serialize<
    t_read<xrMU_Reference, get_id_standart<xrMU_Reference>>>
    tread_mu_refs;
typedef vector_serialize<
    t_write<xrMU_Reference, get_id_standart<xrMU_Reference>>>
    twrite_mu_refs;
