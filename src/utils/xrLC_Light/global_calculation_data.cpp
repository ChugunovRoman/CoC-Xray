    ...
    Status("Processing textures...");
    {
      ...
      for (u32 t = 0; t < tex_count; t++) {
        ...
        if (0 == xr_strcmp(N, "level_lods")) {
          ...
          // load surface if it has an alpha channel or has "implicit lighting"
          // flag
...
// /////////////////////lc Shader_xrLC_LIB*
// g_shaders_xrlc;////////////////lc b_params
// g_params;//////////////////////lc xr_vector<b_material>
// g_materials;///////////////////lc xr_vector<b_BuildTexture>
// g_textures;////////////////////lc CDB::MODEL
// RCAST_Model;///////////////////lc

// Fbox
// LevelBB;//-----------============ global_slots_data
// slots_data;//-------============= xr_vector<b_shader>
// g_shader_compile;//-----========== xr_vector<b_rc_face>
// g_rc_faces;//---------===============
