...
void Face::TessMark(int E) {
  ...
  if ((TESS_MASK & TESS_EDGE_0) && (TESS_MASK & TESS_EDGE_1) &&
      !(TESS_MASK & TESS_EDGE_2))
    TessMark(2);
  if ((TESS_MASK & TESS_EDGE_0) && (TESS_MASK & TESS_EDGE_2) &&
      !(TESS_MASK & TESS_EDGE_1))
    TessMark(1);
  if ((TESS_MASK & TESS_EDGE_1) && (TESS_MASK & TESS_EDGE_2) &&
      !(TESS_MASK & TESS_EDGE_0))
    TessMark(0);
}
