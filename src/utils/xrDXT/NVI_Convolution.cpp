...
void ConvolutionKernel::SetElements(int numElements,
                                    ConvolutionKernelElement *pElements) {
...
//===============================================================
void ConvolutionKernel::GetKernelExtents(int *xlow, int *xhigh, int *ylow,
                                         int *yhigh) {
  ...
  //.	ASSERT_MSG( ((xlow!=NULL)&&(ylow!=NULL)&&(xhigh!=NULL)&&(yhigh!=NULL)),
...
HRESULT Convolver::Initialize(NVI_Image **hSrcImage,
                              const ConvolutionKernel *pKernels, int numKernels,
                              bool wrap) {
...
void Convolver::Convolve_Alpha_At(int i, int j, float *results,
                                  int num_results) {
