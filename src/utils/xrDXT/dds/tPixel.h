...
public:
  ...
  rgba_t(unsigned char _r, unsigned char _g, unsigned char _b,
         unsigned char _a) {
    a = _a;
    r = _r;
    g = _g;
  ...
  unsigned long bgra() {
    return (unsigned long)a << 24 | (unsigned long)r << 16 |
  ...
  friend rgba_t operator+(const rgba_t &v1, const rgba_t &v2) {
    ...
    return rgba_t((unsigned char)r, (unsigned char)g, (unsigned char)b,
                  (unsigned char)a);
  }

  friend rgba_t operator/(const rgba_t &v, float s) {
    return rgba_t((unsigned char)(v.r / s), (unsigned char)(v.g / s),
                  (unsigned char)(v.b / s), (unsigned char)(v.a / s));
  }
...
public:
  ...
  rgba16_t(unsigned short _r, unsigned short _g, unsigned short _b,
           unsigned short _a) {
    a = _a;
    r = _r;
    g = _g;
  ...
  friend rgba16_t operator+(const rgba16_t &v1, const rgba16_t &v2) {
    ...
    return rgba16_t((unsigned char)r, (unsigned char)g, (unsigned char)b,
                    (unsigned char)a);
  }
  ...
  void set(unsigned short _r, unsigned short _g, unsigned short _b,
           unsigned short _a) {
    r = _r;
    g = _g;
    b = _b;
...
public:
  ...
  RGBAMipMappedVolumeMap(size_t width, size_t height, size_t depth,
                         size_t nMIPMaps) {
...
public:
  ...
  fpMipMappedVolumeMap(size_t width, size_t height, size_t depth,
                       size_t nMIPMaps) {
    resize(width, height, depth, nMIPMaps);
  }
