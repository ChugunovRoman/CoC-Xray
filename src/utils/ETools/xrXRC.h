...
public:
  ...
  IC void ray_query(const CDB::MODEL *m_def, const Fvector &r_start,
  ...
  IC void ray_query(const Fmatrix &inv_parent, const CDB::MODEL *m_def,
                    const Fvector &r_start, const Fvector &r_dir,
                    float r_range) {
    // transform
    Fvector S, D;
  ...
  IC void box_query(const CDB::MODEL *m_def, const Fvector &b_center,
                    const Fvector &b_dim) {
#ifndef NO_XRC_STATS
  ...
  IC void box_query(const Fmatrix &inv_parent, const CDB::MODEL *m_def,
                    const Fbox &src) {
    Fbox dest;
