...
#pragma pack(push, 1)
struct VIPM_SWR {
  u32 offset;    // Offset of the first index in the index buffer to start at
                 // (note! no retrictions. Can easily be >64k)
  u16 num_tris;  // Number of tris to render (most cards can't do more than
                 // 65536)
...
ETOOLS_API void __stdcall VIPM_AppendVertex(const Fvector3 &pt,
                                            const Fvector2 &uv);
