#ifndef BinaryHeapH
#define BinaryHeapH
// A binary heap. Actually stores pointers to type THING, not the THINGs
// themselves.
...
#ifdef DEBUG
  // A flag that says using FindNext, RemoveNext and RemoveCurrent are OK to
  // call.
  bool bFindNextValid;
#endif
...
public:
  ...
  void Add(THING *pThisThing, SORT ThisSort) {
    ...
    while ((iCurrentPos > 1) &&
           (pBlobArray[iCurrentPos >> 1].Sort < ThisSort)) {
