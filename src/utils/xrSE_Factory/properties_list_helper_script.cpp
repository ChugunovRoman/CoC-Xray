...
void load_prop_helper() {
  ...
  if (!_PHelper) {
    Msg("! Cannot find entry point of the function %s in the library %s",
        prop_helper_func, prop_helper_func);
    return;
  }
...
IPropHelper &PHelper() {
  ...
  R_ASSERT3(_PHelper,
            "Cannot find entry point of the function or Cannot find library",
            prop_helper_library);
  return (_PHelper());
}
...
void CScriptPropertiesListHelper::script_register(lua_State *L) {
  module(L)
      [class_<PropValue>("prop_value"), class_<PropItemVec>("prop_item_vec"),
       ...
       class_<CanvasValue>("canvas_value"), class_<ButtonValue>("button_value"),
       class_<ChooseValue>("choose_value"), class_<S8Value>("s8_value"),
       class_<S16Value>("s16_value"), class_<S32Value>("s32_value"),
       class_<U8Value>("u8_value"), class_<U16Value>("u16_value"),
       class_<U32Value>("u32_value"), class_<FloatValue>("u32_value"),
       class_<BOOLValue>("bool_value"), class_<VectorValue>("vector_value"),
       class_<ColorValue>("color_value"), class_<RTextValue>("text_value"),
       class_<Flag8Value>("flag8_value"), class_<Flag16Value>("flag16_value"),
       ...
       class_<CChooseType>("choose_type")
           .enum_("choose_type")[value("custom", int(smCustom)),
       ...
       class_<CScriptPropertiesListHelper>("properties_list_helper")
           .def("vector_on_after_edit",
                &CScriptPropertiesListHelper::FvectorRDOnAfterEdit)
           .def("vector_on_before_edit",
                &CScriptPropertiesListHelper::FvectorRDOnBeforeEdit)
           //			.def("vector_on_draw",
           //&CScriptPropertiesListHelper::FvectorRDOnDraw)
           .def("float_on_after_edit",
                &CScriptPropertiesListHelper::floatRDOnAfterEdit)
           .def("float_on_before_edit",
                &CScriptPropertiesListHelper::floatRDOnBeforeEdit)
           //			.def("float_on_draw",
           //&CScriptPropertiesListHelper::floatRDOnDraw)
           .def("name_after_edit", &CScriptPropertiesListHelper::NameAfterEdit)
           .def("name_before_edit",
                &CScriptPropertiesListHelper::NameBeforeEdit)
           //			.def("name_on_draw",
           ...
           .def("create_choose",
                (ChooseValue * (CScriptPropertiesListHelper::*)(PropItemVec *,
                                                                LPCSTR,
                                                                luabind::object,
                                                                LPCSTR, u32))(
           ...
           .def("create_choose",
                (ChooseValue *
                 (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR,
           ...
           //.def("create_s8", (S8Value
           //*(CScriptPropertiesListHelper::*)(PropItemVec*, LPCSTR,
           // luabind::object , LPCSTR ,  s8))
           //(&CScriptPropertiesListHelper::CreateS8))
           //.def("create_s8", (S8Value
           //*(CScriptPropertiesListHelper::*)(PropItemVec*, LPCSTR,
           // luabind::object , LPCSTR ,  s8,  s8))
           //(&CScriptPropertiesListHelper::CreateS8))
           //.def("create_s8", (S8Value
           //*(CScriptPropertiesListHelper::*)(PropItemVec*, LPCSTR,
           // luabind::object , LPCSTR ,  s8,  s8,  s8))
           //(&CScriptPropertiesListHelper::CreateS8))
           ...
           .def("create_s16",
                (S16Value * (CScriptPropertiesListHelper::*)(PropItemVec *,
                                                             LPCSTR,
                                                             luabind::object,
                                                             LPCSTR, s16))(
                    &CScriptPropertiesListHelper::CreateS16))
           ...
           .def("create_s32",
                (S32Value * (CScriptPropertiesListHelper::*)(PropItemVec *,
                                                             LPCSTR,
                                                             luabind::object,
                                                             LPCSTR, s32))(
                    &CScriptPropertiesListHelper::CreateS32))
           ...
           .def("create_u8",
                (U8Value *
                 (CScriptPropertiesListHelper::*)(PropItemVec *, LPCSTR,
                    ...
                    &CScriptPropertiesListHelper::CreateU8))
           .def("create_u8",
                (U8Value * (CScriptPropertiesListHelper::*)(PropItemVec *,
                                                            LPCSTR,
                                                            luabind::object,
                                                            LPCSTR, u8, u8))(
                    &CScriptPropertiesListHelper::CreateU8))
           ...
           .def("create_u16",
                (U16Value * (CScriptPropertiesListHelper::*)(PropItemVec *,
                                                             LPCSTR,
                                                             luabind::object,
                                                             LPCSTR, u16))(
                    &CScriptPropertiesListHelper::CreateU16))
           ...
           .def("create_u32",
                (U32Value * (CScriptPropertiesListHelper::*)(PropItemVec *,
                                                             LPCSTR,
                                                             luabind::object,
                                                             LPCSTR, u32))(
                    &CScriptPropertiesListHelper::CreateU32))
           ...
           .def("create_float",
                (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec *,
                                                               LPCSTR,
                                                               luabind::object,
                                                               LPCSTR, float))(
                    &CScriptPropertiesListHelper::CreateFloat))
           ...
           .def("create_vector",
                (VectorValue * (CScriptPropertiesListHelper::*)(PropItemVec *,
                                                                LPCSTR,
                                                                luabind::object,
                                                                LPCSTR, float))(
                    &CScriptPropertiesListHelper::CreateVector))
           ...
           .def("create_flag16",
                (Flag16Value * (CScriptPropertiesListHelper::*)(PropItemVec *,
                                                                LPCSTR,
                                                                luabind::object,
                                                                LPCSTR, u16))(
           ...
           .def("create_flag32",
                (Flag32Value * (CScriptPropertiesListHelper::*)(PropItemVec *,
                                                                LPCSTR,
                                                                luabind::object,
                                                                LPCSTR, u32))(
