...
static unsigned short
    award_atlas_stats_map[at_awards_count][ap_award_params_count] = {
        {STAT_AwardMasscare,
        ...
        {STAT_AwardClimber,
         STAT_AwardClimberLastRewardDate},                  // mp_award_climber
        ...
        {STAT_AwardOculist,
         STAT_AwardOculistLastRewardDate}, // mp_award_oculist
        ...
        {STAT_AwardAvenger,
         STAT_AwardAvengerLastRewardDate},                  // mp_award_avenger
        {STAT_AwardCherub, STAT_AwardCherubLastRewardDate}, // mp_award_cherub
        {STAT_AwardDignity,
         STAT_AwardDignityLastRewardDate}, // mp_award_dignity
...
enum_awards_t get_award_by_stat_rdate_name(char const *stat_name) {
  for (int i = 0; i < at_awards_count; ++i) {
    if (!strcmp(stat_name, ATLAS_GET_STAT_NAME(
                               award_atlas_stats_map[i][ap_award_rdate]))) {
      return static_cast<enum_awards_t>(i);
    }
  }
  return static_cast<enum_awards_t>(at_awards_count);
