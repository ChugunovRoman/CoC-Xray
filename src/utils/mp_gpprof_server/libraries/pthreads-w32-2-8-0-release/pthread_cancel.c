...
static void CALLBACK ptw32_cancel_callback(DWORD unused) {
  ptw32_throw(PTW32_EPS_CANCEL);
  ...
  if (tp->cancelType == PTHREAD_CANCEL_ASYNCHRONOUS &&
    ...
    if (cancel_self) {
      ...
      if (WaitForSingleObject(threadH, 0) == WAIT_TIMEOUT) {
         ...
         * will result in a call to QueueUserAPCEx with the args given,
         * otherwise this will result in a call to ptw32_RegisterCancelation and
         * only the threadH arg will be used.
         */
