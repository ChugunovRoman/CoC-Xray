 ...
 * DESCRIPTION
 *
 *       This routine causes a thread to delay execution for a specific period
 * of time. This period ends at the current time plus the specified interval.
 * The routine will not return before the end of the period is reached, but may
 * return an arbitrary amount of time after the period has gone by. This can be
 * due to system load, thread priorities, and system timer granularity.
 *
