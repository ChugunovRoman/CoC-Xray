...
// and SNSystems having not produce a patch yet (they'll likely do the same
// since the SNSystems fd_set is a slightly different size than the sys/types.h.
#undef FD_CLR
#undef FD_ZERO
#undef FD_SET
#undef FD_ISSET
...
// ICMP ping support is unsupported on Linux/MacOSX due to needing super-user
// access for raw sockets
