...
template <class T, int size> DoubleBuffer<T, size>::DoubleBuffer() { init(); }
...
void DoubleBuffer<T, size>::backBufferDmaGet(uint64_t ea, unsigned int numBytes,
                                             unsigned int tag) {
  m_dmaPending = true;
  m_dmaTag = tag;
...
template <class T, int size>
void DoubleBuffer<T, size>::backBufferDmaPut(uint64_t ea, unsigned int numBytes,
                                             unsigned int tag) {
  m_dmaPending = true;
  m_dmaTag = tag;
