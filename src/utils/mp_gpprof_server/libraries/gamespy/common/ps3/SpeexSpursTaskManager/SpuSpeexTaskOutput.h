...
#define SPEEX_ENCODER_STATE_BUFFER_SIZE                                        \
  (SPEEX_ENCODER_NB_BUFFERSIZE + SPEEX_ENCODER_WB_BUFFERSIZE + 128)
#define SPEEX_DECODER_NB_BUFFERSIZE 16832
#define SPEEX_DEOCDER_WB_BUFFERSIZE 24192
#define SPEEX_DECODER_STATE_BUFFER_SIZE                                        \
  (SPEEX_DECODER_NB_BUFFERSIZE + SPEEX_DEOCDER_WB_BUFFERSIZE + 128)
//#define SPEEX_STATE_
