...
static const CARDBackupType BackupTypes[] = {
    CARD_BACKUP_TYPE_EEPROM_4KBITS,   CARD_BACKUP_TYPE_EEPROM_64KBITS,
...
static const char *BackupTypeDescriptions[] = {"EEPROM 4 kb", "EEPROM 64 kb",
                                               "EEPROM 512 kb",
#if defined(SUPPORT_FLASH)
                                               "FLASH 2 mb",
#endif
...
static const int NumBackupTypes =
    (sizeof(BackupTypes) / sizeof(BackupTypes[0]));
