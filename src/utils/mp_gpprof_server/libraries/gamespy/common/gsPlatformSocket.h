...
#define getsockopt(s, l, on, ov, ol)                                           \
  sceNetInetGetsockopt(s, l, on, ov, (SceNetInetSocklen_t *)ol)
...
#define recvfrom(s, b, l, f, fr, fl)                                           \
  sceNetInetRecvfrom(s, b, l, f, fr, (SceNetInetSocklen_t *)fl)

#define inet_addr sceNetInetInetAddr
// This is not the correct function for gethostname, it should get the string
// name of the local host not the sockaddr_in struct
#define gethostname // sceNetInetGetsockname
#define getsockname(s, n, l)                                                   \
  sceNetInetGetsockname(s, n, (SceNetInetSocklen_t *)l)
...
// make caps types interchangeable on all platforms
    ...
    !defined(_REVOLUTION) // necessary for Wii??
typedef int SOCKET;
...
#define recvfrom(s, b, l, f, a, al)                                            \
  (int)recvfrom(s, b, (unsigned long)l, f, a, al)
#endif
#endif
