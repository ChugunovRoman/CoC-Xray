...
// if the port of the local address is 0, then a port will be assigned.
// if either buffer sizes is set to 0, a default value will be used (currently
// 4K). the buffer needs to be able to hold all messages waiting for
// confirmation of delivery, and it needs to hold any messages that arrive out
// of order. if either buffer runs out of space the connection will be dropped.
