...
static GHTTPBool NaminatorCallback(GHTTPRequest request, GHTTPResult result,
...
static void ParseArgs(int argc, char **argv) {
  ...
  if (!gotNick) {
    ...
    ghttpGetFile("http://www.planetquake.com/excessive/name.asp", GHTTPTrue,
                 NaminatorCallback, NULL);
  }
}
