...
protected:
  double check_local_compactness(unsigned int v1, unsigned int v2,
                                 const float *vnew);
  double check_local_inversion(unsigned int v1, unsigned int v2,
                               const float *vnew);
  unsigned int check_local_validity(unsigned int v1, unsigned int v2,
                                    const float *vnew);
  unsigned int check_local_degree(unsigned int v1, unsigned int v2,
                                  const float *vnew);
