...
protected:
  ...
  //			void
  //add_spawn_group (CSE_Abstract			*abstract);
  ...
  //			void
  //add_group_object (CSE_Abstract			*abstract, shared_str
  //group_section, bool); 			void
  // add_group_object (CSE_Abstract			*abstract, shared_str
  //group_section);
  void add_level_changer(CSE_Abstract *abstract);
  void update_artefact_spawn_positions();
  //	IC		void
  //normalize_probability (CSE_ALifeAnomalousZone *zone); 	IC
  //void free_group_objects					();
