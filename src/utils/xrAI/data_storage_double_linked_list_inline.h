...
#define CDoubleLinkedList                                                      \
  CDataStorageDoubleLinkedList<sorted>::CDataStorage<_data_storage, _vertex>

TEMPLATE_SPECIALIZATION
IC CDoubleLinkedList::CDataStorage(
...
TEMPLATE_SPECIALIZATION
IC typename CDoubleLinkedList::CGraphVertex &
CDoubleLinkedList::get_best() const {
  VERIFY(!is_opened_empty());
  if (sorted)
