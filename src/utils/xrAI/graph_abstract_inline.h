...
TEMPLATE_SPECIALIZATION
IC typename CAbstractGraph::CVertex *
CAbstractGraph::vertex(const _vertex_id_type &vertex_id) {
  vertex_iterator I = m_vertices.find(vertex_id);
  if (m_vertices.end() == I)
    return (0);
  return ((*I).second);
...
CAbstractGraph::edge(const _vertex_id_type &vertex_id0,
...
IC const _edge_weight_type CAbstractGraph::get_edge_weight(
    const _vertex_id_type vertex_index0, const _vertex_id_type vertex_index1,
...
TEMPLATE_SPECIALIZATION
IC bool
CAbstractGraph::is_accessible(const _vertex_id_type vertex_index) const {
  return (true);
}

TEMPLATE_SPECIALIZATION
IC const typename CAbstractGraph::CVertex *
CAbstractGraph::value(const _vertex_id_type vertex_index,
                      const_iterator i) const {
  return ((*i).vertex());
}

TEMPLATE_SPECIALIZATION
IC void CAbstractGraph::begin(const CVertex *vertex, const_iterator &b,
