...
#define CHashFixedVertexManager                                                \
  CVertexManagerHashFixed<_path_id_type, _index_type, hash_size, fix_size>::   \
      CDataStorage<_vertex, _index_vertex, _data_storage>
...
TEMPLATE_SPECIALIZATION
IC bool
CHashFixedVertexManager::is_visited(const _index_type &vertex_id) const {
