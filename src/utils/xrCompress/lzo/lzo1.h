...
LZO_EXTERN(int)
lzo1_compress(const lzo_byte *src, lzo_uint src_len, lzo_byte *dst,
              lzo_uintp dst_len, lzo_voidp wrkmem);

LZO_EXTERN(int)
lzo1_decompress(const lzo_byte *src, lzo_uint src_len, lzo_byte *dst,
...
LZO_EXTERN(int)
lzo1_99_compress(const lzo_byte *src, lzo_uint src_len, lzo_byte *dst,
                 lzo_uintp dst_len, lzo_voidp wrkmem);
#endif
