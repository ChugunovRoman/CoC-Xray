...
// -----------------------------------------------------------------------
IC bool IntersectRaySphere(const Fvector &rO, const Fvector &rV,
...
IC bool TestRayTri(const Fvector &C, const Fvector &D, Fvector **p, float &u,
...
//--------------------------------
IC bool TestRayTri2(const Fvector &C, const Fvector &D, Fvector *p,
                    float &range) {
  Fvector edge1, edge2, tvec, pvec, qvec;
...
IC bool TestBBoxTri(const Fmatrix33 &A, const Fvector &T, const Fvector &extA,
                    Fvector **p, BOOL bCulling) {
...
//----------------------------------------------------------------------------
IC float MgcSqrDistance(const Fvector &rkPoint, const Fvector &orig,
...
IC EST_Result TestSphereTri(const Fvector &sphereOrigin, float sphereRadius,
                            const Fvector &orig, const Fvector &e0,
                            const Fvector &e1) {
...
//----------------------------------------------------------------------------
IC bool TestRayOBB(const Fvector3 &origin, const Fvector3 &direction,
                   const Fobb &rkBox) {
