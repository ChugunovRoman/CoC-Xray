...
void *__stdcall xr_aligned_offset_malloc(size_t size, size_t align,
                                         size_t offset) {
...
void *__stdcall xr_aligned_realloc(void *memblock, size_t size,
                                   size_t alignment) {
...
void *__stdcall xr_aligned_offset_realloc(void *memblock, size_t size,
