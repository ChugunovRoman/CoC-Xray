...
bool EFS_Utils::GetOpenNameInternal(LPCSTR initial, LPSTR buffer, int sz_buf,
                                    bool bMulti, LPCSTR offset,
                                    int start_flt_ext) {
...
bool EFS_Utils::GetSaveName(LPCSTR initial, string_path &buffer, LPCSTR offset,
                            int start_flt_ext) {
  // unsigned int dwVersion = GetVersion();
  // unsigned int dwWindowsMajorVersion = (DWORD)(LOBYTE(LOWORD(dwVersion)));
...
//----------------------------------------------------
LPCSTR EFS_Utils::AppendFolderToName(LPSTR tex_name, u32 const tex_name_size,
...
LPCSTR EFS_Utils::AppendFolderToName(LPCSTR src_name, LPSTR dest_name,
...
LPCSTR EFS_Utils::GenerateName(LPCSTR base_path, LPCSTR base_name,
                               LPCSTR def_ext, LPSTR out_name,
