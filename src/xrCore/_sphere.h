...
public:
  ...
  ICF ERP_Result intersect(const _vector3<T> &S, const _vector3<T> &D, T range,
  ...
  ICF ERP_Result intersect_full(const _vector3<T> &start,
                                const _vector3<T> &dir, T &dist) const {
    int quantity;
    float afT[2];
  ...
  ICF ERP_Result intersect(const _vector3<T> &start, const _vector3<T> &dir,
                           T &dist) const {
    int quantity;
    T afT[2];
  ...
  IC ERP_Result intersect2(const _vector3<T> &S, const _vector3<T> &D,
                           T &range) const {
    _vector3<T> Q;
    Q.sub(P, S);
