...
public:
  ...
  ICF SelfRef set(const Tvector &R, const Tvector &N, const Tvector &D,
                  const Tvector &C) {
    i.set(R);
    _14_ = 0;
    j.set(N);
  ...
  IC bool
  invert_b(const Self &a) // important: this is 4x3 invert, not the 4x4 one
  {
    // faster than self-invert
    T fDetInv = (a._11 * (a._22 * a._33 - a._23 * a._32) -
                 a._12 * (a._21 * a._33 - a._23 * a._31) +
  ...
  IC SelfRef build_camera(const Tvector &vFrom, const Tvector &vAt,
