...
template <int N> struct SimplifyMemFunc {
  ...
  inline static GenericClass *xr_stdcall Convert(
      X *pthis, XFuncType function_to_bind, GenericMemFuncType &bound_func) {
...
public:
  ...
  FastDelegate0(const Y *pthis,
                DesiredRetType (xr_stdcall X::*function_to_bind)() const) {
...
public:
  ...
  FastDelegate1(Y *pthis,
                DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1)) {
    m_Closure.bindmemfunc(detail::implicit_cast<X *>(pthis), function_to_bind);
  }
  template <class X, class Y>
  inline void
  bind(Y *pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(Param1 p1)) {
    m_Closure.bindmemfunc(detail::implicit_cast<X *>(pthis), function_to_bind);
  }
  // Binding to const member functions.
  template <class X, class Y>
...
public:
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  FastDelegate2(DesiredRetType(xr_stdcall *function_to_bind)(Param1 p1,
                                                             Param2 p2)) {
    bind(function_to_bind);
  }
  // for efficiency, prevent creation of a temporary
...
public:
  ...
  // Binding to non-const member functions
  template <class X, class Y>
  FastDelegate3(Y *pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(
  ...
  FastDelegate3(const Y *pthis,
                DesiredRetType (xr_stdcall X::*function_to_bind)(
                    Param1 p1, Param2 p2, Param3 p3) const) {
    m_Closure.bindconstmemfunc(detail::implicit_cast<const X *>(pthis),
                               function_to_bind);
  }
  template <class X, class Y>
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  FastDelegate3(DesiredRetType(xr_stdcall *function_to_bind)(Param1 p1,
                                                             Param2 p2,
                                                             Param3 p3)) {
    bind(function_to_bind);
  }
...
private: // Invoker for static functions
  RetType xr_stdcall InvokeStaticFunction(Param1 p1, Param2 p2,
                                          Param3 p3) const {
...
public:
  ...
  // Binding to non-const member functions
  template <class X, class Y>
  FastDelegate4(Y *pthis, DesiredRetType (xr_stdcall X::*function_to_bind)(
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  FastDelegate4(DesiredRetType(xr_stdcall *function_to_bind)(
      Param1 p1, Param2 p2, Param3 p3, Param4 p4)) {
    bind(function_to_bind);
  }
  // for efficiency, prevent creation of a temporary
  ...
  inline void
  bind(DesiredRetType(xr_stdcall *function_to_bind)(Param1 p1, Param2 p2,
                                                    Param3 p3, Param4 p4)) {
...
private: // Invoker for static functions
  RetType xr_stdcall InvokeStaticFunction(Param1 p1, Param2 p2, Param3 p3,
                                          Param4 p4) const {
...
public:
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  FastDelegate5(DesiredRetType(xr_stdcall *function_to_bind)(
      Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5)) {
    bind(function_to_bind);
  }
  // for efficiency, prevent creation of a temporary
...
public:
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  FastDelegate6(DesiredRetType(xr_stdcall *function_to_bind)(
      Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6)) {
    bind(function_to_bind);
  }
  // for efficiency, prevent creation of a temporary
...
public:
  ...
  template <class X, class Y>
  FastDelegate(const Y *pthis, R (xr_stdcall X::*function_to_bind)(
                                   Param1 p1, Param2 p2, Param3 p3, Param4 p4,
...
FastDelegate0<FASTDLGT_RETTYPE> MakeDelegate(Y *x,
                                             RetType (xr_stdcall X::*func)()) {
  return FastDelegate0<FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class RetType>
FastDelegate0<FASTDLGT_RETTYPE>
MakeDelegate(Y *x, RetType (xr_stdcall X::*func)() const) {
  return FastDelegate0<FASTDLGT_RETTYPE>(x, func);
}
...
MakeDelegate(Y *x, RetType (xr_stdcall X::*func)(Param1 p1)) {
  return FastDelegate1<Param1, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class RetType>
FastDelegate1<Param1, FASTDLGT_RETTYPE>
MakeDelegate(Y *x, RetType (xr_stdcall X::*func)(Param1 p1) const) {
  return FastDelegate1<Param1, FASTDLGT_RETTYPE>(x, func);
}
...
MakeDelegate(Y *x,
             RetType (xr_stdcall X::*func)(Param1 p1, Param2 p2, Param3 p3)) {
