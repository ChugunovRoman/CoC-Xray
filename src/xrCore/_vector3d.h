...
public:
  ...
  IC SelfRef random_dir(const Self &ConeAxis, float ConeAngle,
                        CRandom &R = ::Random) {
    Self rnd;
    rnd.random_dir(R);
  ...
  // Barycentric coords
  IC SelfRef from_bary(const Self &V1, const Self &V2, const Self &V3, T u, T v,
                       T w) {
  ...
  IC SelfRef from_bary(const Self &V1, const Self &V2, const Self &V3,
                       const Self &B) {
    from_bary(V1, V2, V3, B.x, B.y, B.z);
    return *this;
  }

  IC SelfRef from_bary4(const Self &V1, const Self &V2, const Self &V3,
                        const Self &V4, T u, T v, T w, T t) {
  ...
  IC SelfRef mknormal_non_normalized(const Self &p0, const Self &p1,
                                     const Self &p2) {
    _vector3<T> v01, v12;
    v01.sub(p1, p0);
    v12.sub(p2, p1);
  ...
  IC static void generate_orthonormal_basis_normalized(_vector3<T> &dir,
                                                       _vector3<T> &up,
                                                       _vector3<T> &right) {
    T fInvLength;
    dir.normalize();
