...
LPSTR XRCORE_API strconcat(int dest_sz, char *dest, const char *S1,
                           const char *S2);
LPSTR XRCORE_API strconcat(int dest_sz, char *dest, const char *S1,
...
IC char *strconcat(int dest_sz, char *dest, const char *S1, const char *S2,
  ...
  return xr_strcat(
      xr_strcat(xr_strcat(xr_strcpy(dest, dest_sz, S1), dest_sz, S2), dest_sz,
                S3),
      dest_sz, S4);
}
...
IC char *strconcat(int dest_sz, char *dest, const char *S1, const char *S2,
  ...
  return xr_strcat(
      xr_strcat(xr_strcat(xr_strcat(xr_strcpy(dest, dest_sz, S1), dest_sz, S2),
                          dest_sz, S3),
                dest_sz, S4),
      dest_sz, S5);
}
...
IC char *strconcat(int dest_sz, char *dest, const char *S1, const char *S2,
                   ...
                   const char *S6) {
  return xr_strcat(
      xr_strcat(xr_strcat(xr_strcat(xr_strcat(xr_strcpy(dest, dest_sz, S1),
                                              dest_sz, S2),
                                    dest_sz, S3),
                          dest_sz, S4),
                dest_sz, S5),
...
#define STRCONCAT(dest, ...)                                                   \
  do {                                                                         \
    xray::core::detail::string_tupples STRCONCAT_tupples_unique_identifier(    \
        __VA_ARGS__);                                                          \
