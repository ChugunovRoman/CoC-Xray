...
BOOL __stdcall NT4GetLoadedModules(DWORD dwPID, UINT uiCount,
                                   HMODULE *paModArray, LPDWORD pdwRealCount);

// The TOOLHELP32 specific version of GetLoadedModules.
BOOL __stdcall TLHELPGetLoadedModules(DWORD dwPID, UINT uiCount,
                                      HMODULE *paModArray,
...
DWORD __stdcall TLHELPGetModuleFileNameEx(DWORD dwPID, HANDLE hProcess,
                                          HMODULE hModule, LPTSTR szFilename,
                                          DWORD nSize);

// The NT version of GetModuleFilenameEx.
DWORD __stdcall NTGetModuleFileNameEx(DWORD dwPID, HANDLE hProcess,
                                      HMODULE hModule, LPTSTR szFilename,
                                      DWORD nSize);
