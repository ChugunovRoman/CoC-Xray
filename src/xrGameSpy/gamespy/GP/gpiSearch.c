  ...
  do {
    ...
    /////////////////
      ...
      if (strstr(data->inputBuffer.buffer, "\\final\\") != NULL) {
        ...
        ////////////////////////////
        if ((data->type == GPI_SEARCH_PROFILE) ||
            (data->type == GPI_SEARCH_PROFILE_UNIQUENICK)) {
          ...
          if (callback.callback != NULL) {
            ...
            do {
              ...
              if (strcmp(key, "nick") == 0) {
                ...
                //////////
#ifndef GSI_UNICODE
                tempPtr = gsirealloc(arg->nicks,
                                     sizeof(char *) * (arg->numNicks + 1));
                if (tempPtr == NULL)
                  Error(connection, GP_MEMORY_ERROR, "Out of memory.");
          ...
          if (callback.callback != NULL) {
            ...
            //////////////////////////////////////
            arg->suggestedNicks = (gsi_char **)gsimalloc(
                sizeof(gsi_char *) * arg->numSuggestedNicks);
