...
#ifdef GSI_UNICODE
GHTTPRequest ghttpGetW(const unsigned short *URL, GHTTPBool blocking,
                       ghttpCompletedCallback completedCallback, void *param) {
  char URL_A[1024];
...
#ifdef GSI_UNICODE
GHTTPRequest
ghttpGetExW(const unsigned short *URL, const unsigned short *headers,
            char *buffer, int bufferSize, GHTTPPost post, GHTTPBool throttle,
  ...
  return ghttpGetExA((char *)URL_A, (char *)headers_A, buffer, bufferSize, post,
                     throttle, blocking, progressCallback, completedCallback,
                     param);
}
#endif
...
GHTTPRequest ghttpSaveW(const unsigned short *URL,
                        const unsigned short *filename, GHTTPBool blocking,
                        ghttpCompletedCallback completedCallback, void *param) {
  char URL_A[1024] = {'\0'};
...
GHTTPRequest ghttpSaveExA(const char *URL, const char *filename,
  ...
  return _ghttpSaveEx(URL, filename_W, headers, post, throttle, blocking,
...
#ifdef GSI_UNICODE
GHTTPRequest
ghttpSaveExW(const unsigned short *URL, const unsigned short *filename,
             const unsigned short *headers, GHTTPPost post, GHTTPBool throttle,
             GHTTPBool blocking, ghttpProgressCallback progressCallback,
             ghttpCompletedCallback completedCallback, void *param) {
  char URL_A[1024];
  // char filename_A[1024] = { '\0' };
  ...
  return _ghttpSaveEx(URL_A, filename, headers_A, post, throttle, blocking,
                      progressCallback, completedCallback, param);
}
#endif
...
#ifdef GSI_UNICODE
GHTTPRequest ghttpStreamW(const unsigned short *URL, GHTTPBool blocking,
                          ghttpProgressCallback progressCallback,
                          ghttpCompletedCallback completedCallback,
                          void *param) {
  char *URL_A = {'\0'};
  UCS2ToAsciiString(URL, URL_A);
  return ghttpStreamA(URL_A, blocking, progressCallback, completedCallback,
                      param);
}
#endif
...
GHTTPRequest ghttpStreamExW(const unsigned short *URL,
                            const unsigned short *headers, GHTTPPost post,
                            GHTTPBool throttle, GHTTPBool blocking,
                            ghttpProgressCallback progressCallback,
                            ghttpCompletedCallback completedCallback,
                            void *param) {
  ...
  if (headers != NULL)
    UCS2ToAsciiString(headers, headers_A);
  return ghttpStreamExA(URL_A, headers_A, post, throttle, blocking,
                        progressCallback, completedCallback, param);
}
#endif
...
#ifdef GSI_UNICODE
GHTTPRequest ghttpHeadW(const unsigned short *URL, GHTTPBool blocking,
                        ghttpCompletedCallback completedCallback, void *param) {
  char URL_A[1024] = {'\0'};
  UCS2ToAsciiString(URL, URL_A);
...
GHTTPRequest ghttpHeadExW(const unsigned short *URL,
                          const unsigned short *headers, GHTTPBool throttle,
                          GHTTPBool blocking,
                          ghttpProgressCallback progressCallback,
                          ghttpCompletedCallback completedCallback,
                          void *param) {
  ...
  if (headers != NULL)
    UCS2ToAsciiString(headers, headers_A);
  return ghttpHeadExA(URL_A, headers_A, throttle, blocking, progressCallback,
                      completedCallback, param);
}
#endif
...
#ifdef GSI_UNICODE
GHTTPRequest ghttpPostW(const unsigned short *URL, GHTTPPost post,
                        GHTTPBool blocking,
                        ghttpCompletedCallback completedCallback, void *param) {
  char URL_A[1024] = {'\0'};
  UCS2ToAsciiString(URL, URL_A);
...
GHTTPRequest ghttpPostExW(const unsigned short *URL,
  ...
  if (headers != NULL)
    UCS2ToAsciiString(headers, headers_A);
  return ghttpPostExA(URL_A, headers_A, post, throttle, blocking,
                      progressCallback, completedCallback, param);
}
#endif
...
#ifdef GSI_UNICODE
GHTTPBool ghttpPostAddStringW(GHTTPPost post, const unsigned short *name,
...
#ifdef GSI_UNICODE
GHTTPBool ghttpPostAddFileFromDiskW(GHTTPPost post, const unsigned short *name,
  ...
  return ghttpPostAddFileFromDiskA(post, name_A, filename_A, reportFilename_A,
                                   contentType_A);
}
#endif
...
GHTTPBool ghttpPostAddFileFromMemoryW(GHTTPPost post,
  ...
  return ghttpPostAddFileFromMemoryA(post, name_A, buffer, bufferLen,
                                     reportFilename_A, contentType_A);
