...
static void Startup(void) {
  ...
  SetTopScreenLineCentered(SCREEN_HEIGHT / 2, SCWhite,
                           "Starting GameSpy Sample");
...
static void Shutdown(void) {
  ...
  //	ClearScreens();
  //	SetTopScreenLineCentered(SCREEN_HEIGHT / 2, SCWhite, "GameSpy Sample
  // Shutdown"); 	SVC_WaitVBlankIntr();
