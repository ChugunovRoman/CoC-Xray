...
// function being 		called, embedded NULLs are stripped and hence, this
// function
// does not check for them 		For example, the UTF-8 byte :1000 0000,
// would convert to a UCS2 NULL character 		If this appeared in the
// middle of a stream, it could cause undesired operation
...
// theUCS2String 		the size returned should always be 2x the size passed
// in
