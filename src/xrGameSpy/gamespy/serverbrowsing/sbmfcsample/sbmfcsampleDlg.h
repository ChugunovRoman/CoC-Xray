...
#if !defined(                                                                  \
    AFX_SBMFCSAMPLEDLG_H__8B726D03_AF99_4938_A63C_18525912E55D__INCLUDED_)
...
protected:
  ...
  // Implementation
protected:
  static void SBCallback(ServerBrowser serverBrowser, SBCallbackReason reason,
                         SBServer server, void *instance);
  static void SBConnectCallback(ServerBrowser serverBrowser,
                                SBConnectToServerState state, SOCKET gamesocket,
                                struct sockaddr_in *remoteaddr, void *instance);
