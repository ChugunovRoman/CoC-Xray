...
PTBool ptCheckForPatch(
    ...
    const gsi_char
        *versionUniqueID, // A string uniquely identifying this version.
    ...
    PTBool
        blocking, // If PTTrue, don't return until after the callback is called.
...
///////////////////////////////////////////////////////////////////////
PTBool ptTrackUsage(
    int userID, // The GP userID of the user who is using the product.  Can be
                // 0.
    int productID, // The ID of this product.
    const gsi_char
        *versionUniqueID, // A string uniquely identifying this version.
...
PTBool ptLookupFilePlanetInfo(
    ...
    ptFilePlanetInfoCallback
        callback, // The callback to call with the patch info.
    PTBool
        blocking, // If PTTrue, don't return until after the callback is called.
    void *param   // User-data to pass to the callback.
);
