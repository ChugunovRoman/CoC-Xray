...
#define RACE_TIME                                                              \
  1 // [TYPE: int] [DESC: Player's race time for the match (milliseconds).]
...
#define BEST_RACE_TIME                                                         \
  3 // [TYPE: int] [DESC: Player's career best race time (milliseconds).]
#define WORST_RACE_TIME                                                        \
  4 // [TYPE: int] [DESC: Player's career worst race time (milliseconds).]
#define TOTAL_MATCHES 5 // [TYPE: int]
#define AVERAGE_RACE_TIME                                                      \
  6 // [TYPE: float] [DESC: Player's average race time per match
    // (milliseconds/match).]
#define CURRENT_WIN_STREAK 7  // [TYPE: int]
#define CURRENT_LOSS_STREAK 8 // [TYPE: int]
#define TOTAL_RACE_TIME                                                        \
  9 // [TYPE: int] [DESC: Player's total race time for all matches
    // (milliseconds).]
#define CAREER_DISCONNECTS                                                     \
  11 // [TYPE: int] [DESC: Player's total number of times disconnected.]
#define DISCONNECT_RATE                                                        \
  12 // [TYPE: float] [DESC: Player's disconnect rate (disconnects/matches).]
#define CAREER_DRAWS                                                           \
  13 // [TYPE: int] [DESC: Player's total number of draws (tied matches).]
...
#define TOTAL_COMPLETE_MATCHES                                                 \
  18 // [TYPE: int] [DESC: Total number of matches where the game went to
     // completion (all win/loss/draw results).]
