...
#define SC_REPORT_ROSTERDATA_LENGTH                                            \
  20 // V1.0 - 16 byte connection id + 4 byte team index
...
typedef struct SCIReport {
  ...
  gsi_u32 mNumTeamsReported; // keeps track of the number of team IDs that have
                             // been reported
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult sciCreateReport(gsi_u8 theSessionGuid[16], gsi_u32 theHeaderVersion,
