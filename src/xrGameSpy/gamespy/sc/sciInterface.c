...
#define SC_SERVICE_URL_FORMAT                                                  \
  "http://%s.comp.pubsvs." GSI_DOMAIN_NAME                                     \
...
SCResult sciInterfaceCreate(SCInterface **theInterfaceOut) {
  ...
  if (__GSIACResult == GSIACAvailable) {
    if (scServiceURL[0] == '\0')
      snprintf(scServiceURL, SC_SERVICE_MAX_URL_LEN, SC_SERVICE_URL_FORMAT,
               __GSIACGamename);
  } else
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void sciInterfaceSetSessionId(SCInterface *theInterface,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void sciInterfaceSetConnectionId(SCInterface *theInterface,
