...
typedef void (*ciChannelListUsersCallback)(CHAT chat, const char *channel,
                                           int numUsers, const char **users,
...
void ciUserEnteredChannel(CHAT chat, const char *nick, const char *channel,
...
typedef void (*ciUserEnumChannelsCallback)(CHAT chat, const char *user,
...
// Because these return pointers to SDK memory, we must have a widestring
// version so we can return a pointer to widestring data DO NOT CHANGE nick to
// an unsigned short*, nicks are internally store as char*
