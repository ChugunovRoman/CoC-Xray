...
static void ciFreeCallbackData(ciCallbackData *data) {
  ...
  switch (data->type) {
  case CALLBACK_RAW: {
    ciCallbackRawParams *callbackParams =
        (ciCallbackRawParams *)data->callbackParams;
    gsifree(RAW);
    break;
  }

  case CALLBACK_DISCONNECTED: {
    ciCallbackDisconnectedParams *callbackParams =
        (ciCallbackDisconnectedParams *)data->callbackParams;
    gsifree(REASON);
    break;
  }

  case CALLBACK_PRIVATE_MESSAGE: {
    ciCallbackPrivateMessageParams *callbackParams =
        (ciCallbackPrivateMessageParams *)data->callbackParams;
    gsifree(USER);
    gsifree(MESSAGE);
    break;
  }
  ...
  case CALLBACK_INVITED: {
    ciCallbackInvitedParams *callbackParams =
        (ciCallbackInvitedParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(USER);
    break;
  }
  ...
  case CALLBACK_CHANNEL_MESSAGE: {
    ciCallbackChannelMessageParams *callbackParams =
        (ciCallbackChannelMessageParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(USER);
    gsifree(MESSAGE);
    break;
  ...
  case CALLBACK_KICKED: {
    ciCallbackKickedParams *callbackParams =
        (ciCallbackKickedParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(USER);
    gsifree(REASON);
    break;
  ...
  case CALLBACK_USER_JOINED: {
    ciCallbackUserJoinedParams *callbackParams =
        (ciCallbackUserJoinedParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(USER);
    break;
  }
  ...
  case CALLBACK_USER_PARTED: {
    ciCallbackUserPartedParams *callbackParams =
        (ciCallbackUserPartedParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(USER);
    gsifree(REASON);
    gsifree(KICKER);
  ...
  case CALLBACK_USER_CHANGED_NICK: {
    ciCallbackUserChangedNickParams *callbackParams =
        (ciCallbackUserChangedNickParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(OLD_NICK);
    gsifree(NEW_NICK);
    break;
  ...
  case CALLBACK_TOPIC_CHANGED: {
    ciCallbackTopicChangedParams *callbackParams =
        (ciCallbackTopicChangedParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(TOPIC);
    break;
  }
  ...
  case CALLBACK_CHANNEL_MODE_CHANGED: {
    ciCallbackChannelModeChangedParams *callbackParams =
        (ciCallbackChannelModeChangedParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(MODE);
    break;
  }
  ...
  case CALLBACK_USER_MODE_CHANGED: {
    ciCallbackUserModeChangedParams *callbackParams =
        (ciCallbackUserModeChangedParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(USER);
    break;
  }
  ...
  case CALLBACK_USER_LIST_UPDATED: {
    ciCallbackUserListUpdatedParams *callbackParams =
        (ciCallbackUserListUpdatedParams *)data->callbackParams;
    gsifree(CHANNEL);
    break;
  }

  case CALLBACK_ENUM_CHANNELS_EACH: {
    ciCallbackEnumChannelsEachParams *callbackParams =
        (ciCallbackEnumChannelsEachParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(TOPIC);
    break;
  }
  ...
  case CALLBACK_ENUM_CHANNELS_ALL: {
    int i;
    ciCallbackEnumChannelsAllParams *callbackParams =
        (ciCallbackEnumChannelsAllParams *)data->callbackParams;
  ...
  case CALLBACK_ENTER_CHANNEL: {
    ciCallbackEnterChannelParams *callbackParams =
        (ciCallbackEnterChannelParams *)data->callbackParams;
    gsifree(CHANNEL);
    break;
  }

  case CALLBACK_GET_CHANNEL_TOPIC: {
    ciCallbackGetChannelTopicParams *callbackParams =
        (ciCallbackGetChannelTopicParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(TOPIC);
    break;
  }
  ...
  case CALLBACK_GET_CHANNEL_MODE: {
    ciCallbackGetChannelModeParams *callbackParams =
        (ciCallbackGetChannelModeParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(MODE);
    break;
  }
  ...
  case CALLBACK_GET_UDPRELAY: {
    ciCallbackGetUdpRelayParams *callbackParams =
        (ciCallbackGetUdpRelayParams *)data->callbackParams;
    gsifree(CHANNEL);
  ...
  case CALLBACK_GET_CHANNEL_PASSWORD: {
    ciCallbackGetChannelPasswordParams *callbackParams =
        (ciCallbackGetChannelPasswordParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(PASSWORD);
    break;
  }
  ...
  case CALLBACK_ENUM_USERS: {
    int i;
    ciCallbackEnumUsersParams *callbackParams =
        (ciCallbackEnumUsersParams *)data->callbackParams;
    gsifree(CHANNEL);
  ...
  case CALLBACK_GET_USER_INFO: {
    int i;
    ciCallbackGetUserInfoParams *callbackParams =
        (ciCallbackGetUserInfoParams *)data->callbackParams;
    gsifree(NICK);
    gsifree(USER);
    gsifree(NAME);
    gsifree(ADDRESS);
  ...
  case CALLBACK_GET_BASIC_USER_INFO: {
    ciCallbackGetBasicUserInfoParams *callbackParams =
        (ciCallbackGetBasicUserInfoParams *)data->callbackParams;
    gsifree(NICK);
    gsifree(USER);
    gsifree(ADDRESS);
    break;
  ...
  case CALLBACK_GET_USER_MODE: {
    ciCallbackGetUserModeParams *callbackParams =
        (ciCallbackGetUserModeParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(USER);
    break;
  }
  ...
  case CALLBACK_ENUM_CHANNEL_BANS: {
    int i;
    ciCallbackEnumChannelBansParams *callbackParams =
        (ciCallbackEnumChannelBansParams *)data->callbackParams;
    gsifree(CHANNEL);
  ...
  case CALLBACK_NICK_ERROR: {
    int i;
    ciCallbackNickErrorParams *callbackParams =
        (ciCallbackNickErrorParams *)data->callbackParams;
    gsifree(NICK);
  ...
  case CALLBACK_CHANGE_NICK: {
    ciCallbackChangeNickParams *callbackParams =
        (ciCallbackChangeNickParams *)data->callbackParams;
    gsifree(OLD_NICK);
    gsifree(NEW_NICK);
    break;
  }
  ...
  case CALLBACK_NEW_USER_LIST: {
    int i;
    ciCallbackNewUserListParams *callbackParams =
        (ciCallbackNewUserListParams *)data->callbackParams;
    gsifree(CHANNEL);
    for (i = 0; i < NUM_USERS; i++)
      gsifree(USERS[i]);
    gsifree(USERS);
  ...
  case CALLBACK_GET_GLOBAL_KEYS: {
    int i;
    ciCallbackGetGlobalKeysParams *callbackParams =
        (ciCallbackGetGlobalKeysParams *)data->callbackParams;
    gsifree(USER);
    for (i = 0; i < NUM; i++) {
      gsifree(KEYS[i]);
      if (VALUES)
  ...
  case CALLBACK_GET_CHANNEL_KEYS: {
    int i;
    ciCallbackGetChannelKeysParams *callbackParams =
        (ciCallbackGetChannelKeysParams *)data->callbackParams;
    gsifree(CHANNEL);
    gsifree(USER);
    for (i = 0; i < NUM; i++) {
      gsifree(KEYS[i]);
  ...
  case CALLBACK_AUTHENTICATE_CDKEY: {
    ciCallbackAuthenticateCDKeyParams *callbackParams =
        (ciCallbackAuthenticateCDKeyParams *)data->callbackParams;
    gsifree(MESSAGE);
    break;
  }
...
CHATBool ciInitCallbacks(ciConnection *connection) {
  ...
  connection->callbackList =
      ArrayNew(sizeof(ciCallbackData), 128, ciCallbacksArrayElementFreeFn);
...
CHATBool ciAddCallback_(CHAT chat, int type, void *callback,
                        void *callbackParams, void *param, int ID,
  ...
  switch (data.type) {
  case CALLBACK_RAW: {
    ciCallbackRawParams *destParams =
        (ciCallbackRawParams *)data.callbackParams;
  ...
  case CALLBACK_DISCONNECTED: {
    ciCallbackDisconnectedParams *destParams =
        (ciCallbackDisconnectedParams *)data.callbackParams;
    ciCallbackDisconnectedParams *srcParams =
        (ciCallbackDisconnectedParams *)callbackParams;
    COPY(reason);
    break;
  }
  ...
  case CALLBACK_PRIVATE_MESSAGE: {
    ciCallbackPrivateMessageParams *destParams =
        (ciCallbackPrivateMessageParams *)data.callbackParams;
    ciCallbackPrivateMessageParams *srcParams =
        (ciCallbackPrivateMessageParams *)callbackParams;
    COPY(user);
    COPY(message);
    break;
  ...
  case CALLBACK_INVITED: {
    ciCallbackInvitedParams *destParams =
        (ciCallbackInvitedParams *)data.callbackParams;
    ciCallbackInvitedParams *srcParams =
        (ciCallbackInvitedParams *)callbackParams;
    COPY(channel);
    COPY(user);
    break;
  ...
  case CALLBACK_CHANNEL_MESSAGE: {
    ciCallbackChannelMessageParams *destParams =
        (ciCallbackChannelMessageParams *)data.callbackParams;
    ciCallbackChannelMessageParams *srcParams =
        (ciCallbackChannelMessageParams *)callbackParams;
    COPY(channel);
    COPY(user);
    COPY(message);
  ...
  case CALLBACK_KICKED: {
    ciCallbackKickedParams *destParams =
        (ciCallbackKickedParams *)data.callbackParams;
    ciCallbackKickedParams *srcParams =
        (ciCallbackKickedParams *)callbackParams;
    COPY(channel);
    COPY(user);
    COPY(reason);
  ...
  case CALLBACK_USER_JOINED: {
    ciCallbackUserJoinedParams *destParams =
        (ciCallbackUserJoinedParams *)data.callbackParams;
    ciCallbackUserJoinedParams *srcParams =
        (ciCallbackUserJoinedParams *)callbackParams;
    COPY(channel);
    COPY(user);
    break;
  ...
  case CALLBACK_USER_PARTED: {
    ciCallbackUserPartedParams *destParams =
        (ciCallbackUserPartedParams *)data.callbackParams;
    ciCallbackUserPartedParams *srcParams =
        (ciCallbackUserPartedParams *)callbackParams;
    COPY(channel);
    COPY(user);
    COPY(reason);
  ...
  case CALLBACK_USER_CHANGED_NICK: {
    ciCallbackUserChangedNickParams *destParams =
        (ciCallbackUserChangedNickParams *)data.callbackParams;
    ciCallbackUserChangedNickParams *srcParams =
        (ciCallbackUserChangedNickParams *)callbackParams;
    COPY(channel);
    COPY(oldNick);
    COPY(newNick);
  ...
  case CALLBACK_TOPIC_CHANGED: {
    ciCallbackTopicChangedParams *destParams =
        (ciCallbackTopicChangedParams *)data.callbackParams;
    ciCallbackTopicChangedParams *srcParams =
        (ciCallbackTopicChangedParams *)callbackParams;
    COPY(channel);
    COPY(topic);
    break;
  ...
  case CALLBACK_CHANNEL_MODE_CHANGED: {
    ciCallbackChannelModeChangedParams *destParams =
        (ciCallbackChannelModeChangedParams *)data.callbackParams;
    ciCallbackChannelModeChangedParams *srcParams =
        (ciCallbackChannelModeChangedParams *)callbackParams;
    COPY(channel);
    COPY_MODE();
    break;
  ...
  case CALLBACK_USER_MODE_CHANGED: {
    ciCallbackUserModeChangedParams *destParams =
        (ciCallbackUserModeChangedParams *)data.callbackParams;
    ciCallbackUserModeChangedParams *srcParams =
        (ciCallbackUserModeChangedParams *)callbackParams;
    COPY(channel);
    COPY(user);
    break;
  ...
  case CALLBACK_USER_LIST_UPDATED: {
    ciCallbackUserListUpdatedParams *destParams =
        (ciCallbackUserListUpdatedParams *)data.callbackParams;
    ciCallbackUserListUpdatedParams *srcParams =
        (ciCallbackUserListUpdatedParams *)callbackParams;
    COPY(channel);
    break;
  }
  ...
  case CALLBACK_ENUM_CHANNELS_EACH: {
    ciCallbackEnumChannelsEachParams *destParams =
        (ciCallbackEnumChannelsEachParams *)data.callbackParams;
    ciCallbackEnumChannelsEachParams *srcParams =
        (ciCallbackEnumChannelsEachParams *)callbackParams;
    COPY(channel);
    COPY(topic);
    break;
  ...
  case CALLBACK_ENUM_CHANNELS_ALL: {
    ciCallbackEnumChannelsAllParams *destParams =
        (ciCallbackEnumChannelsAllParams *)data.callbackParams;
    ciCallbackEnumChannelsAllParams *srcParams =
        (ciCallbackEnumChannelsAllParams *)callbackParams;
  ...
  case CALLBACK_ENTER_CHANNEL: {
    ciCallbackEnterChannelParams *destParams =
        (ciCallbackEnterChannelParams *)data.callbackParams;
    ciCallbackEnterChannelParams *srcParams =
        (ciCallbackEnterChannelParams *)callbackParams;
    COPY(channel);
    break;
  }
  ...
  case CALLBACK_GET_CHANNEL_TOPIC: {
    ciCallbackGetChannelTopicParams *destParams =
        (ciCallbackGetChannelTopicParams *)data.callbackParams;
    ciCallbackGetChannelTopicParams *srcParams =
        (ciCallbackGetChannelTopicParams *)callbackParams;
    COPY(channel);
    COPY(topic);
    break;
  ...
  case CALLBACK_GET_CHANNEL_MODE: {
    ciCallbackGetChannelModeParams *destParams =
        (ciCallbackGetChannelModeParams *)data.callbackParams;
    ciCallbackGetChannelModeParams *srcParams =
        (ciCallbackGetChannelModeParams *)callbackParams;
    COPY(channel);
    COPY_MODE();
    break;
  ...
  case CALLBACK_GET_UDPRELAY: {
    ciCallbackGetUdpRelayParams *destParams =
        (ciCallbackGetUdpRelayParams *)data.callbackParams;
    ciCallbackGetUdpRelayParams *srcParams =
        (ciCallbackGetUdpRelayParams *)callbackParams;
    COPY(channel);
    COPY(udpIp);
    break;
  ...
  case CALLBACK_GET_CHANNEL_PASSWORD: {
    ciCallbackGetChannelPasswordParams *destParams =
        (ciCallbackGetChannelPasswordParams *)data.callbackParams;
    ciCallbackGetChannelPasswordParams *srcParams =
        (ciCallbackGetChannelPasswordParams *)callbackParams;
    COPY(channel);
    COPY(password);
    break;
  ...
  case CALLBACK_ENUM_USERS: {
    ciCallbackEnumUsersParams *destParams =
        (ciCallbackEnumUsersParams *)data.callbackParams;
    ciCallbackEnumUsersParams *srcParams =
        (ciCallbackEnumUsersParams *)callbackParams;
    COPY(channel);
  ...
  case CALLBACK_GET_USER_INFO: {
    ciCallbackGetUserInfoParams *destParams =
        (ciCallbackGetUserInfoParams *)data.callbackParams;
    ciCallbackGetUserInfoParams *srcParams =
        (ciCallbackGetUserInfoParams *)callbackParams;
    COPY(nick);
    COPY(user);
    COPY(name);
  ...
  case CALLBACK_GET_BASIC_USER_INFO: {
    ciCallbackGetBasicUserInfoParams *destParams =
        (ciCallbackGetBasicUserInfoParams *)data.callbackParams;
    ciCallbackGetBasicUserInfoParams *srcParams =
        (ciCallbackGetBasicUserInfoParams *)callbackParams;
    COPY(nick);
    COPY(user);
    COPY(address);
  ...
  case CALLBACK_GET_CHANNEL_BASIC_USER_INFO: {
    ciCallbackGetChannelBasicUserInfoParams *destParams =
        (ciCallbackGetChannelBasicUserInfoParams *)data.callbackParams;
    ciCallbackGetChannelBasicUserInfoParams *srcParams =
        (ciCallbackGetChannelBasicUserInfoParams *)callbackParams;
    COPY(channel);
    COPY(nick);
    COPY(user);
  ...
  case CALLBACK_GET_USER_MODE: {
    ciCallbackGetUserModeParams *destParams =
        (ciCallbackGetUserModeParams *)data.callbackParams;
    ciCallbackGetUserModeParams *srcParams =
        (ciCallbackGetUserModeParams *)callbackParams;
    COPY(channel);
    COPY(user);
    break;
  ...
  case CALLBACK_ENUM_CHANNEL_BANS: {
    ciCallbackEnumChannelBansParams *destParams =
        (ciCallbackEnumChannelBansParams *)data.callbackParams;
    ciCallbackEnumChannelBansParams *srcParams =
        (ciCallbackEnumChannelBansParams *)callbackParams;
    COPY(channel);
  ...
  case CALLBACK_NICK_ERROR: {
    ciCallbackNickErrorParams *destParams =
        (ciCallbackNickErrorParams *)data.callbackParams;
    ciCallbackNickErrorParams *srcParams =
        (ciCallbackNickErrorParams *)callbackParams;
    COPY(nick);
  ...
  case CALLBACK_CHANGE_NICK: {
    ciCallbackChangeNickParams *destParams =
        (ciCallbackChangeNickParams *)data.callbackParams;
    ciCallbackChangeNickParams *srcParams =
        (ciCallbackChangeNickParams *)callbackParams;
    COPY(oldNick);
    COPY(newNick);
    break;
  ...
  case CALLBACK_NEW_USER_LIST: {
    ciCallbackNewUserListParams *destParams =
        (ciCallbackNewUserListParams *)data.callbackParams;
    ciCallbackNewUserListParams *srcParams =
        (ciCallbackNewUserListParams *)callbackParams;
    COPY(channel);
    COPY_STR_ARRAY(users, numUsers);
    COPY_INT_ARRAY(modes, numUsers);
  ...
  case CALLBACK_BROADCAST_KEY_CHANGED: {
    ciCallbackBroadcastKeyChangedParams *destParams =
        (ciCallbackBroadcastKeyChangedParams *)data.callbackParams;
    ciCallbackBroadcastKeyChangedParams *srcParams =
        (ciCallbackBroadcastKeyChangedParams *)callbackParams;
    COPY(channel);
    COPY(user);
    COPY(key);
  ...
  case CALLBACK_GET_GLOBAL_KEYS: {
    ciCallbackGetGlobalKeysParams *destParams =
        (ciCallbackGetGlobalKeysParams *)data.callbackParams;
    ciCallbackGetGlobalKeysParams *srcParams =
        (ciCallbackGetGlobalKeysParams *)callbackParams;
    COPY(user);
  ...
  case CALLBACK_GET_CHANNEL_KEYS: {
    ciCallbackGetChannelKeysParams *destParams =
        (ciCallbackGetChannelKeysParams *)data.callbackParams;
    ciCallbackGetChannelKeysParams *srcParams =
        (ciCallbackGetChannelKeysParams *)callbackParams;
    COPY(channel);
    COPY(user);
    COPY_STR_ARRAY(keys, num);
  ...
  case CALLBACK_AUTHENTICATE_CDKEY: {
    ciCallbackAuthenticateCDKeyParams *destParams =
        (ciCallbackAuthenticateCDKeyParams *)data.callbackParams;
    ciCallbackAuthenticateCDKeyParams *srcParams =
        (ciCallbackAuthenticateCDKeyParams *)callbackParams;
    COPY(message);
    break;
  }
...
static void ciCallCallback(CHAT chat, ciCallbackData *data) {
  ...
  case CALLBACK_ENUM_CHANNELS_EACH: {
    ciCallbackEnumChannelsEachParams *callbackParams =
        (ciCallbackEnumChannelsEachParams *)data->callbackParams;
    chatEnumChannelsCallbackEach callback =
        (chatEnumChannelsCallbackEach)data->callback;
#ifndef GSI_UNICODE
  ...
  case CALLBACK_ENUM_CHANNELS_ALL: {
    ciCallbackEnumChannelsAllParams *callbackParams =
        (ciCallbackEnumChannelsAllParams *)data->callbackParams;
    chatEnumChannelsCallbackAll callback =
        (chatEnumChannelsCallbackAll)data->callback;
#ifndef GSI_UNICODE
    callback(chat, SUCCESS, NUM_CHANNELS, (const char **)CHANNELS,
             (const char **)TOPICS, NUM_USERS, param);
    break;
#else
    unsigned short **channels_W =
        UTF8ToUCS2StringArrayAlloc((const char **)CHANNELS, NUM_CHANNELS);
    unsigned short **topics_W =
        UTF8ToUCS2StringArrayAlloc((const char **)TOPICS, NUM_CHANNELS);
    callback(chat, SUCCESS, NUM_CHANNELS, (const unsigned short **)channels_W,
             (const unsigned short **)topics_W, NUM_USERS, param);
  ...
  case CALLBACK_ENTER_CHANNEL: {
    ...
    chatEnterChannelCallback callback =
        (chatEnterChannelCallback)data->callback;
  ...
  case CALLBACK_GET_CHANNEL_TOPIC: {
    ...
    chatGetChannelTopicCallback callback =
        (chatGetChannelTopicCallback)data->callback;
#ifndef GSI_UNICODE
  ...
  case CALLBACK_GET_CHANNEL_MODE: {
    ...
    chatGetChannelModeCallback callback =
        (chatGetChannelModeCallback)data->callback;
#ifndef GSI_UNICODE
...
#ifndef GSI_UNICODE
    callback(chat, CHANNEL, callbackParams->udpIp, callbackParams->udpPort,
             callbackParams->udpKey, param);
    break;
#else
    // Copy all the params, call the callback, free the params
    unsigned short *channel_W = UTF8ToUCS2StringAlloc(CHANNEL);
    unsigned short *udpIp_W = UTF8ToUCS2StringAlloc(callbackParams->udpIp);
    callback(chat, channel_W, udpIp_W, callbackParams->udpPort,
             callbackParams->udpKey, param);
    gsifree(channel_W);
    gsifree(udpIp_W);
    break;
  ...
  case CALLBACK_GET_CHANNEL_PASSWORD: {
    ...
    chatGetChannelPasswordCallback callback =
        (chatGetChannelPasswordCallback)data->callback;
#ifndef GSI_UNICODE
...
#ifndef GSI_UNICODE
    callback(chat, SUCCESS, CHANNEL, NUM_USERS, (const char **)USERS, MODES,
             param);
    break;
#else
    unsigned short *channel_W = UTF8ToUCS2StringAlloc(CHANNEL);
    unsigned short **users_W =
        UTF8ToUCS2StringArrayAlloc((const char **)USERS, NUM_USERS);
    callback(chat, SUCCESS, channel_W, NUM_USERS,
             (const unsigned short **)users_W, MODES, param);
    gsifree(channel_W);
  ...
  case CALLBACK_GET_USER_INFO: {
...
#ifndef GSI_UNICODE
    callback(chat, SUCCESS, NICK, USER, NAME, ADDRESS, NUM_CHANNELS,
             (const char **)CHANNELS, param);
    break;
#else
    ...
    unsigned short **channels_W =
        UTF8ToUCS2StringArrayAlloc((const char **)CHANNELS, NUM_CHANNELS);
    callback(chat, SUCCESS, nick_W, user_W, name_W, address_W, NUM_CHANNELS,
             (const unsigned short **)channels_W, param);
    gsifree(nick_W);
    gsifree(user_W);
    gsifree(name_W);
    gsifree(address_W);
  ...
  case CALLBACK_GET_BASIC_USER_INFO: {
    ...
    chatGetBasicUserInfoCallback callback =
        (chatGetBasicUserInfoCallback)data->callback;
#ifndef GSI_UNICODE
  ...
  case CALLBACK_GET_CHANNEL_BASIC_USER_INFO: {
    ...
    chatGetChannelBasicUserInfoCallback callback =
        (chatGetChannelBasicUserInfoCallback)data->callback;
#ifndef GSI_UNICODE
  ...
  case CALLBACK_ENUM_CHANNEL_BANS: {
    ...
    chatEnumChannelBansCallback callback =
        (chatEnumChannelBansCallback)data->callback;
#ifndef GSI_UNICODE
    callback(chat, SUCCESS, CHANNEL, NUM_BANS, (const char **)BANS, param);
    break;
#else
    unsigned short *channel_W = UTF8ToUCS2StringAlloc(CHANNEL);
    unsigned short **bans_W =
        UTF8ToUCS2StringArrayAlloc((const char **)BANS, NUM_BANS);
    callback(chat, SUCCESS, channel_W, NUM_BANS,
             (const unsigned short **)bans_W, param);
    gsifree(channel_W);
...
#ifndef GSI_UNICODE
    callback(chat, TYPE, NICK, NUM_SUGGESTED_NICKS,
             (const char **)SUGGESTED_NICKS, param);
    break;
#else
    // Copy all the params, call the callback, free the params
    unsigned short *nick_W = UTF8ToUCS2StringAlloc(NICK);
    unsigned short **suggestedNicks_W = UTF8ToUCS2StringArrayAlloc(
        (const char **)SUGGESTED_NICKS, NUM_SUGGESTED_NICKS);
    callback(chat, TYPE, nick_W, NUM_SUGGESTED_NICKS,
             (const unsigned short **)suggestedNicks_W, param);
    gsifree(nick_W);
  ...
  case CALLBACK_NEW_USER_LIST: {
    ...
    unsigned short **users_W =
        UTF8ToUCS2StringArrayAlloc((const char **)USERS, NUM_USERS);
    callback(chat, channel_W, NUM_USERS, (const unsigned short **)users_W,
             MODES, param);
    gsifree(channel_W);
    FREE_STRING_ARRAY(users_W, NUM_USERS);
    break;
  ...
  case CALLBACK_GET_GLOBAL_KEYS: {
    ...
    chatGetGlobalKeysCallback callback =
        (chatGetGlobalKeysCallback)data->callback;
#ifndef GSI_UNICODE
    callback(chat, SUCCESS, USER, NUM, (const char **)KEYS,
             (const char **)VALUES, param);
    break;
#else
    unsigned short *user_W = UTF8ToUCS2StringAlloc(USER);
    unsigned short **keys_W =
        UTF8ToUCS2StringArrayAlloc((const char **)KEYS, NUM);
    unsigned short **values_W =
        UTF8ToUCS2StringArrayAlloc((const char **)VALUES, NUM);
    callback(chat, SUCCESS, user_W, NUM, (const unsigned short **)keys_W,
             (const unsigned short **)values_W, param);
    gsifree(user_W);
  ...
  case CALLBACK_GET_CHANNEL_KEYS: {
    ...
    chatGetChannelKeysCallback callback =
        (chatGetChannelKeysCallback)data->callback;
#ifndef GSI_UNICODE
    callback(chat, SUCCESS, CHANNEL, USER, NUM, (const char **)KEYS,
             (const char **)VALUES, param);
    break;
#else
    unsigned short *channel_W = UTF8ToUCS2StringAlloc(CHANNEL);
    ...
    unsigned short **values_W =
        UTF8ToUCS2StringArrayAlloc((const char **)VALUES, NUM);
    callback(chat, SUCCESS, channel_W, user_W, NUM,
  ...
  case CALLBACK_AUTHENTICATE_CDKEY: {
    ...
    chatAuthenticateCDKeyCallback callback =
        (chatAuthenticateCDKeyCallback)data->callback;
#ifndef GSI_UNICODE
...
void ciCallCallbacks(CHAT chat, int ID) {
  ...
  for (skip = 0; ArrayLength(connection->callbackList) > skip;) {
    ...
    if ((data->channel != NULL) && !ciInChannel(chat, data->channel)) {
      ...
      //////////////////////////////////////////////////////////////////////////
      if (((data->channel == NULL) ||
           ciWasJoinCallbackCalled(chat, data->channel)) &&
          ((ID == 0) || (data->ID == ID))) {
