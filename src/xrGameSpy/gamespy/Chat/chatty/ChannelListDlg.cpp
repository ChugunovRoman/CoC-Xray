...
void EnumChannelsCallbackEach(CHAT chat, CHATBool success, int index,
...
void EnumJoinedChannelsCallback(CHAT chat, int index, const char *channel,
                                void *param) {
  CChannelListDlg *dlg = (CChannelListDlg *)param;
...
void EnumChannelsCallbackAll(CHAT chat, CHATBool success, int numChannels,
                             const char **channels, const char **topics,
                             int *numUsers, void *param) {
  if (success) {
    CChannelListDlg *dlg = (CChannelListDlg *)param;
...
void ListUsers(CHAT chat, CHATBool success, const char *channel, int numUsers,
...
void CChannelListDlg::OnChannels() {
  ...
  chatEnumChannels(theApp.m_chat, m_filter, EnumChannelsCallbackEach,
                   EnumChannelsCallbackAll, this, CHATFalse);
}
