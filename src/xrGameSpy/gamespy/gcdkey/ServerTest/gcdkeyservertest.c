...
static void ClientRefreshAuthorize(int gameid, int localid, int hint,
  ...
  // will include it with the response. It is passed as the first 8 characters
  // along with the challenge to the client.
...
3. Enter a main loop
        ...
        b. Check for a new connection on the server socket and create a new
client c. Check for data on the client sockets d. Check for disconnects on the
client sockets
