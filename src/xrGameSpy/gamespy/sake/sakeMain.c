...
SAKERequest SAKE_CALL sakeGetSpecificRecords(SAKE sake,
  ...
  return sakeiRunRequest(sake, input, callback, userData,
                         ...
                         sakeiStartGetSpecificRecordsRequest);
}
...
SAKERequest SAKE_CALL sakeGetRandomRecord(SAKE sake,
  ...
  return sakeiRunRequest(sake, input, callback, userData,
                         ...
                         sakeiStartGetRandomRecordRequest);
}
...
SAKERequest SAKE_CALL sakeGetRecordLimit(SAKE sake,
  ...
  return sakeiRunRequest(sake, input, callback, userData,
                         ...
                         sakeiStartGetRecordLimitRequest);
}
...
gsi_bool SAKE_CALL sakeGetFileDownloadURL(SAKE sake, int fileId,
  ...
  if (gSakeDownloadUrlOverride[0] != '\0') {
    rcode =
        _tsnprintf(url, SAKE_MAX_URL_LENGTH, _T("%s?gameid=%d&pid=%d"),
...
#ifdef GSI_UNICODE
    {
      ...
      rcode = _tsnprintf(url, SAKE_MAX_URL_LENGTH,
                         ...
                         sake->mGameName, GSI_DOMAIN_NAME, fileId,
