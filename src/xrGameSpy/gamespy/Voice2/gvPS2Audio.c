...
#if !defined(GV_NO_PS2_SPU2)
  numDevices += gviPS2Spu2ListDevices(devices + numDevices,
                                      maxDevices - numDevices, types);
#endif
#if !defined(GV_NO_PS2_HEADSET)
  numDevices += gviPS2HeadsetListDevices(devices + numDevices,
                                         maxDevices - numDevices, types);
#endif
#if !defined(GV_NO_PS2_EYETOY)
  numDevices += gviPS2EyetoyListDevices(devices + numDevices,
                                        maxDevices - numDevices, types);
#endif
