...
BOOL IsBuddyUsingV2B(GPConnection *theConnection, GPProfile theProfileId,
                     GPBuddyStatus *theStatus);
...
HCURSOR CVoice2BuddyMFCDlg::OnQueryDragIcon() { return (HCURSOR)m_hIcon; }
...
LRESULT CVoice2BuddyMFCDlg::WindowProc(UINT message, WPARAM wParam,
                                       LPARAM lParam) {
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void OnGPError(GPConnection *theConnection, GPErrorArg *theArg,
                      void *theParam) {
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void OnGPBuddyInfo(GPConnection *theConnection,
                          GPGetInfoResponseArg *theArg, void *theParam) {
  CVoice2BuddyMFCDlg *aDialog = (CVoice2BuddyMFCDlg *)theParam;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void OnGPBuddyStatus(GPConnection *theConnection,
                            GPRecvBuddyStatusArg *theArg, void *theParam) {
  CVoice2BuddyMFCDlg *aDialog = (CVoice2BuddyMFCDlg *)theParam;

  // Retrieve info for the buddy (nickname etc.)
  // will return with file cache information, if available
  gpGetInfo(theConnection, theArg->profile, GP_CHECK_CACHE, GP_NON_BLOCKING,
            (GPCallback)OnGPBuddyInfo, theParam);
  GSI_UNUSED(aDialog);
}

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void OnGPBuddyMessage(GPConnection *theConnection,
                             GPRecvBuddyMessageArg *theArg, void *theParam) {
  CVoice2BuddyMFCDlg *aDialog = (CVoice2BuddyMFCDlg *)theParam;
  ...
  if (strcmp(V2B_GP_INVITE_ACCEPTED, theArg->message) == 0)
    aDialog->PostMessage(WM_USER + 1, V2B_MSG_DOVOICECHAT,
                         aDialog->m_MyProfileId);
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void OnGPInvite(GPConnection *theConnection, GPRecvGameInviteArg *theArg,
                       void *theParam) {
  CVoice2BuddyMFCDlg *aDialog = (CVoice2BuddyMFCDlg *)theParam;
  ...
  while (anIndex < aDialog->m_BuddyList.GetCount()) {
    ...
    if (aDialog->m_BuddyList.GetItemData(anIndex) ==
        (unsigned int)theArg->profile) {
  ...
  char buf[255];
  sprintf(buf, "%s has invited you to voice chat.  Accept?",
          (LPCSTR)aBuddyName);
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void OnGPConnect(GPConnection *theConnection,
                        GPConnectResponseArg *theArg, void *theParam) {
  CVoice2BuddyMFCDlg *aDialog = (CVoice2BuddyMFCDlg *)theParam;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CVoice2BuddyMFCDlg::DoLogin(const CString &theEmail,
  ...
  GPResult result = gpInitialize(
      &m_GP, PRODUCTID_GMTEST, NAMESPACE_GAMESPY_SHARED, GP_PARTNERID_GAMESPY);
  ...
  gpSetCallback(&m_GP, GP_RECV_BUDDY_MESSAGE, (GPCallback)OnGPBuddyMessage,
                this);
  m_Initialized = TRUE;

  // Connect to the presence server (goes to callback even though it's blocking)
  gpConnect(&m_GP, theNickname, theEmail, thePassword, GP_NO_FIREWALL,
            GP_BLOCKING, (GPCallback)OnGPConnect, this);
