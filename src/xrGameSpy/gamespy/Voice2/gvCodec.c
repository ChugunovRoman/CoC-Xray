...
static void gviRawDecodeAdd(GVSample *out, const GVByte *in,
                            GVDecoderData data) {
...
static void gviRawDecodeSet(GVSample *out, const GVByte *in,
                            GVDecoderData data) {
  const GVSample *sampleIn = (const GVSample *)in;
  int i;
...
GVRate gviGetSampleRate(void) { return GVISampleRate; }
