...
int ptCreateCheckPatchTrackUsageReqA(int userID, int productID,
...
PTBool ptCheckForPatchAndTrackUsageA(int userID, int productID,
  ...
  ///////////////////////////////////
  if ((ptCreateCheckPatchTrackUsageReqA(userID, productID, versionUniqueID,
...
#ifdef GSI_UNICODE
int ptCreateCheckPatchTrackUsageReqW(int userID, int productID,
                                     const unsigned short *versionUniqueID,
                                     int distributionID,
                                     ptPatchCallback callback, PTBool blocking,
                                     void *param) {
