...
/////////////////////////////////////
static void EnumStagingPlayersCallback(PEER peer, PEERBool success,
...
void JoinStagingRoomCallback(PEER peer, PEERBool success, PEERJoinResult result,
...
BOOL CStagingPage::OnSetActive() {
  ...
  if (!Wizard->m_hosting) {
    ...
    peerJoinStagingRoom(Wizard->m_peer, game->server, NULL,
                        JoinStagingRoomCallback, Wizard, PEERTrue);
  ...
  ////////////////////////
  peerEnumPlayers(Wizard->m_peer, StagingRoom, EnumStagingPlayersCallback,
                  Wizard);
  // PEERSTOP
