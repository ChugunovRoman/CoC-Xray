...
///////////////////////////////////////////////////////////
const char *
peerTranslateNickA(char *nick,           // The nick to translate
...
void peerJoinStagingRoomA(
    ...
    const char password[PEER_PASSWORD_LEN], // The password of the room being
                                            // joined.  Can be NULL or "".
    peerJoinRoomCallback callback,          // Called when finished.
    void *param,                            // Passed to the callback.
    PEERBool blocking // If PEERTrue, don't return until finished.
);
...
void peerCreateStagingRoomA(
    ...
    const char password[PEER_PASSWORD_LEN], // An optional password for the
                                            // staging room
    peerJoinRoomCallback callback,          // Called when finished.
    void *param,                            // Passed to the callback.
    PEERBool blocking // If PEERTrue, don't return until finished.
...
void peerLeaveRoomA(PEER peer,         // The peer object.
                    ...
                    const char *reason // The reason the player is leaving (can
                                       // be NULL).  PANTS|03.13.01
);
...
///////////////////////////////////////////////////
const char *
peerGetRoomChannelA(PEER peer,        // The peer object.
...
/////////////////////////////////////////////////////////////////////////////
PEERBool
peerGetPlayerPingA(PEER peer,        // The peer object.
...
///////////////////////////////
PEERBool
peerGetReadyA(PEER peer,        // The peer object.
              const char *nick, // The player's nick.
...
void peerSetRoomKeysA(PEER peer,          // The peer object.
                      ...
                      const char *nick,   // The player to set the keys on (NULL
                                          // or "" for the room).
                      int num,            // The number of keys.
                      const char **keys,  // The keys to set.
...
///////////////////////////////////////////////////////////////
const char *
peerGetGlobalWatchKeyA(PEER peer,        // The peer object.
...
///////////////////////////////////////////////////////////////
const char *
peerGetRoomWatchKeyA(PEER peer,         // The peer object.
