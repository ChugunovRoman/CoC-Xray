...
float *ComputeNewPosition(V2f dest, const V2f position, int motion,
                          float rotation, unsigned long diff,
                          int unitsPerMilliSec, GT2Bool clamp);

float ComputeNewRotation(float rotation, int turning, unsigned long diff,
