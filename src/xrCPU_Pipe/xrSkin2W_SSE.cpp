...
#define shuffle_sw4(SW0, SW1, SW2, SW3)                                        \
  __asm movss SW3, DWORD PTR[One] __asm movss SW0,                             \
      ...
      _MM_SHUFFLE(1, 0, 0, 0) __asm shufps SW3, SW3, _MM_SHUFFLE(1, 0, 0, 0)

// ==================================================================
void __stdcall xrSkin4W_SSE(vertRender *D, vertBoned4W *S, u32 vCount,
                            CBoneInstance *Bones) {
  __m128 P0, P1, P2, P3;
  DWORD One;
  __asm {
...
// ==================================================================
void __stdcall xrSkin3W_SSE(vertRender *D, vertBoned3W *S, u32 vCount,
                            CBoneInstance *Bones) {
  __m128 P0, P1;
  DWORD One;
  __asm {
...
// ==================================================================
void __stdcall xrSkin2W_SSE(vertRender *D, vertBoned2W *S, u32 vCount,
                            CBoneInstance *Bones) {
  __asm {
    // ------------------------------------------------------------------
	mov			edi, DWORD PTR [D]			; edi = D
...
// ==================================================================
void __stdcall xrSkin1W_SSE(vertRender *D, vertBoned1W *S, u32 vCount,
                            CBoneInstance *Bones) {
  __asm {
    // ------------------------------------------------------------------
	mov			edi, DWORD PTR [D]			; edi = D
