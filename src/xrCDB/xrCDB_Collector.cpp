...
void Collector::add_face_D(const Fvector &v0, const Fvector &v1,
...
void Collector::add_face(const Fvector &v0, const Fvector &v1,
                         const Fvector &v2, u16 material, u16 sector) {
  TRI T;
  T.verts[0] = verts.size();
  T.verts[1] = verts.size() + 1;
  T.verts[2] = verts.size() + 2;
...
void Collector::add_face_packed(const Fvector &v0, const Fvector &v1,
                                const Fvector &v2,        // vertices
...
CollectorPacked::CollectorPacked(const Fbox &bb, int apx_vertices,
                                 int apx_faces) {
  // Params
