 ...
 *complete tree (2*N-1 nodes) whose negative box pointers and primitive pointers
 *have been made implicit, hence packing 3 pointers in one.
 *
 ...
 *const udword boxid, udword& curid, const AABBTreeNode* curnode) \param
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static void _BuildCollisionTree(AABBCollisionNode *linear, const udword boxid,
  ...
  if (curnode->IsLeaf()) {
    ...
    // To make the negative one implicit, we must store P and N in successive
    // order
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static void _BuildNoLeafTree(AABBNoLeafNode *linear, const udword boxid,
                             udword &curid, const AABBTreeNode *curnode) {
  ...
  if (gFixQuantized) {                                                         \
    ...
    for (udword j = 0; j < 3; j++) { /* Dequantize the box center */           \
      ...
      do { /* Dequantize the box extent */                                     \
        float qe = float(((float *)mNodes[i].mAABB.mExtents)[j]) *             \
