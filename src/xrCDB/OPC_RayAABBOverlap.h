 ...
 *Segment is cached within the class. \param		center	[in] AABB center
 ...
 *is cached within the class. \param		center	[in] AABB center \param
 *extents	[in] AABB extents \return		true on overlap
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline_ BOOL RayCollider::RayAABBOverlap(const Point &center,
  ...
  // center.y;	if(GREATER(Dy, extents.y) && ((SIR(Dy)-1)^SIR(mDir.y))>=0.0f)
  // return FALSE; 	float Dz = mOrigin.z - center.z;	if(GREATER(Dz,
  // extents.z) && ((SIR(Dz)-1)^SIR(mDir.z))>=0.0f)	return FALSE;
