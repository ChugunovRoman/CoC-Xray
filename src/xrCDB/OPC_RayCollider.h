...
public:
   ...
   *null \param		cache			[in] a possibly cached face
   ...
   */
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  bool Collide(const Ray &world_ray, OPCODE_Model *model,
               const Matrix4x4 *world = null, udword *cache = null);

  // Collision queries
  bool Collide(const Ray &world_ray, const AABBCollisionTree *tree,
               const Matrix4x4 *world = null, udword *cache = null);
  bool Collide(const Ray &world_ray, const AABBNoLeafTree *tree,
               const Matrix4x4 *world = null, udword *cache = null);
  bool Collide(const Ray &world_ray, const AABBQuantizedTree *tree,
               const Matrix4x4 *world = null, udword *cache = null);
  bool Collide(const Ray &world_ray, const AABBQuantizedNoLeafTree *tree,
               const Matrix4x4 *world = null, udword *cache = null);
  bool Collide(const Ray &world_ray, const AABBTree *tree,
   ...
   *maximal value, for ray queries (else segment) \see
   *SetClosestHit(bool flag) \see		SetCulling(bool flag) \see
   ...
   *during queries \see		SetClosestHit(bool flag) \see SetCulling(bool
   *flag) \see		SetMaxDist(float maxdist)
   */
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   *query. \see		GetNbRayBVTests() \see		GetNbIntersections()
   ...
   *Can be used for in/out tests. \see		GetNbRayBVTests() \see
   *GetNbRayPrimTests() \return		the number of valid intersections during
   *last query
   */
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   *triangle-vertices for a given triangle index. \param		callback
...
protected:
  ...
  inline_ BOOL RayTriOverlap(const Point &vert0, const Point &vert1,
                             const Point &vert2);
  // Init methods
  BOOL InitQuery(const Ray &world_ray, const Matrix4x4 *world = null,
                 udword *faceid = null);
};
