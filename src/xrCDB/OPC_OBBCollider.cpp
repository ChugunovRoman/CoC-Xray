 ...
 *space \param		model		[in] Opcode model to collide with \param
 *worldb		[in] OBB's world matrix, or null \param worldm
 *[in] model's world matrix, or null \return		true if success \warning
  ...
  if (!model->HasLeafNodes()) {
    if (model->IsQuantized())
      return Collide(cache, box,
                     (const AABBQuantizedNoLeafTree *)model->GetTree(), worldb,
                     worldm);
    else
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL OBBCollider::InitQuery(OBBCache &cache, const OBB &box,
                            const Matrix4x4 *worldb, const Matrix4x4 *worldm) {
  ...
  if (TemporalCoherenceEnabled()) {
    ...
    if (FirstContactEnabled()) {
      ...
      if (mTouchedPrimitives->GetNbEntries()) {
        ...
        // Perform overlap test between the cached triangle and the box (and set
        // contact status if needed)
 ...
 *	\param		cache		[in/out] a box cache
 *	\param		box			[in] collision OBB in local
 *space \param		tree		[in] model's AABB tree
 *	\param		worldb		[in] OBB's world matrix, or null
 *	\param		worldm		[in] model's world matrix, or null
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool OBBCollider::Collide(OBBCache &cache, const OBB &box,
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool OBBCollider::Collide(OBBCache &cache, const OBB &box,
                          const AABBNoLeafTree *tree, const Matrix4x4 *worldb,
 ...
 *query sooner. \param		bc	[in] box center \param		be
 *[in] box extents \return		true if the OBB contains the whole box
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
