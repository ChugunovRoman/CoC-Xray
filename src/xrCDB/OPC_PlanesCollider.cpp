 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool PlanesCollider::Collide(PlanesCache &cache, const Plane *planes,
                             udword nb_planes, OPCODE_Model *model,
  ...
  if (!model->HasLeafNodes()) {
    ...
    if (model->IsQuantized())
      return Collide(cache, planes, nb_planes,
                     (const AABBQuantizedTree *)model->GetTree(), worldm);
    else
      return Collide(cache, planes, nb_planes,
                     (const AABBCollisionTree *)model->GetTree(), worldm);
  }
}
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL PlanesCollider::InitQuery(PlanesCache &cache, const Plane *planes,
                               udword nb_planes, const Matrix4x4 *worldm) {
  ...
  if (TemporalCoherenceEnabled()) {
    ...
    if (FirstContactEnabled()) {
      ...
      if (mTouchedPrimitives->GetNbEntries()) {
        ...
        // Perform overlap test between the cached triangle and the planes (and
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool PlanesCollider::Collide(PlanesCache &cache, const Plane *planes,
                             udword nb_planes, const AABBCollisionTree *tree,
                             const Matrix4x4 *worldm) {
  // Checkings
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool PlanesCollider::Collide(PlanesCache &cache, const Plane *planes,
                             udword nb_planes, const AABBNoLeafTree *tree,
                             const Matrix4x4 *worldm) {
  // Checkings
  if (!tree || !planes || !nb_planes)
    return false;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool PlanesCollider::Collide(PlanesCache &cache, const Plane *planes,
                             udword nb_planes, const AABBQuantizedTree *tree,
                             const Matrix4x4 *worldm) {
  // Checkings
  if (!tree || !planes || !nb_planes)
    return false;
...
void PlanesCollider::_Collide(const AABBCollisionNode *node, udword clipmask) {
  ...
  // If the box is completely included, so are its children. We don't need to do
  // extra tests, we can immediately output a list of visible children. Those
  // ones won't need to be clipped.
  if (!OutClipMask) {
    // Set contact status
    mFlags |= OPC_CONTACT;
    _Dump(node);
