...
AABBTreeCollider::AABBTreeCollider()
    : mNbBVBVTests(0), mNbPrimPrimTests(0), mNbBVPrimTests(0),
 ...
 *object \param		world1			[in] world matrix for second
 *object \return		true if success \warning	SCALE NOT
 *SUPPORTED. The matrices must contain rotation & translation parts only.
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool AABBTreeCollider::Collide(BVTCache &cache, const Matrix4x4 *world0,
  ...
  if (cache.HullTest) {
    if (cache.Model0->GetHull() && cache.Model1->GetHull()) {
      struct Local {
        static Point *SVCallback(const Point &sv, udword &previndex,
                                 udword user_data) {
 ...
 *	\param		world0			[in] world matrix for first
 *object \param		world1			[in] world matrix for second
 *object \warning	SCALE NOT SUPPORTED. The matrices must contain rotation
...
void AABBTreeCollider::InitQuery(const Matrix4x4 *world0,
  ...
  for (udword i = 0; i < 3; i++) {
    for (udword j = 0; j < 3; j++) {
      // Epsilon value prevents floating-point inaccuracies (strategy borrowed
      // from RAPID)
 ...
 *primitives \warning	only works for "First Contact" mode
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 *object \param		world0			[in] world matrix for first
 *object \param		world1			[in] world matrix for second
 *object \param		cache			[in/out] cache for a pair of
 *previously colliding primitives \return		true if success \warning
 *SCALE NOT SUPPORTED. The matrices must contain rotation & translation parts
 *only.
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void AABBTreeCollider::PrimTest(udword id0, udword id1) {
  ...
  if (TriTriOverlap(*VP0.Vertex[0], *VP0.Vertex[1], *VP0.Vertex[2], u0, u1,
                    u2)) {
 ...
 *space) and a _new_ leaf from B. \param		id1		[in]
 *leaf-triangle index from tree B
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#endif
  // Perform triangle-triangle overlap test
  if (TriTriOverlap(mLeafVerts[0], mLeafVerts[1], mLeafVerts[2], *VP.Vertex[0],
 ...
 *space) and a _new_ leaf from A. \param		id0		[in]
 *leaf-triangle index from tree A
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void AABBTreeCollider::_Collide(const AABBQuantizedNode *b0,
                                const AABBQuantizedNode *b1, const Point &a,
                                const Point &Pa, const Point &b,
                                const Point &Pb) {
  // Perform BV-BV overlap test
