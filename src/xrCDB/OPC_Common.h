 ...
 *be provided by the user) \param		user_data		[in]
 *user-defined data from SetCallback()
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
typedef void (*OPC_CALLBACK)(udword triangle_index, VertexPointers &triangle,
                             udword user_data);
...
inline_ void TransformPoint(Point &dest, const Point &source,
                            const Matrix3x3 &rot, const Point &trans) {
