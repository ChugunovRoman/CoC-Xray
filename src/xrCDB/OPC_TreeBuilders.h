...
enum SplittingRules {
  ...
  SPLIT_SPLATTERPOINTS =
      (1 << 2),              //!< Splatter primitive centers (QuickCD-style)
  ...
  // Node split
  SPLIT_GEOMCENTER =
      (1 << 6), //!< Split at geometric center (else split in the middle)
  //
...
public:
  //! Constructor
  AABBTreeBuilder()
      : mLimit(0), mRules(SPLIT_FORCE_DWORD), mNbPrimitives(0), mCount(0),
        mNbInvalidSplits(0) {}
  //! Destructor
   ...
   *primitives \param		nb_prims		[in] number of indices
   *	\param		global_box		[out] global AABB enclosing the set
   *of input primitives \return		true if success
   */
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   *split \param		axis			[in] axis index (0,1,2)
   ...
   *	\param		primitives		[in] list of indices of
   *primitives \param		nb_prims		[in] number of indices
   *	\param		global_box		[in] global AABB enclosing the set
   *of input primitives \param		axis			[in] axis index
   *(0,1,2) \return		splitting value
   */
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
