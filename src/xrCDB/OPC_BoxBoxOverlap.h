...
inline_ BOOL AABBTreeCollider::BoxBoxOverlap(const Point &ea, const Point &ca,
  ...
  float Tx =
      (mR1to0.m[0][0] * cb.x + mR1to0.m[1][0] * cb.y + mR1to0.m[2][0] * cb.z) +
      mT1to0.x - ca.x;
  ...
  float Ty =
      (mR1to0.m[0][1] * cb.x + mR1to0.m[1][1] * cb.y + mR1to0.m[2][1] * cb.z) +
      mT1to0.y - ca.y;
  ...
  float Tz =
      (mR1to0.m[0][2] * cb.x + mR1to0.m[1][2] * cb.y + mR1to0.m[2][2] * cb.z) +
      mT1to0.z - ca.z;
