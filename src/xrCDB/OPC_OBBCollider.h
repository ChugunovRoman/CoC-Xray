...
public:
   ...
   *local space \param		model			[in] Opcode model to
   *collide
   *with \param		worldb			[in] OBB's world matrix, or null
  ...
  bool Collide(OBBCache &cache, const OBB &box, const AABBQuantizedTree *tree,
               const Matrix4x4 *worldb = null, const Matrix4x4 *worldm = null);
  bool Collide(OBBCache &cache, const OBB &box,
...
protected:
  ...
  // Init methods
  BOOL InitQuery(OBBCache &cache, const OBB &box,
