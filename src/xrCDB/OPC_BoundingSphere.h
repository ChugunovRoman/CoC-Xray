...
private:
  ...
  Sphere Circumscribe4(const Point &p0, const Point &p1, const Point &p2,
                       const Point &p3);
  Sphere MinFix3(int n, Point **perm, Point *fixed0, Point *fixed1,
                 Point *fixed2);
  ...
  Sphere MinimalSphere4(const Point &p0, const Point &p1, const Point &p2,
                        const Point &p3);
#endif
};
