...
public:
   ...
   *pointers and a colliding pair of primitives \param		world0
   *[in] world matrix for first object, or null \param		world1
   *[in] world matrix for second object, or null \return		true if
   *success \warning	SCALE NOT SUPPORTED. The matrices must contain rotation
   *& translation parts only.
   */
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  bool Collide(BVTCache &cache, const Matrix4x4 *world0 = null,
   ...
   *coarse tests \see		SetFullPrimBoxTest(bool flag)
   */
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   *(where Class III axes are discarded) \param		flag
   *[in] true for full tests, false for coarse tests \see
   ...
   *collision query. \see		GetNbBVBVTests() \see
   *GetNbBVPrimTests()
   ...
   *query. \see		GetNbBVBVTests() \see		GetNbPrimPrimTests()
...
protected:
  ...
  void _Collide(const AABBQuantizedNode *b0, const AABBQuantizedNode *b1,
  ...
  inline_ BOOL BoxBoxOverlap(const Point &ea, const Point &ca, const Point &eb,
                             const Point &cb);
  inline_ BOOL TriBoxOverlap(const Point &center, const Point &extents);
  inline_ BOOL TriTriOverlap(const Point &V0, const Point &V1, const Point &V2,
