...
public:
  walker(ISpatial_DB *_space, u32 _mask, const Fvector &_center,
         const Fvector &_size) {
    mask = _mask;
    center = _center;
    size = _size;
...
void ISpatial_DB::q_box(xr_vector<ISpatial *> &R, u32 _o, u32 _mask,
...
void ISpatial_DB::q_sphere(xr_vector<ISpatial *> &R, u32 _o, u32 _mask,
