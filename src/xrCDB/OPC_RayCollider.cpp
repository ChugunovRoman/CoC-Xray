 ...
 *face. If can be useful e.g. for shadow feelers, where you want to know whether
 *the path to the light is _free or not (a boolean answer is enough).
 ...
 *ray against the cached triangle. If they still collide, we return immediately.
 *
 *	CLOSEST HIT:
 *
...
RayCollider::RayCollider()
    : mNbRayBVTests(0), mNbRayPrimTests(0), mNbIntersections(0),
 ...
 *with \param		world			[in] model's world matrix, or
 *null
 *	\param		cache			[in] a possibly cached face
 *index, or null \return		true if success \warning	SCALE
 *NOT SUPPORTED. The matrices must contain rotation & translation parts only.
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool RayCollider::Collide(const Ray &world_ray, OPCODE_Model *model,
  ...
  if (!model->HasLeafNodes()) {
    if (model->IsQuantized())
      return Collide(world_ray,
                     (const AABBQuantizedNoLeafTree *)model->GetTree(), world,
                     cache);
    else
      return Collide(world_ray, (const AABBNoLeafTree *)model->GetTree(), world,
                     cache);
  } else {
    if (model->IsQuantized())
      return Collide(world_ray, (const AABBQuantizedTree *)model->GetTree(),
                     world, cache);
    else
      return Collide(world_ray, (const AABBCollisionTree *)model->GetTree(),
                     world, cache);
  }
}
 ...
 *null \param		faceid		[in] index of previously stabbed
 *triangle \return		contact status \warning	SCALE NOT SUPPORTED. The
 *matrix must contain rotation & translation parts only.
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL RayCollider::InitQuery(const Ray &world_ray, const Matrix4x4 *world,
                            udword *faceid) {
  // Reset stats & contact status
 ...
 *	\param		cache			[in] a possibly cached face
 *index, or null \return		true if success \warning	SCALE
 *NOT SUPPORTED. The matrix must contain rotation & translation parts only.
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool RayCollider::Collide(const Ray &world_ray, const AABBNoLeafTree *tree,
                          const Matrix4x4 *world, udword *cache) {
  // Checkings
  if (!tree)
    return false;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool RayCollider::Collide(const Ray &world_ray, const AABBTree *tree,
