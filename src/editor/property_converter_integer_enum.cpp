...
bool property_converter_integer_enum::GetStandardValuesSupported(
    ITypeDescriptorContext ^ context) {
  return (true);
}

bool property_converter_integer_enum::GetStandardValuesExclusive(
    ITypeDescriptorContext ^ context) {
  return (true);
}

StandardValuesCollection ^
    property_converter_integer_enum::GetStandardValues(ITypeDescriptorContext ^
                                                       context) {
  ...
  property_integer_enum_value ^ value =
      safe_cast<property_integer_enum_value ^>(raw_value);
  return (gcnew StandardValuesCollection(value->m_collection));
}

Object ^
    property_converter_integer_enum::ConvertTo(ITypeDescriptorContext ^ context,
                                               CultureInfo ^ culture,
                                               Object ^ value,
  ...
  PropertySpecDescriptor ^ descriptor =
      safe_cast<PropertySpecDescriptor ^>(context->PropertyDescriptor);
  property_value ^ raw_value = container->value(descriptor->item);
  property_integer_enum_value ^ real_value =
      safe_cast<property_integer_enum_value ^>(raw_value);
