  ...
  void InitializeComponent(void) {
    ...
    this->TreeView->MouseDoubleClick +=
        gcnew System::Windows::Forms::MouseEventHandler(
            this, &window_tree_values::TreeView_MouseDoubleClick);
    this->TreeView->AfterCollapse +=
        gcnew System::Windows::Forms::TreeViewEventHandler(
            this, &window_tree_values::TreeView_AfterCollapse);
    this->TreeView->MouseClick +=
        gcnew System::Windows::Forms::MouseEventHandler(
            this, &window_tree_values::TreeView_MouseClick);
    this->TreeView->AfterExpand +=
        gcnew System::Windows::Forms::TreeViewEventHandler(
            this, &window_tree_values::TreeView_AfterExpand);
    //
    // Images
    //
    this->Images->ImageStream =
        (cli::safe_cast<System::Windows::Forms::ImageListStreamer ^>(
            resources->GetObject(L"Images.ImageStream")));
    ...
    // Cancel_Button
    //
    this->Cancel_Button->DialogResult =
    ...
    this->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 8.25F, System::Drawing::FontStyle::Regular,
