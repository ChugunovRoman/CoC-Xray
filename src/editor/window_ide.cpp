...
Void window_ide::window_ide_SizeChanged(System::Object ^ sender,
                                        System::EventArgs ^ e) {
...
Void window_ide::window_ide_LocationChanged(System::Object ^ sender,
                                            System::EventArgs ^ e) {
...
Void window_ide::window_ide_Activated(System::Object ^ sender,
                                      System::EventArgs ^ e) {
  m_view->window_view_Activated(sender, e);
}

Void window_ide::window_ide_Deactivate(System::Object ^ sender,
                                       System::EventArgs ^ e) {
  m_view->window_view_Deactivate(sender, e);
}

Void window_ide::window_ide_FormClosing(
