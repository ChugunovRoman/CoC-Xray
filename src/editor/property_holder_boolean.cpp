...
editor::property_value *property_holder::add_property(
    ...
    bool const &default_value, boolean_getter_type const &getter,
    boolean_setter_type const &setter, readonly_enum const &read_only,
  ...
  m_container->add_property(
      gcnew PropertySpec(to_string(identifier), bool ::typeid,
...
property_holder::add_property(LPCSTR identifier, LPCSTR category,
                              LPCSTR description, bool const &default_value,
                              bool &value, readonly_enum const &read_only,
                              notify_parent_on_change_enum const &notify_parent,
                              password_char_enum const &password,
                              refresh_grid_on_change_enum const &refresh_grid) {
  m_container->add_property(
...
property_holder::add_property(LPCSTR identifier, LPCSTR category,
                              ...
                              LPCSTR values[2], readonly_enum const &read_only,
                              notify_parent_on_change_enum const &notify_parent,
                              password_char_enum const &password,
                              refresh_grid_on_change_enum const &refresh_grid) {
  m_container->add_property(
