...
property_vec3f_base::property_vec3f_base(editor::vec3f const % vec3f) {
  ...
  m_container->add_property(
      gcnew PropertySpec("x", float ::typeid, "components", "X component",
                         vec3f.x, (String ^) nullptr,
  ...
  m_container->add_property(
      gcnew PropertySpec("y", float ::typeid, "components", "Y component",
                         vec3f.y, (String ^) nullptr,
                         property_converter_float::typeid),
      gcnew property_float(getter, setter, .01f));
  ...
  m_container->add_property(
      gcnew PropertySpec("z", float ::typeid, "components", "Z component",
                         vec3f.z, (String ^) nullptr,
                         property_converter_float::typeid),
      gcnew property_float(getter, setter, .01f));
}
...
Object ^ property_vec3f_base::get_value() { return (m_container); }
