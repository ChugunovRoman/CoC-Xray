...
PropertyDescriptorCollection ^
    property_converter_color::GetProperties(ITypeDescriptorContext ^ context,
                                            Object ^ value,
...
bool property_converter_color::GetPropertiesSupported(ITypeDescriptorContext ^
                                                      context) {
  return (true);
}

bool property_converter_color::CanConvertTo(ITypeDescriptorContext ^ context,
...
Object ^ property_converter_color::ConvertTo(ITypeDescriptorContext ^ context,
                                             CultureInfo ^ culture,
                                             Object ^ value,
                                             Type ^ destination_type) {
  if (destination_type == String::typeid) {
    ...
    editor::color color =
        safe_cast<property_color_base %>(container->container_holder())
            .get_value_raw();
    return ("" +
            property_converter_float().ConvertTo(context, culture, color.r,
                                                 String::typeid) +
            " " +
            property_converter_float().ConvertTo(context, culture, color.g,
                                                 String::typeid) +
            " " +
            property_converter_float().ConvertTo(context, culture, color.b,
                                                 String::typeid) +
            "");
  }
...
bool property_converter_color::CanConvertFrom(ITypeDescriptorContext ^ context,
                                              Type ^ source_type) {
...
Object ^ property_converter_color::ConvertFrom(ITypeDescriptorContext ^ context,
                                               CultureInfo ^ culture,
                                               Object ^ value) {
