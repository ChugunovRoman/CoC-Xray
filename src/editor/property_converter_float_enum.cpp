...
bool property_converter_float_enum::GetStandardValuesSupported(
    ITypeDescriptorContext ^ context) {
  return (true);
}

bool property_converter_float_enum::GetStandardValuesExclusive(
    ITypeDescriptorContext ^ context) {
  return (true);
}

StandardValuesCollection ^
    property_converter_float_enum::GetStandardValues(ITypeDescriptorContext ^
                                                     context) {
  ...
  property_float_enum_value ^ value =
      safe_cast<property_float_enum_value ^>(raw_value);
  return (gcnew StandardValuesCollection(value->m_collection));
}

Object ^
    property_converter_float_enum::ConvertTo(ITypeDescriptorContext ^ context,
                                             CultureInfo ^ culture,
                                             Object ^ value,
  ...
  PropertySpecDescriptor ^ descriptor =
      safe_cast<PropertySpecDescriptor ^>(context->PropertyDescriptor);
  property_value ^ raw_value = container->value(descriptor->item);
  property_float_enum_value ^ real_value =
      safe_cast<property_float_enum_value ^>(raw_value);
