...
property_integer_values_value_reference_getter::
    property_integer_values_value_reference_getter(
        int &value, string_collection_getter_type const &collection_getter,
    ...
    : inherited(value),
      ...
      m_collection_size_getter(
          new string_collection_size_getter_type(collection_size_getter)) {}
...
void property_integer_values_value_reference_getter::set_value(Object ^
                                                               object) {
