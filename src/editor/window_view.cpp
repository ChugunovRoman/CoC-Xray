...
Void window_view::EditButton_Click(System::Object ^ sender,
                                   System::EventArgs ^ e) {
...
Void window_view::PauseButton_Click(System::Object ^ sender,
                                    System::EventArgs ^ e) {
  PauseButton->Checked = !PauseButton->Checked;
  m_engine->pause(PauseButton->Checked);
}

Void window_view::window_view_DoubleClick(System::Object ^ sender,
                                          System::EventArgs ^ e) {
  if (!EditButton->Checked)
    return;
...
Void window_view::window_view_SizeChanged(System::Object ^ sender,
                                          System::EventArgs ^ e) {
  if (!components)
    return;
...
Void window_view::window_view_LocationChanged(System::Object ^ sender,
                                              System::EventArgs ^ e) {
  if (!Parent)
    return;
...
Void window_view::window_view_Activated(System::Object ^ sender,
                                        System::EventArgs ^ e) {
  if (!Parent)
    return;
...
Void window_view::window_view_Deactivate(System::Object ^ sender,
                                         System::EventArgs ^ e) {
  if (!Parent)
    return;
...
Void window_view::window_view_KeyUp(System::Object ^ sender,
...
Void window_view::window_view_Paint(System::Object ^ sender,
...
Void window_view::ViewPanel_MouseDown(System::Object ^ sender,
...
Void window_view::ViewPanel_MouseMove(System::Object ^ sender,
                                      System::Windows::Forms::MouseEventArgs ^
                                          e) {
  ...
  PropertySpecDescriptor ^ descriptor =
      safe_cast<PropertySpecDescriptor ^>(descriptor_raw);
  property_container ^ container =
      safe_cast<property_container ^>(descriptor->bag);
  ::property_value ^ raw_value = container->value(descriptor->item);
  VERIFY(raw_value);

  property_incrementable ^ incrementable =
      dynamic_cast<property_incrementable ^>(raw_value);
  if (!incrementable)
    return;
...
Void window_view::ViewPanel_MouseLeave(System::Object ^ sender,
                                       System::EventArgs ^ e) {
