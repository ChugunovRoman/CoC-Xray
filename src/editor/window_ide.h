...
#pragma region Windows Form Designer generated code
  ...
  void InitializeComponent(void) {
    ...
    this->Editor->DocumentStyle =
        WeifenLuo::WinFormsUI::DocumentStyles::DockingSdi;
    this->Editor->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 11, System::Drawing::FontStyle::Regular,
    ...
    this->Text = L"editor";
    this->Deactivate +=
        gcnew System::EventHandler(this, &window_ide::window_ide_Deactivate);
    this->SizeChanged +=
        gcnew System::EventHandler(this, &window_ide::window_ide_SizeChanged);
    this->Activated +=
        gcnew System::EventHandler(this, &window_ide::window_ide_Activated);
    this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(
        this, &window_ide::window_ide_FormClosing);
    this->LocationChanged += gcnew System::EventHandler(
        this, &window_ide::window_ide_LocationChanged);
...
private:
  WeifenLuo::WinFormsUI::IDockContent ^
      reload_content(System::String ^ persist_string);

private:
  Void window_ide_SizeChanged(System::Object ^ sender, System::EventArgs ^ e);
  Void window_ide_LocationChanged(System::Object ^ sender,
                                  System::EventArgs ^ e);
  Void window_ide_FormClosing(System::Object ^ sender,
