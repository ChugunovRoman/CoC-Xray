...
bool property_converter_integer_values::GetStandardValuesSupported(
    ITypeDescriptorContext ^ context) {
  return (true);
}

bool property_converter_integer_values::GetStandardValuesExclusive(
    ITypeDescriptorContext ^ context) {
  return (true);
}

StandardValuesCollection ^ property_converter_integer_values::GetStandardValues(
                               ITypeDescriptorContext ^ context) {
  ...
  property_integer_values_value_base ^ value =
      safe_cast<property_integer_values_value_base ^>(raw_value);
  return (gcnew StandardValuesCollection(value->collection()));
}

Object ^ property_converter_integer_values::ConvertTo(ITypeDescriptorContext ^
                                                          context,
                                                      CultureInfo ^ culture,
                                                      Object ^ value,
  ...
  PropertySpecDescriptor ^ descriptor =
      safe_cast<PropertySpecDescriptor ^>(context->PropertyDescriptor);
  property_value ^ raw_value = container->value(descriptor->item);
  property_integer_values_value_base ^ real_value =
      safe_cast<property_integer_values_value_base ^>(raw_value);
