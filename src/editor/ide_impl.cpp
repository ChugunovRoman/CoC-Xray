...
ide_impl::create_property_holder(LPCSTR display_name,
...
void ide_impl::environment_levels(property_holder *property_holder) {
  ::property_holder *properties =
      dynamic_cast<::property_holder *>(property_holder);
  VERIFY(properties);
...
void ide_impl::weather_editor_setup(
  ...
  m_window->weather_editor().weathers_ids(weathers_getter, weathers_size_getter,
