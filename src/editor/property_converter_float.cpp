...
bool property_converter_float::CanConvertTo(ITypeDescriptorContext ^ context,
...
Object ^ property_converter_float::ConvertTo(ITypeDescriptorContext ^ context,
                                             CultureInfo ^ culture,
                                             Object ^ value,
                                             Type ^ destination_type) {
  if (destination_type != String::typeid)
...
bool property_converter_float::CanConvertFrom(ITypeDescriptorContext ^ context,
                                              Type ^ source_type) {
...
Object ^ property_converter_float::ConvertFrom(ITypeDescriptorContext ^ context,
                                               CultureInfo ^ culture,
                                               Object ^ value) {
