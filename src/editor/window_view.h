  ...
  void InitializeComponent(void) {
    ...
    this->MainToolBar->Items->AddRange(
        gcnew cli::array<System::Windows::Forms::ToolStripItem ^>(2){
            this->EditButton, this->PauseButton});
    ...
    // EditButton
    //
    this->EditButton->DisplayStyle =
        System::Windows::Forms::ToolStripItemDisplayStyle::Text;
    this->EditButton->Image = (cli::safe_cast<System::Drawing::Image ^>(
        resources->GetObject(L"EditButton.Image")));
    this->EditButton->ImageTransparentColor = System::Drawing::Color::Magenta;
    this->EditButton->Name = L"EditButton";
    this->EditButton->Size = System::Drawing::Size(29, 22);
    this->EditButton->Text = L"Edit";
    this->EditButton->Click +=
        gcnew System::EventHandler(this, &window_view::EditButton_Click);
    //
    // PauseButton
    //
    this->PauseButton->Checked = true;
    this->PauseButton->CheckState = System::Windows::Forms::CheckState::Checked;
    this->PauseButton->DisplayStyle =
        System::Windows::Forms::ToolStripItemDisplayStyle::Text;
    this->PauseButton->Image = (cli::safe_cast<System::Drawing::Image ^>(
        resources->GetObject(L"PauseButton.Image")));
    this->PauseButton->ImageTransparentColor = System::Drawing::Color::Magenta;
    this->PauseButton->Name = L"PauseButton";
    this->PauseButton->Size = System::Drawing::Size(40, 22);
    this->PauseButton->Text = L"Pause";
    this->PauseButton->Click +=
        gcnew System::EventHandler(this, &window_view::PauseButton_Click);
    //
    // ViewPanel
    //
    ...
    this->ViewPanel->DoubleClick +=
        gcnew System::EventHandler(this, &window_view::window_view_DoubleClick);
    this->ViewPanel->MouseLeave +=
        gcnew System::EventHandler(this, &window_view::ViewPanel_MouseLeave);
    this->ViewPanel->MouseDown +=
        gcnew System::Windows::Forms::MouseEventHandler(
            this, &window_view::ViewPanel_MouseDown);
    this->ViewPanel->MouseMove +=
        gcnew System::Windows::Forms::MouseEventHandler(
            this, &window_view::ViewPanel_MouseMove);
    this->ViewPanel->MouseClick +=
        gcnew System::Windows::Forms::MouseEventHandler(
            this, &window_view::ViewPanel_MouseClick);
    //
    // imageList1
    //
    ...
    this->Text = L"View";
    this->Deactivate +=
        gcnew System::EventHandler(this, &window_view::window_view_Deactivate);
    this->Paint += gcnew System::Windows::Forms::PaintEventHandler(
        this, &window_view::window_view_Paint);
    this->SizeChanged +=
        gcnew System::EventHandler(this, &window_view::window_view_SizeChanged);
    this->Activated +=
        gcnew System::EventHandler(this, &window_view::window_view_Activated);
    this->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(
        this, &window_view::window_view_KeyUp);
    this->LocationChanged += gcnew System::EventHandler(
        this, &window_view::window_view_LocationChanged);
    this->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(
        this, &window_view::window_view_KeyDown);
...
public:
  ...
  void on_idle();
  IntPtr draw_handle();
  Void window_view_LocationChanged(System::Object ^ sender,
                                   System::EventArgs ^ e);
