...
editor::property_value *property_holder::add_property(
    ...
    editor::color const &default_value, color_getter_type const &getter,
    color_setter_type const &setter, readonly_enum const &read_only,
  ...
  PropertySpec ^ spec = gcnew PropertySpec(
      to_string(identifier), Color::typeid, to_string(category),
      to_string(description),
      Color(default_value.r, default_value.g, default_value.b),
      property_editor_color::typeid, property_converter_color::typeid);
  m_container->add_property(
      spec, gcnew property_color(getter, setter, spec->Attributes));
...
editor::property_value *property_holder::add_property(
    LPCSTR identifier, LPCSTR category, LPCSTR description,
    editor::color const &default_value, editor::color &value,
  ...
  PropertySpec ^ spec = gcnew PropertySpec(
      ...
      property_editor_color::typeid, property_converter_color::typeid);
  m_container->add_property(
      spec, gcnew property_color_reference(value, spec->Attributes));
