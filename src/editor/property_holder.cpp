...
property_holder::property_holder(editor::engine *engine, LPCSTR display_name,
                                 property_holder_collection *collection,
                                 editor::property_holder_holder *holder)
    : m_engine(engine), m_display_name(to_string(display_name)),
      m_collection(collection), m_holder(holder), m_disposing(false) {
