...
property_file_name_value::property_file_name_value(
    ...
    System::String ^ DefaultExt_, System::String ^ Filter_,
    System::String ^ InitialDirectory_, System::String ^ Title_,
    bool remove_extension)
    : inherited(getter, setter), DefaultExt(DefaultExt_), Filter(Filter_),
