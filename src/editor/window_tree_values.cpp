...
Void window_tree_values::TreeView_AfterCollapse(Object ^ sender,
                                                TreeViewEventArgs ^ e) {
  e->Node->ImageIndex = 0;
  e->Node->SelectedImageIndex = 0;
}

Void window_tree_values::TreeView_AfterExpand(Object ^ sender,
                                              TreeViewEventArgs ^ e) {
  e->Node->ImageIndex = 1;
  e->Node->SelectedImageIndex = 1;
}

Void window_tree_values::TreeView_MouseClick(Object ^ sender,
                                             MouseEventArgs ^ e) {
...
Void window_tree_values::TreeView_MouseDoubleClick(Object ^ sender,
                                                   MouseEventArgs ^ e) {
  if (e->Button != ::MouseButtons::Left)
    return;
