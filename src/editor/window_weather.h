  ...
  void InitializeComponent(void) {
    ...
    this->toolStrip1->Items->AddRange(
        gcnew cli::array<System::Windows::Forms::ToolStripItem ^>(3){
            this->SaveButton, this->ReloadWeatherButton,
            this->ReloadAllWeathersButton});
    ...
    // SaveButton
    //
    this->SaveButton->DisplayStyle =
        System::Windows::Forms::ToolStripItemDisplayStyle::Image;
    this->SaveButton->Image = (cli::safe_cast<System::Drawing::Image ^>(
        resources->GetObject(L"SaveButton.Image")));
    this->SaveButton->ImageTransparentColor = System::Drawing::Color::Magenta;
    this->SaveButton->Name = L"SaveButton";
    this->SaveButton->Size = System::Drawing::Size(23, 22);
    this->SaveButton->Text = L"save weathers";
    this->SaveButton->Click +=
        gcnew System::EventHandler(this, &window_weather::SaveButton_Click);
    //
    // ReloadWeatherButton
    //
    this->ReloadWeatherButton->DisplayStyle =
        System::Windows::Forms::ToolStripItemDisplayStyle::Image;
    this->ReloadWeatherButton->Image =
        (cli::safe_cast<System::Drawing::Image ^>(
            resources->GetObject(L"ReloadWeatherButton.Image")));
    this->ReloadWeatherButton->ImageTransparentColor =
    ...
    this->ReloadWeatherButton->Click += gcnew System::EventHandler(
        this, &window_weather::ReloadWeatherButton_Click);
    //
    // ReloadAllWeathersButton
    //
    this->ReloadAllWeathersButton->DisplayStyle =
        System::Windows::Forms::ToolStripItemDisplayStyle::Image;
    this->ReloadAllWeathersButton->Image =
        (cli::safe_cast<System::Drawing::Image ^>(
            resources->GetObject(L"ReloadAllWeathersButton.Image")));
    this->ReloadAllWeathersButton->ImageTransparentColor =
        System::Drawing::Color::Magenta;
    ...
    this->ReloadAllWeathersButton->Click += gcnew System::EventHandler(
        this, &window_weather::ReloadAllWeathersButton_Click);
    //
    // PropertyGrid
    //
    ...
    this->Text = L"weather";
    this->Leave +=
        gcnew System::EventHandler(this, &window_weather::window_weather_Leave);
