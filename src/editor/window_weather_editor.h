...
///          tool associated with all .resx files this class depends on.
///          Otherwise, the designers will not be able to interact properly with
///          localized resources associated with this form.
/// </summary>
public
...
public:
  window_weather_editor(window_ide ^ ide, engine *engine)
      : m_ide(ide), m_engine(*engine), m_weathers_getter(0),
        m_weathers_size_getter(0), m_frames_getter(0), m_frames_size_getter(0),
        m_update_enabled(true), m_load_finished(false), m_mouse_down(false),
        m_update_frames_combo_box(false), m_update_frame_trackbar(false),
        m_update_text_value(false), m_update_weather_time(false) {
    InitializeComponent();
    //
...
private:
  editor::controls::property_grid ^ blend;
...
private:
  editor::controls::property_grid ^ target;
...
private:
  editor::controls::property_grid ^ current;
...
#pragma region Windows Form Designer generated code
  ...
  void InitializeComponent(void) {
    ...
    this->WeatherTrackBar->MouseDown +=
        gcnew System::Windows::Forms::MouseEventHandler(
            this, &window_weather_editor::WeatherTrackBar_MouseDown);
    this->WeatherTrackBar->ValueChanged += gcnew System::EventHandler(
        this, &window_weather_editor::WeatherTrackBar_ValueChanged);
    this->WeatherTrackBar->MouseUp +=
        gcnew System::Windows::Forms::MouseEventHandler(
            this, &window_weather_editor::WeatherTrackBar_MouseUp);
    //
    // panel25
    //
    ...
    this->CurrentTimeTextBox->TextAlign =
        System::Windows::Forms::HorizontalAlignment::Center;
    this->CurrentTimeTextBox->TextChanged += gcnew System::EventHandler(
        this, &window_weather_editor::CurrentTimeTextBox_TextChanged);
    //
    // label7
    //
    ...
    this->CurrentTimeTrackBar->TickStyle =
        System::Windows::Forms::TickStyle::None;
    this->CurrentTimeTrackBar->MouseDown +=
        gcnew System::Windows::Forms::MouseEventHandler(
            this, &window_weather_editor::CurrentTimeTrackBar_MouseDown);
    this->CurrentTimeTrackBar->ValueChanged += gcnew System::EventHandler(
        this, &window_weather_editor::CurrentTimeTrackBar_ValueChanged);
    this->CurrentTimeTrackBar->MouseUp +=
        gcnew System::Windows::Forms::MouseEventHandler(
            this, &window_weather_editor::CurrentTimeTrackBar_MouseUp);
    //
    // panel10
    //
    ...
    // NextFrameButton
    //
    this->NextFrameButton->Image = (cli::safe_cast<System::Drawing::Image ^>(
        resources->GetObject(L"NextFrameButton.Image")));
    ...
    this->NextFrameButton->Click += gcnew System::EventHandler(
        this, &window_weather_editor::NextFrameButton_Click);
    //
    // panel9
    //
    ...
    // PauseButton
    //
    this->PauseButton->BackgroundImageLayout =
    ...
    this->PauseButton->Click += gcnew System::EventHandler(
        this, &window_weather_editor::PauseButton_Click);
    //
    // PreviousFrameButton
    //
    this->PreviousFrameButton->Image =
        (cli::safe_cast<System::Drawing::Image ^>(
            resources->GetObject(L"PreviousFrameButton.Image")));
    ...
    this->PreviousFrameButton->Click += gcnew System::EventHandler(
        this, &window_weather_editor::PreviousFrameButton_Click);
    //
    // panel3
    //
    ...
    this->WeathersComboBox->DropDownStyle =
    ...
    this->WeathersComboBox->SelectedIndexChanged += gcnew System::EventHandler(
        this, &window_weather_editor::WeathersComboBox_SelectedIndexChanged);
    //
    // panel7
    //
    ...
    this->TimeFactorNumericUpDown->Increment =
        System::Decimal(gcnew cli::array<System::Int32>(4){10, 0, 0, 0});
    this->TimeFactorNumericUpDown->Location = System::Drawing::Point(0, 25);
    this->TimeFactorNumericUpDown->Maximum =
        System::Decimal(gcnew cli::array<System::Int32>(4){100000, 0, 0, 0});
    this->TimeFactorNumericUpDown->Minimum =
        System::Decimal(gcnew cli::array<System::Int32>(4){1, 0, 0, 131072});
    ...
    this->TimeFactorNumericUpDown->Value =
        System::Decimal(gcnew cli::array<System::Int32>(4){1, 0, 0, 0});
    this->TimeFactorNumericUpDown->ValueChanged += gcnew System::EventHandler(
        this, &window_weather_editor::TimeFactorNumericUpDown_ValueChanged);
    //
    // panel5
    //
    ...
    // FramesComboBox
    //
    this->FramesComboBox->DropDownStyle =
        System::Windows::Forms::ComboBoxStyle::DropDownList;
    ...
    this->FramesComboBox->SelectedIndexChanged += gcnew System::EventHandler(
        this, &window_weather_editor::FramesComboBox_SelectedIndexChanged);
    this->FramesComboBox->DropDownClosed += gcnew System::EventHandler(
        this, &window_weather_editor::FramesComboBox_DropDownClosed);
    this->FramesComboBox->DropDown += gcnew System::EventHandler(
        this, &window_weather_editor::FramesComboBox_DropDown);
    //
    // panel2
    //
    ...
    this->CopyButton->Image = (cli::safe_cast<System::Drawing::Image ^>(
        resources->GetObject(L"CopyButton.Image")));
    ...
    this->CopyButton->Click += gcnew System::EventHandler(
        this, &window_weather_editor::CopyButton_Click);
    //
    // panel11
    //
    ...
    this->CreateFromButton->Image = (cli::safe_cast<System::Drawing::Image ^>(
        resources->GetObject(L"CreateFromButton.Image")));
    ...
    this->CreateFromButton->Click += gcnew System::EventHandler(
        this, &window_weather_editor::CreateFromButton_Click);
    //
    // splitter2
    //
    ...
    this->PasteTargetButton->Image = (cli::safe_cast<System::Drawing::Image ^>(
        resources->GetObject(L"PasteTargetButton.Image")));
    ...
    this->PasteTargetButton->Click += gcnew System::EventHandler(
        this, &window_weather_editor::PasteTargetButton_Click);
    //
    // splitter1
    //
    ...
    this->PasteCurrentButton->Image = (cli::safe_cast<System::Drawing::Image ^>(
        resources->GetObject(L"PasteCurrentButton.Image")));
    ...
    this->PasteCurrentButton->Click += gcnew System::EventHandler(
        this, &window_weather_editor::PasteCurrentButton_Click);
    //
    // ReloadCurrentButton
    //
    this->ReloadCurrentButton->AutoSize = true;
    this->ReloadCurrentButton->Image =
        (cli::safe_cast<System::Drawing::Image ^>(
            resources->GetObject(L"ReloadCurrentButton.Image")));
    ...
    this->ReloadCurrentButton->Click += gcnew System::EventHandler(
        this, &window_weather_editor::ReloadCurrentButton_Click);
    //
    // ReloadTargetButton
    //
    this->ReloadTargetButton->AutoSize = true;
    this->ReloadTargetButton->Image = (cli::safe_cast<System::Drawing::Image ^>(
        resources->GetObject(L"ReloadTargetButton.Image")));
    ...
    this->ReloadTargetButton->Click += gcnew System::EventHandler(
        this, &window_weather_editor::ReloadTargetButton_Click);
    //
    // window_weather_editor
    //
    ...
    this->SizeChanged += gcnew System::EventHandler(
        this, &window_weather_editor::window_weather_editor_SizeChanged);
    this->Enter += gcnew System::EventHandler(
        this, &window_weather_editor::window_weather_editor_Enter);
