void CPHSimpleCharacter::UpdateStaticDamage(dContact *c, SGameMtl *tri_material,
                                            bool bo1) {
...
void CPHSimpleCharacter::UpdateDynamicDamage(dContact *c, u16 obj_material_idx,
                                             dBodyID b, bool bo1) {
