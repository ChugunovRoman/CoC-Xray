...
CPHActorCharacter::CPHActorCharacter(bool single_game)
  ...
  // =begin(m_restrictors)+0; m_restrictors_index[CPHCharacter::rtMonsterMedium]
...
void SPHCharacterRestrictor::Create(CPHCharacter *ch, dVector3 sizes) {
  ...
  switch (m_type) {
  case rtStalker:
    static_cast<CPHActorCharacter::stalker_restrictor *>(this)->Create(ch,
                                                                       sizes);
    break;
  case rtStalkerSmall:
    static_cast<CPHActorCharacter::stalker_small_restrictor *>(this)->Create(
        ch, sizes);
    break;
  case rtMonsterMedium:
    static_cast<CPHActorCharacter::medium_monster_restrictor *>(this)->Create(
        ch, sizes);
    break;
  default:
    NODEFAULT;
...
void CPHActorCharacter::InitContact(dContact *c, bool &do_collide,
