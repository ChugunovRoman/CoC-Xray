...
IC void SetJointLimit(CPhysicsJoint &J, const IBoneData &bone_data,
                      u8 limit_num, u8 axis_num) {
...
IC void SetJointRLimit(CPhysicsJoint &J, const IBoneData &bone_data,
                       u8 limit_num, u8 axis_num) {
...
IC CPhysicsJoint *CtreateHinge(const IBoneData &bone_data, u8 limit_num,
...
IC CPhysicsJoint *CtreateFullControl(const IBoneData &bone_data,
                                     u8 limit_num[3], CPhysicsElement *root_e,
                                     CPhysicsElement *E) {
