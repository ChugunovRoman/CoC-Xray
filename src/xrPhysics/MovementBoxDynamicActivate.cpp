...
template <class Pars>
void TTestDepthCallback(bool &do_colide, bool bo1, dContact &c,
  ...
  virtual void PhDataUpdate(dReal step) {
    ...
    for (int i = 0; i < num; i++) {
      ...
      if (dJointGetType(joint) == dJointTypeContact) {
        ...
        save_max(m_max_force_self_sd, _sqrt(self_force[0] * self_force[0] +
...
/////////////////////////////////////////////////////////////////////////////////////
bool ActivateBoxDynamic(IPHMovementControl *mov_control, bool character_exist,
  ...
  // const Fbox& box =Box();
  float pass = character_exist ? _abs(mov_control->Box().getradius() -
  ...
  mov_control->actor_calculate(Fvector().set(0, 0, 0), Fvector().set(1, 0, 0),
                               0, 0, 0, 0);
