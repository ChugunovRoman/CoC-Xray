...
/////////////////////////////////////////////////////////////////////////////
IC void add_contact_body_effector(dBodyID body, const dContact &c,
                                  SGameMtl *material) {
...
IC static int CollideIntoGroup(dGeomID o1, dGeomID o2, dJointGroupID jointGroup,
                               CPHIsland *world, const int &MAX_CONTACTS) {
  const int RS = 800 + 10;
  const int N = RS;
  ...
  for (i = 0; i < n; ++i) {
    ...
    if (usr_data_2 && usr_data_2->object_callbacks) {
      usr_data_2->object_callbacks->Call(do_collide, false, c, material_1,
                                         material_2);
    }
    ...
    if (usr_data_2) {
      ...
      if (usr_data_2->ph_object) {
        usr_data_2->ph_object->InitContact(&c, do_collide, material_idx_1,
                                           material_idx_2);
      }
    }
    ///////////////////////////////////////////////////////////////////////////////////////
    if (usr_data_1) {
      ...
      if (usr_data_1->ph_object) {
        usr_data_1->ph_object->InitContact(&c, do_collide, material_idx_1,
                                           material_idx_2);
      }
    }
