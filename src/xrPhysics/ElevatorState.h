...
private:
  ...
  static SEnertionState m_etable[CElevatorState::clbNoState]
                                [CElevatorState::clbNoState];
...
private:
  ...
  void InitContact(dContact *c, bool &do_collide, u16 /*material_idx_1*/,
                   u16 /*material_2*/);
  ...
  void UpdateClimbingCommon(const Fvector &d_to_ax, float to_ax,
