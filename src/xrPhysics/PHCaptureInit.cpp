...
CPHCapture::CPHCapture(CPHCharacter *a_character,
    ...
    : m_joint(NULL), m_ajoint(NULL), m_body(NULL),
      ...
      // dJointFeedback		m_joint_feedback;
      // ,
      m_capture_pos(Fvector().set(0, 0, 0)), m_back_force(0), m_pull_force(0),
      m_capture_force(0), m_capture_distance(0), m_capture_time(0),
      m_time_start(0), m_capture_bone(0),
      // CPHIsland			m_island;
      b_collide(false)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
CPHCapture::CPHCapture(CPHCharacter *a_character,
                       IPhysicsShellHolder *a_taget_object, u16 a_taget_element)
    : m_joint(NULL), m_ajoint(NULL), m_body(NULL), b_disabled(false),
      b_character_feedback(false), m_taget_object(a_taget_object),
      m_character(a_character), e_state(cstFree),
