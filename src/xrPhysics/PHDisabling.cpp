...
SDisableUpdateState &
SDisableUpdateState::operator&=(SDisableUpdateState &lstate) {
...
void CPHDisablingTranslational::UpdateL1() {
  ...
  // .Update(* (Fvector*) position)		; float acceleration_param
  // =	m_mean_acceleration	.Update(* (Fvector*) velocity)		;
...
void CPHDisablingRotational::UpdateL1() {
  ...
  // float			velocity_param		=	m_mean_velocity		.Update
  // ( vrotation	)	; float			acceleration_param
  // = m_mean_acceleration	.Update	(* (Fvector*) velocity	)	;
