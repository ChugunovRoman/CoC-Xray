...
class CPHCollideValidator {
  ...
  enum ETypeFlags {
    ...
    cbNCClassAnimated = 1 << 11, //свойство игнорирования класса анимированного
                                 //физического объекта
    cbNone = 1 << 12
...
public:
  ...
  static IC bool DoCollide(const CPHObject &obj1, const CPHObject &obj2) {
    ...
    //;break;
    //	case 0:					return DoCollideNonMatched
    //(obj1,obj2) ;break; 	default: NODEFAULT; #ifdef DEBUG 	return
    //false; #endif // DEBUG
    return (CollideType(obj1.collide_class_bits().flags,
                        obj2.collide_class_bits().flags) != cbNCGroupObject ||
