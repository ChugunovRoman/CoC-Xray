...
static void ActivateTestDepthCallback(bool &do_colide, bool bo1, dContact &c,
                                      SGameMtl *material_1,
                                      SGameMtl *material_2) {
  ...
  /*
     ...
     dGeomGetBody(c.geom.g2)); do_colide = false; return;
          ...
          dxGeomUserData* data_oposite =  retrieveGeomUserData( bo1 ? c.geom.g2
     : c.geom.g1 );
...
void StaticEnvironment(bool &do_colide, bool bo1, dContact &c,
...
void GetMaxDepthCallback(bool &do_colide, bool bo1, dContact &c,
                         SGameMtl *material_1, SGameMtl *material_2) {
...
bool CPHActivationShape::Activate(const Fvector need_size, u16 steps,
                                  float max_displacement, float max_rotation,
