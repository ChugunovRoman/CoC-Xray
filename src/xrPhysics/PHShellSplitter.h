    ...
    : public CPHUpdateObject // call all Fractures and Breakable Joints Updates
{
  ...
  virtual void PhTune(
      dReal
          step); // call fractures PhTune for element splitters
  ...
  shell_root SplitJoint(
      u16 aspl); // create new shell moving into it departed elements and joints
  ...
  void PassEndSplitters(const CShellSplitInfo &spl_inf, CPHShell *dest,
