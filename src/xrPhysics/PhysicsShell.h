...
extern XRPHYSICS_API void get_box(const CPhysicsBase *shell,
                                  const Fmatrix &form, Fvector &sz, Fvector &c);
...
public:
  ...
  virtual void Activate(const Fmatrix &transform, const Fvector &lin_vel,
                        const Fvector &ang_vel, bool disable = false) = 0;
  ...
  virtual void get_Extensions(const Fvector &axis, float center_prg,
                              float &lo_ext, float &hi_ext) const = 0;
  ...
  virtual void
  set_ObjectContactCallback(ObjectContactCallbackFun *callback) = 0;
  virtual void SetAnimated(bool v) = 0;
  virtual void
  add_ObjectContactCallback(ObjectContactCallbackFun *callback) = 0;
  virtual void
  remove_ObjectContactCallback(ObjectContactCallbackFun *callback) = 0;
...
public:
  ...
  virtual void applyImpulseVsMC(const Fvector &pos, const Fvector &dir,
                                float val) = 0;
  virtual void applyImpulseVsGF(const Fvector &pos, const Fvector &dir,
                                float val) = 0;
  virtual void applyImpulseTrace(const Fvector &pos, const Fvector &dir,
                                 float val, const u16 id) = 0;
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // virtual		void		_BCL
  // CalculateBoneTransform ( Fmatrix &bone_transform )const = 0;
  virtual void GetPointVel(Fvector &res_vel, const Fvector &point) const = 0;
  //	virtual			void
  //get_LinearVel ( Fvector& velocity )		const { get_LinearVel( velocity
  //); } 	virtual			void get_AngularVel
  // ( Fvector& velocity )		const { get_AngularVel( velocity ); }
  virtual void get_Box(Fvector &sz, Fvector &c) const {
...
XRPHYSICS_API float
NonElasticCollisionEnergy(CPhysicsElement *e1, CPhysicsElement *e2,
...
public:
  ...
  virtual void SetAxisSDfactors(float spring_factor, float damping_factor,
                                int axis_num) = 0;
  ...
  virtual void SetAnchorVsFirstElement(const float x, const float y,
                                       const float z) = 0;
  virtual void SetAnchorVsSecondElement(const float x, const float y,
                                        const float z) = 0;
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  virtual void SetAxisDir(const float x, const float y, const float z,
                          const int axis_num) = 0;
  virtual void SetAxisDirVsFirstElement(const float x, const float y,
                                        const float z, const int axis_num) = 0;
  virtual void SetAxisDirVsSecondElement(const float x, const float y,
                                         const float z, const int axis_num) = 0;

  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  virtual void SetLimits(const float low, const float high,
                         const int axis_num) = 0;
  virtual void SetLimitsVsFirstElement(const float low, const float high,
                                       const int axis_num) = 0;
  ...
  virtual void GetMaxForceAndVelocity(float &force, float &velocity,
                                      int axis_num) = 0;
  virtual float GetAxisAngle(int axis_num) = 0;
  virtual float GetAxisAngleRate(int axis_num) = 0;
  //	virtual		dJointID				GetDJoint
  //() =0;
  virtual void GetAxisSDfactors(float &spring_factor, float &damping_factor,
                                int axis_num) = 0;
...
public:
  ...
  virtual void applyImpulseTrace(const Fvector &pos, const Fvector &dir,
                                 float val, const u16 id) = 0;
  virtual void applyHit(const Fvector &pos, const Fvector &dir, float val,
                        const u16 id, ALife::EHitType hit_type) = 0;
...
struct dContact;
struct SGameMtl;
XRPHYSICS_API void StaticEnvironmentCB(bool &do_colide, bool bo1, dContact &c,
                                       SGameMtl *material_1,
                                       SGameMtl *material_2);
...
extern "C" XRPHYSICS_API CPhysicsShell *__stdcall P_build_Shell(
    IPhysicsShellHolder *obj, bool not_active_state, BONE_P_MAP *bone_map = 0,
...
extern "C" XRPHYSICS_API bool __stdcall can_create_phys_shell(
    string1024 &reason, IPhysicsShellHolder &O);
