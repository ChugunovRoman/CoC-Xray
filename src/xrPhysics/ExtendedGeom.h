...
public:
  ...
  void Call(bool &do_colide, bool bo1, dContact &c, SGameMtl *material_1,
            SGameMtl *material_2) {
    for (CObjectContactCallback *i = this; i; i = i->next) {
      VERIFY(i->callback);
...
XRPHYSICS_API void get_user_data(dxGeomUserData *&gd1, dxGeomUserData *&gd2,
                                 bool bo1, const dContactGeom &geom);
...
IC void
dGeomUserDataSetObjectContactCallback(dxGeom *geom,
...
IC void
dGeomUserDataAddObjectContactCallback(dxGeom *geom,
                                      ObjectContactCallbackFun *obj_callback) {
...
IC void dGeomUserDataRemoveObjectContactCallback(
    dxGeom *geom, ObjectContactCallbackFun *obj_callback) {
