...
//); 				void
// DBG_ObjAfterStep			( CPHObject *obj );
// void DBG_ObjBeforeStep			( CPHObject *obj );
// void
// DBG_ObjeAfterPhTune		( CPHObject *obj ); 				void
// DBG_ObjBeforePhTune
//( CPHObject *obj ); 				void DBG_ObjAfterCollision
//( CPHObject *obj
//); 				void DBG_ObjBeforeCollision		( CPHObject
//*obj );
#endif
//////////////////////////////////////////////////////////////
//////////////CPHMesh///////////////////////////////////////////
...
CObjectSpace *__stdcall mesh_create_object_space(
    Fvector *verts, CDB::TRI *tris, const hdrCFORM &H,
...
CPHWorld::CPHWorld()
    : // IPHWorldUpdateCallbck		*_update_callback
      m_update_callback(&empty_update_callback), m_default_contact_shotmark(0),
...
#endif
  dJointGroupEmpty(ContactGroup); // this is to be called after
                                  // PhDataUpdate!!!-the order is critical!!!
