...
int dCollideRMB(dxGeom *o1, dxGeom *o2, int flags, dContactGeom *contact,
                int skip) {
...
int dCollideRMS(dxGeom *o1, dxGeom *o2, int flags, dContactGeom *contact,
                int skip) {
  dxRayMotions *rm = (dxRayMotions *)dGeomGetClassData(o1);
...
int dCollideRMCyl(dxGeom *o1, dxGeom *o2, int flags, dContactGeom *contact,
                  int skip) {
  dxRayMotions *rm = (dxRayMotions *)dGeomGetClassData(o1);
