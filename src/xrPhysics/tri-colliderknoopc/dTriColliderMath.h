...
inline bool TriContainPoint(const dReal *v0, const dReal *v1, const dReal *v2,
                            ...
                            const dReal *triSideAx1, const dReal *pos) {
...
inline bool TriPlaneContainPoint(const dReal *v0, const dReal *v1,
                                 const dReal *v2, const dReal *pos) {
...
inline bool TriPlaneContainPoint(const dReal *triAx, const dReal *v0,
                                 const dReal *pos) {
...
inline void PlanePoint(const Triangle &tri, const dReal *from, const dReal *to,
                       float from_dist, dReal *point) {
