...
public:
  ...
  int CollideSphere(dxGeom *Sphere, int Flags, dContactGeom *Contact,
                    int Stride);
  int CollideCylinder(dxGeom *Cylinder, int Flags, dContactGeom *Contacts,
                      int Stride);
...
private:
  ...
  template <class T>
  IC int dSortTriPrimitiveCollide(T primitive, dxGeom *o1, dxGeom *o2,
  ...
  int dSortedTriSphere(const dReal * /**v1/**/, const dReal * /**v2/**/,
                       const dReal *triAx, CDB::TRI *T, dReal dist,
  ...
  int dTriSphere(const dReal *v0, const dReal *v1, const dReal *v2, Triangle *T,
                 dxGeom *Sphere, dxGeom *Geometry, int Flags,
                 dContactGeom *Contacts, int /**skip/**/);
  IC float dBoxProj(dxGeom *box, const dReal *normal);
  IC void CrossProjLine(const dReal *pt1, const dReal *vc1, const dReal *pt2,
                        const dReal *vc2, dReal *proj);
  IC void CrossProjLine1(const dReal *pt1, const dReal *vc1, const dReal *pt2,
                         const dReal *vc2, dReal *proj);
  IC bool CrossProjLine14(const dReal *pt1, const dReal *vc1, const dReal *pt2,
                          const dReal *vc2, dReal hside, dReal *proj);
  IC bool IsPtInBx(const dReal *Pt, const dReal *BxP, const dReal *BxEx,
                   const dReal *BxR);
  IC dReal FragmentonBoxTest(const dReal *Pt1, const dReal *Pt2,
                             const dReal *BxP, const dReal *BxEx,
                             const dReal *R, dReal *norm, dReal *pos);
  int dSortedTriBox(const dReal *triSideAx0, const dReal *triSideAx1,
                    const dReal *triAx,
                    // const dReal* v0,
                    // const dReal* v1,
                    // const dReal* v2,
  ...
  int dTriBox(const dReal *v0, const dReal *v1, const dReal *v2, Triangle *T,
              dxGeom *o1, dxGeom *o2, int flags, dContactGeom *contact,
              int skip);
  IC bool circleLineIntersection(const dReal *cn, const dReal *cp, dReal r,
                                 const dReal *lv, const dReal *lp, dReal sign,
                                 dVector3 point);
  IC float dCylProj(dxGeom *cylinder, const dReal *normal);
  int dSortedTriCyl(const dReal *triSideAx0, const dReal *triSideAx1,
                    const dReal *triAx,
                    // const dReal* v0,
                    // const dReal* v1,
                    // const dReal* v2,
                    CDB::TRI *T, dReal dist, dxGeom *o1, dxGeom *o2, int flags,
                    dContactGeom *contact, int skip);
  int dTriCyl(const dReal *v0, const dReal *v1, const dReal *v2, Triangle *T,
              dxGeom *o1, dxGeom *o2, int flags, dContactGeom *contact,
              int skip);
  ...
  IC int Collide(const dReal *v0, const dReal *v1, const dReal *v2, Triangle *T,
                 dxGeom *o1, dxGeom *o2, int flags, dContactGeom *contact,
                 int skip);
  IC int CollidePlain(const dReal *triSideAx0, const dReal *triSideAx1,
...
IC void dcTriListCollider::SideToGlClTriState(u32 v0, u32 v1,
                                              CDB::TRI *T_array) {
