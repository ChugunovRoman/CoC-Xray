...
void CBlender_accum_spot::Compile(CBlender_Compile &C) {
  ...
  case SE_L_UNSHADOWED: // unshadowed
    C.r_Pass("accum_volume", "accum_spot_unshadowed_nomsaa", false, FALSE,
  ...
  case SE_L_NORMAL: // normal
    C.r_Pass("accum_volume", "accum_spot_normal_nomsaa", false, FALSE, FALSE,
    ...
    // if
    //(b_HW_PCF)	C.r_Sampler_clf		("s_smap",r2_RT_smap_depth
  ...
  case SE_L_FULLSIZE: // normal-fullsize
    C.r_Pass("accum_volume", "accum_spot_fullsize_nomsaa", false, FALSE, FALSE,
             blend, D3DBLEND_ONE, dest);
    // C.r_Sampler_rtf		("s_position",		r2_RT_P);
    // C.r_Sampler_rtf		("s_normal",		r2_RT_N);
    // C.r_Sampler_clw		("s_material",		r2_material);
  ...
  case SE_L_TRANSLUENT: // shadowed + transluency
    ...
    // diff here if (b_HW_smap)		{ 	if (b_HW_PCF)	C.r_Sampler_clf
...
void CBlender_accum_spot_msaa::Compile(CBlender_Compile &C) {
  ...
  case SE_L_FILL: // masking
    ...
    break;
  case SE_L_UNSHADOWED: // unshadowed
    C.r_Pass("accum_volume", "accum_spot_unshadowed_msaa", false, FALSE, FALSE,
             blend, D3DBLEND_ONE, dest);
    // C.r_Sampler_rtf		("s_position",		r2_RT_P);
    // C.r_Sampler_rtf		("s_normal",		r2_RT_N);
    // C.r_Sampler_clw		("s_material",		r2_material);
    ...
    break;
  case SE_L_NORMAL: // normal
    C.r_Pass("accum_volume", "accum_spot_normal_msaa", false, FALSE, FALSE,
             blend, D3DBLEND_ONE, dest);
    // C.r_Sampler_rtf		("s_position",		r2_RT_P);
    // C.r_Sampler_rtf		("s_normal",		r2_RT_N);
    // C.r_Sampler_clw		("s_material",		r2_material);
    ...
    break;
  case SE_L_FULLSIZE: // normal-fullsize
    C.r_Pass("accum_volume", "accum_spot_fullsize_msaa", false, FALSE, FALSE,
             blend, D3DBLEND_ONE, dest);
    // C.r_Sampler_rtf		("s_position",		r2_RT_P);
    // C.r_Sampler_rtf		("s_normal",		r2_RT_N);
    // C.r_Sampler_clw		("s_material",		r2_material);
