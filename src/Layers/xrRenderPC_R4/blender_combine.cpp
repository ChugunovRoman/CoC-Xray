...
void CBlender_combine::Compile(CBlender_Compile &C) {
  ...
  switch (C.iElement) {
  case 0: // combine
    C.r_Pass("combine_1", "combine_1_nomsaa", FALSE, FALSE, FALSE, TRUE,
             D3DBLEND_INVSRCALPHA, D3DBLEND_SRCALPHA); //. MRT-blend?
    ...
    // ("s_tonemap",		r2_RT_luminance_cur	); C.r_Sampler_clw
    // ("s_material",		r2_material			);
