...
void CRenderTarget::accum_spot(light *L) {
  ...
  // *****************************	Minimize overdraw
  // ************************************* Select shader (front or back-faces),
  // *** back, if intersect near plane
  ...
  // dwLightMarkerID
  // +=	2;	// keep lowest bit always setted up
...
void CRenderTarget::accum_volumetric(light *L) {
  ...
  */
  ...
  // Draw volume with projective texgen
  {
    ...
    SE_L_TRANSLUENT; else if		(bFullSize)	_id	= SE_L_FULLSIZE;
    ...
    */
    ...
    //	Increase camera-space aabb z size to compensate decrease of slices
    // number
