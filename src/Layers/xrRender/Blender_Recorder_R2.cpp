...
void CBlender_Compile::r_Pass(LPCSTR _vs, LPCSTR _ps, bool bFog, BOOL bZtest,
                              BOOL bZwrite, BOOL bABlend, D3DBLEND abSRC,
...
u32 CBlender_Compile::r_Sampler(LPCSTR _name, LPCSTR texture,
                                bool b_ps1x_ProjectiveDivide, u32 address,
  ...
  if (u32(-1) != dwStage) {
    ...
    if (0 == xr_strcmp(_name, "s_base_hud")) {
      fmin = D3DTEXF_GAUSSIANQUAD; // D3DTEXF_PYRAMIDALQUAD;
                                   // //D3DTEXF_ANISOTROPIC; //D3DTEXF_LINEAR;
                                   // //D3DTEXF_POINT; //D3DTEXF_NONE
      fmag = D3DTEXF_GAUSSIANQUAD; // D3DTEXF_PYRAMIDALQUAD;
                                   // //D3DTEXF_ANISOTROPIC; //D3DTEXF_LINEAR;
                                   // //D3DTEXF_POINT; //D3DTEXF_NONE;
    }
...
void CBlender_Compile::r_Sampler_rtf(LPCSTR name, LPCSTR texture,
...
void CBlender_Compile::r_Sampler_clf(LPCSTR name, LPCSTR texture,
                                     bool b_ps1x_ProjectiveDivide) {
  r_Sampler(name, texture, b_ps1x_ProjectiveDivide, D3DTADDRESS_CLAMP,
            D3DTEXF_LINEAR, D3DTEXF_NONE, D3DTEXF_LINEAR);
}
void CBlender_Compile::r_Sampler_clw(LPCSTR name, LPCSTR texture,
                                     bool b_ps1x_ProjectiveDivide) {
  u32 s = r_Sampler(name, texture, b_ps1x_ProjectiveDivide, D3DTADDRESS_CLAMP,
                    D3DTEXF_LINEAR, D3DTEXF_NONE, D3DTEXF_LINEAR);
  if (u32(-1) != s)
