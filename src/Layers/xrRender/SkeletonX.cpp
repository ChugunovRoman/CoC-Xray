...
void CSkeletonX::_Render_soft(ref_geom &hGeom, u32 vCount, u32 iOffset,
                              u32 pCount) {
...
BOOL CSkeletonX::_PickBoneSoft1W(IKinematics::pick_result &r, float dist,
...
BOOL CSkeletonX::_PickBoneSoft2W(IKinematics::pick_result &r, float dist,
                                 const Fvector &S, const Fvector &D,
                                 u16 *indices, CBoneData::FacesVec &faces) {
...
BOOL CSkeletonX::_PickBoneSoft3W(IKinematics::pick_result &r, float dist,
                                 const Fvector &S, const Fvector &D,
                                 u16 *indices, CBoneData::FacesVec &faces) {
...
BOOL CSkeletonX::_PickBoneSoft4W(IKinematics::pick_result &r, float dist,
                                 const Fvector &S, const Fvector &D,
                                 u16 *indices, CBoneData::FacesVec &faces) {
...
void CSkeletonX::_FillVerticesSoft3W(const Fmatrix &view, CSkeletonWallmark &wm,
                                     const Fvector &normal, float size,
                                     u16 *indices, CBoneData::FacesVec &faces) {
  VERIFY(*Vertices3W);
  for (CBoneData::FacesVecIt it = faces.begin(); it != faces.end(); ++it) {
...
void CSkeletonX::_FillVerticesSoft4W(const Fmatrix &view, CSkeletonWallmark &wm,
                                     const Fvector &normal, float size,
                                     u16 *indices, CBoneData::FacesVec &faces) {
  VERIFY(*Vertices4W);
  for (CBoneData::FacesVecIt it = faces.begin(); it != faces.end(); ++it) {
