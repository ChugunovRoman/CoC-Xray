...
#if defined(USE_DX10) || defined(USE_DX11)
  IC void get_ConstantDirect(shared_str &n, u32 DataSize, void **pVData,
...
public:
  ...
  IC void set_Stencil(u32 _enable, u32 _func = D3DCMP_ALWAYS, u32 _ref = 0x00,
                      u32 _mask = 0x00, u32 _writemask = 0x00,
  ...
  ICF void Render(D3DPRIMITIVETYPE T, u32 baseV, u32 startV, u32 countV,
                  u32 startI, u32 PC);
  ICF void Render(D3DPRIMITIVETYPE T, u32 startV, u32 PC);

#ifdef USE_DX11
  ICF void Compute(UINT ThreadGroupCountX, UINT ThreadGroupCountY,
  ...
  void dbg_DIP(D3DPRIMITIVETYPE pt, ref_geom geom, u32 baseV, u32 startV,
...
#endif //	USE_DX10
#ifdef DEBUG
  void dbg_Draw(D3DPRIMITIVETYPE T, FVF::L *pVerts, int vcnt, u16 *pIdx,
                int pcnt);
