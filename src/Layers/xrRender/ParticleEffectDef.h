...
typedef BOOL (*CollisionCallback)(
    CParticleEffect *E, PAPI::Particle &P, const Fvector &pt,
...
public:
  ...
  void ExecuteCollision(PAPI::Particle *particles, u32 p_cnt, float dt,
...
public:
  ...
  void __stdcall OnActionEditClick(ButtonValue *sender, bool &bDataModified,
                                   bool &bSafe);
  ...
  void __stdcall OnControlClick(ButtonValue *sender, bool &bDataModified,
                                bool &bSafe);
  void __stdcall OnActionsClick(ButtonValue *sender, bool &bDataModified,
                                bool &bSafe);
