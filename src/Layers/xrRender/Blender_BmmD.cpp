...
void CBlender_BmmD::Compile(CBlender_Compile &C) {
  ...
  if (C.bEditor) {
    ...
    case SE_R1_LPOINT:
      ...
      break;
    case SE_R1_LSPOT:
      C.r_Pass("impl_spot", "add_spot", FALSE, TRUE, FALSE, TRUE, D3DBLEND_ONE,
               D3DBLEND_ONE, TRUE);
      C.r_Sampler("s_base", C.L_textures[0]);
...
void CBlender_BmmD::Compile(CBlender_Compile &C) {
  ...
  case SE_R2_NORMAL_HQ: // deffer
    uber_deffer(C, true, "impl", "impl", false, oT2_Name[0] ? oT2_Name : 0,
                true);
    C.r_Sampler("s_mask", mask);
    C.r_Sampler("s_lmap", C.L_textures[1]);

    C.r_Sampler("s_dt_r", oR_Name, false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC,
                D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC);
    C.r_Sampler("s_dt_g", oG_Name, false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC,
                D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC);
    C.r_Sampler("s_dt_b", oB_Name, false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC,
                D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC);
    C.r_Sampler("s_dt_a", oA_Name, false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC,
                D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC);
...
void CBlender_BmmD::Compile(CBlender_Compile &C) {
  ...
  case SE_R2_NORMAL_HQ: // deffer
    ...
    // D3DTEXF_ANISOTROPIC);
    // C.r_Sampler		("s_dt_g",	oG_Name,	false,
    // D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,
    // D3DTEXF_ANISOTROPIC);
    // C.r_Sampler		("s_dt_b",	oB_Name,	false,
    // D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,
    // D3DTEXF_ANISOTROPIC);
    // C.r_Sampler		("s_dt_a",	oA_Name,	false,
    // D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,
    // D3DTEXF_ANISOTROPIC);
