...
void uber_deffer(CBlender_Compile &C, bool hq, LPCSTR _vspec, LPCSTR _pspec,
                 BOOL _aref, LPCSTR _detail_replace, bool DO_NOT_FINISH) {
  // Uber-parse
  ...
  // D3DTEXF_ANISOTROPIC); C.r_Sampler		("s_bumpX",		fnameB,
  // false,	D3DTADDRESS_WRAP,	D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR,
  // D3DTEXF_ANISOTROPIC);	// should be before base bump C.r_Sampler
  // ("s_bump",		fnameA,				false,
  // D3DTADDRESS_WRAP,
  ...
  C.r_Sampler("s_base", C.L_textures[0], false, D3DTADDRESS_WRAP,
              D3DTEXF_ANISOTROPIC, D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC);
  C.r_Sampler("s_bumpX", fnameB, false, D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC,
              D3DTEXF_LINEAR,
