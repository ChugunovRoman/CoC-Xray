...
dx10SamplerStateCache::SHandle
dx10SamplerStateCache::GetState(D3D_SAMPLER_DESC &desc) {
  SHandle hResult;
...
dx10SamplerStateCache::SHandle
dx10SamplerStateCache::FindState(const StateDecs &desc, u32 StateCRC) {
  u32 res = 0xffffffff;
...
void dx10SamplerStateCache::PrepareSamplerStates(
    ...
    SHandle pCurrentState[D3D_COMMONSHADER_SAMPLER_SLOT_COUNT], u32 &uiMin,
    u32 &uiMax) const {
