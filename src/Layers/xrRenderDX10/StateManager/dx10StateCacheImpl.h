...
IDeviceState *
dx10StateCache<IDeviceState, StateDecs>::GetState(SimulatorStates &state_code) {
  StateDecs desc;
...
template <class IDeviceState, class StateDecs>
IDeviceState *
dx10StateCache<IDeviceState, StateDecs>::GetState(StateDecs &desc) {
...
template <class IDeviceState, class StateDecs>
IDeviceState *
dx10StateCache<IDeviceState, StateDecs>::FindState(const StateDecs &desc,
                                                   u32 StateCRC) {
  u32 res = 0xffffffff;
