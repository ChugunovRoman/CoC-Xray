...
void dx10ShaderResourceStateCache::SetPSResource(u32 uiSlot,
...
void dx10ShaderResourceStateCache::SetGSResource(u32 uiSlot,
                                                 ID3DShaderResourceView *pRes) {
...
void dx10ShaderResourceStateCache::SetVSResource(u32 uiSlot,
                                                 ID3DShaderResourceView *pRes) {
...
#ifdef USE_DX11
void dx10ShaderResourceStateCache::SetHSResource(u32 uiSlot,
                                                 ID3DShaderResourceView *pRes) {
...
void dx10ShaderResourceStateCache::SetDSResource(u32 uiSlot,
                                                 ID3DShaderResourceView *pRes) {
  VERIFY(uiSlot < CBackend::mtMaxHullShaderTextures);
...
void dx10ShaderResourceStateCache::SetCSResource(u32 uiSlot,
                                                 ID3DShaderResourceView *pRes) {
