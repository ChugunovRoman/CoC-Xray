...
class TClipMaker : public TForm, public pureFrame {
  ...
  void __fastcall ClipDragOver(TObject *Sender, TObject *Source, int X, int Y,
                               TDragState State, bool &Accept);
  void __fastcall ClipDragDrop(TObject *Sender, TObject *Source, int X, int Y);
  ...
  void __fastcall ClipMouseMove(TObject *Sender, TShiftState Shift, int X,
                                int Y);
  void __fastcall ClipMouseUp(TObject *Sender, TMouseButton Button,
                              TShiftState Shift, int X, int Y);
  void __fastcall FormShow(TObject *Sender);
  void __fastcall BPDragOver(TObject *Sender, TObject *Source, int X, int Y,
                             TDragState State, bool &Accept);
  void __fastcall BPDragDrop(TObject *Sender, TObject *Source, int X, int Y);
  ...
  void __fastcall BPEndDrag(TObject *Sender, TObject *Target, int X, int Y);
  void __fastcall BPStartDrag(TObject *Sender, TDragObject *&DragObject);
  void __fastcall ClipStartDrag(TObject *Sender, TDragObject *&DragObject);
  void __fastcall ClipEndDrag(TObject *Sender, TObject *Target, int X, int Y);
...
public:
  ...
  public:
    ...
    AnsiString CycleName(u16 bp) {
      VERIFY(bp < 4);
      return *cycles[bp].name;
    }
    u16 CycleSlot(u16 bp) {
      VERIFY(bp < 4);
      return cycles[bp].slot;
    }
