...
void TfraLeftBar::UpdateBar() {
  ...
  if (ebRenderEngineStyle->Down && !ATools->IsVisualPresent())
...
void __fastcall TfraLeftBar::tvMotionsDragOver(TObject *Sender, TObject *Source,
...
//---------------------------------------------------------------------------
void __fastcall TfraLeftBar::tvMotionsDragDrop(TObject *Sender, TObject *Source,
                                               int X, int Y) {
  FHelper.DragDrop(Sender, Source, X, Y,
                   TOnItemRename(this, &TfraLeftBar::RenameItem));
}
//---------------------------------------------------------------------------
