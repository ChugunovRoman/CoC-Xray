...
public:
  struct SDebugDraw {
    ...
    void AppendLine(const Fvector &p0, const Fvector &p1, u32 c = 0xff00ff00,
                    bool i = true, bool m = true) {
    ...
    void AppendWireFace(const Fvector &p0, const Fvector &p1, const Fvector &p2,
                        u32 c = 0xffff0000, bool i = true, bool m = true) {
    ...
    void AppendSolidFace(const Fvector &p0, const Fvector &p1,
                         const Fvector &p2, u32 c = 0xffff0000, bool i = true,
                         bool m = true) {
