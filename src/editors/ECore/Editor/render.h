...
public:
  ...
  void model_Render(IRenderVisual *m_pVisual, const Fmatrix &mTransform,
                    int priority, bool strictB2F, float m_fLOD);
  void model_RenderSingle(IRenderVisual *m_pVisual, const Fmatrix &mTransform,
                          float m_fLOD);
  ...
  virtual HRESULT CompileShader(LPCSTR pSrcData, UINT SrcDataLen,
