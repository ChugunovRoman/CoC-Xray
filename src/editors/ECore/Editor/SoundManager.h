...
public:
  ...
  void SynchronizeSounds(bool sync_thm, bool sync_game, bool bForceGame,
  ...
  void CreateSoundThumbnail(ESoundThumbnail *THM, const AnsiString &src_name,
                            LPCSTR path = 0, bool bSetDefParam = true);
  void CleanupSounds();
