...
private: // User declarations
  ...
  void LockForm() {
    bFormLocked = true;
    form->paProperties->Enabled = false;
    form->paItems->Enabled = false;
  }
  void UnlockForm() {
    bFormLocked = false;
    form->paProperties->Enabled = true;
  ...
  void __stdcall OnControl2Click(ButtonValue *sender, bool &bModif,
                                 bool &bSafe);
  void __stdcall OnSyncCurrentClick(ButtonValue *sender, bool &bModif,
                                    bool &bSafe);
  void __stdcall OnAttClick(ButtonValue *sender, bool &bModif, bool &bSafe);
  void __stdcall OnAttenuationDraw(CanvasValue *sender, void *_canvas,
                                   const Irect &_rect);
