...
PDomain::PDomain(EType et, BOOL ra, u32 color, PDomainEnum t, float inA0,
                 float inA1, float inA2, float inA3, float inA4, float inA5,
...
/*
void	PDomain::set(PAPI::PDomainEnum t, 		float inA0, float inA1,
float inA2, float inA3, float inA4, float inA5, float inA6, float inA7, float
inA8	)
{
        type 	= t;
        f[0]	= inA0;
...
void PDomain::Render(u32 clr, const Fmatrix &parent) {
  ...
  case PDBlob:
    ...
    break;
  case PDDisc:
    DU_impl.DrawCylinder(parent, v[0], v[1], 0.f, f[6], clr_s, clr_w, true,
                         true);
    DU_impl.DrawCylinder(parent, v[0], v[1], 0.f, f[7], clr_s, clr_w, true,
                         true);
    break;
  case PDRectangle:
...
void PDomain::FillProp(PropItemVec &items, LPCSTR pref, u32 clr) {
  ...
  case vNum:
    switch (type) {
    case PDPoint:
      V = PHelper().CreateVector(items, PrepareKey(pref, "Center"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    case PDLine:
      V = PHelper().CreateVector(items, PrepareKey(pref, "Point 1"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateVector(items, PrepareKey(pref, "Point 2"), &v[1],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    case PDTriangle:
      V = PHelper().CreateVector(items, PrepareKey(pref, "Vertex 1"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateVector(items, PrepareKey(pref, "Vertex 2"), &v[1],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateVector(items, PrepareKey(pref, "Vertex 3"), &v[2],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    case PDPlane:
      V = PHelper().CreateVector(items, PrepareKey(pref, "Origin"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateVector(items, PrepareKey(pref, "Normal"), &v[1],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    case PDBox:
      V = PHelper().CreateVector(items, PrepareKey(pref, "Min"), &v[0], flt_min,
                                 flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateVector(items, PrepareKey(pref, "Max"), &v[1], flt_min,
                                 flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    case PDSphere:
    ...
    case PDCylinder:
      ...
      break;
    case PDCone:
      V = PHelper().CreateVector(items, PrepareKey(pref, "Apex"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateVector(items, PrepareKey(pref, "End Point"), &v[1],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateFloat(items, PrepareKey(pref, "Radius Inner"), &f[6],
                                flt_min, flt_max, 0.001f, 3);
    ...
    case PDRectangle:
      V = PHelper().CreateVector(items, PrepareKey(pref, "Origin"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateVector(items, PrepareKey(pref, "Basis U"), &v[1],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateVector(items, PrepareKey(pref, "Basis V"), &v[2],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    default:
      V = PHelper().CreateVector(items, PrepareKey(pref, "Translate"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateVector(items, PrepareKey(pref, "Rotate"), &v[1],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateVector(items, PrepareKey(pref, "Scale"), &v[2],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    }
  ...
  case vAngle:
    switch (type) {
    case PDPoint:
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Center"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    case PDLine:
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Point 1"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Point 2"), &v[1],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    case PDTriangle:
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Vertex 1"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Vertex 2"), &v[1],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Vertex 3"), &v[2],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    case PDPlane:
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Origin"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Normal"), &v[1],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    case PDBox:
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Min"), &v[0], flt_min,
                                 flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Max"), &v[1], flt_min,
                                 flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    case PDSphere:
    ...
    case PDCylinder:
      ...
      break;
    case PDCone:
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Apex"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "End Point"), &v[1],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateFloat(items, PrepareKey(pref, "Radius Inner"), &f[6],
                                flt_min, flt_max, 0.001f, 3);
    ...
    case PDRectangle:
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Origin"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Basis U"), &v[1],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Basis V"), &v[2],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    default:
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Translate"), &v[0],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Rotate"), &v[1],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      V = PHelper().CreateAngle3(items, PrepareKey(pref, "Scale"), &v[2],
                                 flt_min, flt_max, 0.001f, 3);
      V->Owner()->prop_color = TColor(clr);
      break;
    }
...
//	float	zloc;
        switch(type)
        {
                ...
                case PDTriangle:
                        c = GetCenter();
                        r1 = trans*(v1.set( (float)a0-c.X(), (float)a1-c.Y(),
(float)a2-c.Z() )); r2 = trans*(v2.set( (float)a3-c.X(), (float)a4-c.Y(),
(float)a5-c.Z() )); r3 = trans*(v3.set( (float)a6-c.X(), (float)a7-c.Y(),
(float)a8-c.Z() )); a0 = r1.X()+c.X();	a1 = r1.Y()+c.Y();   a2 = r1.Z()+c.Z();
                        a3 = r2.X()+c.X();	a4 = r2.Y()+c.Y();   a5 =
r2.Z()+c.Z(); a6 = r3.X()+c.X();	a7 = r3.Y()+c.Y();   a8 = r3.Z()+c.Z();
                        break;
                case PDPlane:
//			r2 = trans*(v2.set( a3, a4, a5 ));
...
//			a6 = r3.X();	a7 = r3.Y();	a8 = r3.Z();
                        ...
                        v2.set((float)a0+((float)a3/2.0),
(float)a1+((float)a4/2.0), (float)a2+((float)a5/2.0));
                        v3.set((float)a0+((float)a6/2.0),
(float)a1+((float)a7/2.0), (float)a2+((float)a8/2.0));

                        r1 = trans*v1;
                        r2 = trans*v2;
                        r3 = trans*v3;

                        a0 = r1.X()+c.X();	a1 = r1.Y()+c.Y();   a2 =
r1.Z()+c.Z();
...
); break; case PDPlane: v1.set(a0, a1, a2); v2.set(a0+(a3/2.0f), a1+(a4/2.0f),
a2+(a5/2.0f)); v3.set(a0+(a6/2.0f), a1+(a7/2.0f), a2+(a8/2.0f));
                        v4.set(a0+(a6/2.0f)+(a3/2.0f), a1+(a7/2.0f)+(a4/2.0f),
a2+(a8/2.0f)+(a5/2.0f)); center.set(	(v1.X()+v2.X()+v3.X()+v4.X())/4.0,
                                                (v1.Y()+v2.Y()+v3.Y()+v4.Y())/4.0,
                                                (v1.Z()+v2.Z()+v3.Z()+v4.Z())/4.0
); break; case PDBox: break; case PDSphere: break; case PDCylinder: break; case
PDCone: break; case PDBlob: break; case PDDisc: center.set(a0, a1, a2); break;
        }
        return center;
}
*/
