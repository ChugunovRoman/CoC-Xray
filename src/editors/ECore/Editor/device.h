...
public:
  ...
  IC void SetHandle(HWND main_hwnd, HWND render_hwnd) {
    m_hWnd = main_hwnd;
    m_hRenderWnd = render_hwnd;
  }
  ...
  // CRegistrator <pureAppStart> seqAppStart; CRegistrator <pureAppEnd>
  // seqAppEnd; CRegistrator <pureAppActivate	>
  // seqAppActivate; CRegistrator <pureAppDeactivate	>
  // seqAppDeactivate;
public:
  CEditorRenderDevice();
  ...
  void DIP(D3DPRIMITIVETYPE pt, ref_geom geom, u32 baseV, u32 startV,
