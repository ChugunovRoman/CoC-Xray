...
public:
  PDomain() {}
  PDomain(EType et, BOOL renderable, u32 color = 0x00000000,
          PAPI::PDomainEnum type = PAPI::PDPoint, float inA0 = 0.0f,
          float inA1 = 0.0f, float inA2 = 0.0f, float inA3 = 0.0f,
          float inA4 = 0.0f, float inA5 = 0.0f, float inA6 = 0.0f,
          float inA7 = 0.0f, float inA8 = 0.0f);
  ~PDomain();
...
public:
  ...
  void appendVector(LPCSTR name, PVector::EType type, float vx, float vy,
                    float vz, float mn = -P_MAXFLOAT, float mx = P_MAXFLOAT);
...
/*
         ...
         void pTargetVelocityD(float scale, PDomainEnum dtype,
                ...
                float a6 = 0.0f, float a7 = 0.0f, float a8 = 0.0f, BOOL
