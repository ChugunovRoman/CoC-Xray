...
*/
nv_scalar det3x3(nv_scalar a1, nv_scalar a2, nv_scalar a3, nv_scalar b1,
                 nv_scalar b2, nv_scalar b3, nv_scalar c1, nv_scalar c2,
                 nv_scalar c3) {
...
mat4 &perspective(mat4 &M, const nv_scalar fovy, const nv_scalar aspect,
...
mat3 &tangent_basis(mat3 &basis, const vec3 &v0, const vec3 &v1, const vec3 &v2,
  ...
  // tangent...
  nv_scalar oonorm =
      nv_one / _sqrt(basis.a00 * basis.a00 + basis.a01 * basis.a01 +
                     basis.a02 * basis.a02);
  basis.a00 *= oonorm;
  basis.a01 *= oonorm;
  basis.a02 *= oonorm;
  ...
  // binormal...
  oonorm = nv_one / _sqrt(basis.a10 * basis.a10 + basis.a11 * basis.a11 +
                          basis.a12 * basis.a12);
  basis.a10 *= oonorm;
  basis.a11 *= oonorm;
  basis.a12 *= oonorm;
  ...
  oonorm = nv_one / _sqrt(basis.a20 * basis.a20 + basis.a21 * basis.a21 +
                          basis.a22 * basis.a22);
  basis.a20 *= oonorm;
  basis.a21 *= oonorm;
  basis.a22 *= oonorm;
...
nv_scalar nv_find_circ_circle(vec3 &center, const vec3 &v1, const vec3 &v2,
                              const vec3 &v3) {
  vec3 e0;
  vec3 e1;
  nv_scalar d1, d2, d3;
