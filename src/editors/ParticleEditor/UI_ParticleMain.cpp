...
CParticleMain::CParticleMain() { EPrefs = xr_new<CCustomPreferences>(); }
//---------------------------------------------------------------------------

CParticleMain::~CParticleMain() { xr_delete(EPrefs); }
//---------------------------------------------------------------------------

CCommandVar CParticleTool::CommandSelectPreviewObj(CCommandVar p1,
                                                   CCommandVar p2) {
  SelectPreviewObject(p1);
  return TRUE;
}
CCommandVar CParticleTool::CommandEditPreviewProps(CCommandVar p1,
                                                   CCommandVar p2) {
  EditPreviewPrefs();
  return TRUE;
}
...
void CParticleMain::RegisterCommands() {
  ...
  // tools
  REGISTER_CMD_CE(COMMAND_SELECT_PREVIEW_OBJ, "Select Preview Object", PTools,
                  CParticleTool::CommandSelectPreviewObj, true);
  REGISTER_CMD_CE(COMMAND_EDIT_PREVIEW_PROPS, "Select Preview Props", PTools,
                  CParticleTool::CommandEditPreviewProps, true);
  REGISTER_CMD_CE(COMMAND_SAVE, "File\\Save", PTools,
                  CParticleTool::CommandSave, true);
  REGISTER_CMD_C(COMMAND_SAVE_BACKUP, PTools, CParticleTool::CommandSaveBackup);
  REGISTER_CMD_CE(COMMAND_LOAD, "File\\Reload", PTools,
                  CParticleTool::CommandReload, true);
  REGISTER_CMD_C(COMMAND_VALIDATE, PTools, CParticleTool::CommandValidate);
  REGISTER_CMD_CE(COMMAND_CLEAR, "File\\Clear", PTools,
                  CParticleTool::CommandClear, true);
  REGISTER_CMD_CE(COMMAND_PLAY_CURRENT, "Particles\\Play", PTools,
                  CParticleTool::CommandPlayCurrent, true);
  REGISTER_SUB_CMD_CE(COMMAND_STOP_CURRENT, "Particles", PTools,
                      CParticleTool::CommandStopCurrent, true);
  ...
  REGISTER_CMD_CE(COMMAND_CREATE_GROUP_FROM_SELECTED,
                  "Particles\\CreateGroupFromEffect", PTools,
...
bool __fastcall CParticleMain::ApplyGlobalShortCut(WORD Key,
                                                   TShiftState Shift) {
