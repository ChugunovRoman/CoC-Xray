...
class TfraLeftBar : public TFrame {
  ...
  void __fastcall ebSceneCommandsMouseDown(TObject *Sender, TMouseButton Button,
                                           TShiftState Shift, int X, int Y);
  void __fastcall PreviewClick(TObject *Sender);
  void __fastcall ebParticleCloneClick(TObject *Sender);
  void __fastcall ebImageCommandsMouseDown(TObject *Sender, TMouseButton Button,
                                           TShiftState Shift, int X, int Y);
  ...
  void __fastcall ebFileMouseDown(TObject *Sender, TMouseButton Button,
                                  TShiftState Shift, int X, int Y);
  ...
  void __fastcall ebSoundCommandsMouseDown(TObject *Sender, TMouseButton Button,
                                           TShiftState Shift, int X, int Y);
