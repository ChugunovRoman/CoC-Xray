...
CShaderMain::CShaderMain() { EPrefs = xr_new<CCustomPreferences>(); }
//---------------------------------------------------------------------------
...
void CShaderMain::RegisterCommands() {
  ...
  // tools
  REGISTER_CMD_CE(COMMAND_SAVE, "File\\Save", STools, CShaderTool::CommandSave,
                  true);
  REGISTER_CMD_C(COMMAND_SAVE_BACKUP, STools, CShaderTool::CommandSaveBackup);
  REGISTER_CMD_CE(COMMAND_LOAD, "File\\Reload", STools,
                  CShaderTool::CommandReload, true);
  REGISTER_CMD_CE(COMMAND_CLEAR, "File\\Clear", STools,
                  CShaderTool::CommandClear, true);
  REGISTER_CMD_CE(COMMAND_UPDATE_LIST, "Update List", STools,
                  CShaderTool::CommandUpdateList, true);
