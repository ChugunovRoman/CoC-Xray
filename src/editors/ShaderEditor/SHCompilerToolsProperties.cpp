...
void CSHCompilerTools::RealUpdateProperties() {
  ...
  if (m_Shader) {
    ...
    PHelper().CreateFlag32(items, "Flags\\Collision", &L.m_Flags,
                           Shader_xrLC::flCollision);
    PHelper().CreateFlag32(items, "Flags\\Rendering", &L.m_Flags,
                           Shader_xrLC::flRendering);
    PHelper().CreateFlag32(items, "Flags\\OptimizeUV", &L.m_Flags,
                           Shader_xrLC::flOptimizeUV);
    PHelper().CreateFlag32(items, "Flags\\Vertex light", &L.m_Flags,
                           Shader_xrLC::flLIGHT_Vertex);
    PHelper().CreateFlag32(items, "Flags\\Cast shadow", &L.m_Flags,
                           Shader_xrLC::flLIGHT_CastShadow);
    //.		PHelper().CreateFlag32	(items, "Flags\\Sharp",
    //&L.m_Flags, Shader_xrLC::flLIGHT_Sharp);
  }
