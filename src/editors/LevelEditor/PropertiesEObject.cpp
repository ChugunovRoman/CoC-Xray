...
TfrmPropertiesEObject *
TfrmPropertiesEObject::CreateProperties(TWinControl *parent, TAlign align,
  ...
  props->m_BasicProp = TProperties::CreateForm("", props->paBasic, alClient,
                                               props->OnModifiedEvent);
  props->m_SurfProp = TProperties::CreateForm(
      "", props->paSurfaces, alClient, props->OnModifiedEvent,
...
void TfrmPropertiesEObject::UpdateProperties(xr_vector<CSceneObject *> Ss,
                                             bool bReadOnly) {
