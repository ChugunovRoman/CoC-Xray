...
typedef bool __fastcall(__closure *TBeforeAppendCallback)(
    SBeforeAppendCallbackParams *p);
typedef bool __fastcall(__closure *TAfterAppendCallback)(TShiftState _Shift,
                                                         CCustomObject *obj);
...
protected:
  ...
  CCustomObject *DefaultAddObject(TShiftState Shift,
                                  TBeforeAppendCallback before = 0,
                                  TAfterAppendCallback after = 0);
