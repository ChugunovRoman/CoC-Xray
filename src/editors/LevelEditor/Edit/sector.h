...
enum EVisible { fvNone, fvPartialInside, fvPartialOutside, fvFully };
...
public:
  ...
  bool AddMesh(CSceneObject *O,
               CEditableMesh *M); // возвращает добавлен ли объект
  int DelMesh(CSceneObject *O,
              CEditableMesh *M); // 0-не удален 1-удален 2-удален сектор вообще
