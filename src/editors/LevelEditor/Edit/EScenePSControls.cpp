...
//
//------------------------------------------------------------------------------
__fastcall TUI_ControlPSAdd::TUI_ControlPSAdd(int st, int act,
                                              ESceneToolBase *parent)
    : TUI_CustomControl(st, act, parent) {}

bool __fastcall TUI_ControlPSAdd::AfterAppendCallback(TShiftState Shift,
                                                      CCustomObject *obj) {
...
bool __fastcall TUI_ControlPSAdd::End(TShiftState _Shift) { return true; }
