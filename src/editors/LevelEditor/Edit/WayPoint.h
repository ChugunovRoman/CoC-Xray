...
protected:
  ...
  void __stdcall FindWPByName(LPCSTR new_name, bool &res) {
    res = !!FindWayPoint(new_name);
  }
  bool __stdcall OnWayPointNameAfterEdit(PropValue *sender,
                                         shared_str &edit_val);
...
public:
  ...
  virtual bool RayPick(float &distance, const Fvector &S, const Fvector &D,
