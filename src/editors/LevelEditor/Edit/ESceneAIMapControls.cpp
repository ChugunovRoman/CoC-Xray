...
// Node Add
//------------------------------------------------------------------------------
TUI_ControlAIMapNodeAdd::TUI_ControlAIMapNodeAdd(int st, int act,
...
bool __fastcall TUI_ControlAIMapNodeAdd::Start(TShiftState Shift) {
  ...
  if (S->PickObjects(p, UI->m_CurrentRStart, UI->m_CurrentRDir, UI->ZFar())) {
    ...
    append_nodes =
        S->AddNode(p, ((TfraAIMap *)S->pFrame)->ebIgnoreConstraints->Down,
                   ((TfraAIMap *)S->pFrame)->ebAutoLink->Down, S->m_BrushSize);
...
// Node Move
//------------------------------------------------------------------------------------
TUI_ControlAIMapNodeMove::TUI_ControlAIMapNodeMove(int st, int act,
                                                   ESceneToolBase *parent)
    : TUI_CustomControl(st, act, parent) {}
...
// Rotate Node
//------------------------------------------------------------------------------------
TUI_ControlAIMapNodeRotate::TUI_ControlAIMapNodeRotate(int st, int act,
                                                       ESceneToolBase *parent)
    : TUI_CustomControl(st, act, parent) {}
