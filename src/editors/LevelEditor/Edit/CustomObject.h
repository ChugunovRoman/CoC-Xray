...
public:
  ...
  void __stdcall OnMotionCommandsClick(ButtonValue *value, bool &bModif,
                                       bool &bSafe);
  void __stdcall OnMotionFilesClick(ButtonValue *value, bool &bModif,
                                    bool &bSafe);
  void __stdcall OnMotionControlClick(ButtonValue *value, bool &bModif,
                                      bool &bSafe);
...
public:
  ...
  virtual bool RaySelect(int flag, const Fvector &start, const Fvector &dir,
                         bool bRayTest = false); // flag 1,0,-1 (-1 invert)
  virtual bool FrustumSelect(int flag, const CFrustum &frustum);
  virtual bool RayPick(float &dist, const Fvector &start, const Fvector &dir,
  ...
  virtual void ScalePivot(const Fmatrix &prev_inv, const Fmatrix &current,
                          Fvector &amount);
  ...
  virtual bool OnSelectionRemove() {
    return true;
  } // возвращает можно ли его удалять вообще
...
public:
  static void SnapMove(Fvector &pos, Fvector &rot, const Fmatrix &rotRP,
