...
typedef fastdelegate::FastDelegate3<const AnsiString &, AnsiString &, bool &>
    TOnCodeInsight;
...
class XR_EPROPS_API TfrmText : public TForm {
  ...
  void __fastcall mmTextKeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
...
public:
  ...
  static TfrmText *__fastcall CreateForm(
      AnsiString &text, LPCSTR caption = "Text", u32 flags = 0, int lim = 0,
      LPCSTR apply_name = "Apply", TOnApplyClick on_apply = 0,
      TOnCloseClick on_close = 0, TOnCodeInsight on_insight = 0);
  static bool __fastcall RunEditor(AnsiString &text, LPCSTR caption = "Text",
                                   u32 flags = 0, int lim = 0,
                                   LPCSTR apply_name = "Apply",
                                   TOnApplyClick on_apply = 0,
                                   TOnCloseClick on_close = 0,
