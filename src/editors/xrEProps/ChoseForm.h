...
class XR_EPROPS_API TfrmChoseItem : public TForm {
  ...
  void __fastcall tvMultiStartDrag(TObject *Sender, TDragObject *&DragObject);
...
public: // User declarations
  ...
  static int __fastcall SelectItem(u32 choose_ID, LPCSTR &dest, int sel_cnt = 1,
                                   LPCSTR init_name = 0,
  ...
  static void AppendEvents(u32 choose_ID, LPCSTR caption,
                           TOnChooseFillItems on_fill,
                           TOnChooseSelectItem on_sel, TOnDrawThumbnail on_thm,
