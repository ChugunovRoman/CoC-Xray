...
//
bool MNormalMapConverter::convertToNormalMap(unsigned char *inImagePtr,
                                             unsigned int width,
                                             unsigned int height,
  ...
  //
  if (NULL == outImagePtr) {
    convertToNormalMap_InPlace(inImagePtr, width, height, outputPixelFormat,
                               bumpScale);
  } else {
...
bool MNormalMapConverter::convertToNormalMap_InPlace(
    unsigned char *inImagePtr, unsigned int width, unsigned int height,
...
bool MNormalMapConverter::convertToHeightMap(unsigned char *inImagePtr,
                                             unsigned int width,
                                             unsigned int height,
                                             OutFormatType outputPixelFormat,
                                             float heightScale,
