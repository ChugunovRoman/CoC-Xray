...
public:
  ...
  virtual MStatus geometry(const MDrawRequest &request, M3dView &view, int prim,
...
protected:
  ...
  // Callbacks that we monitor so we can release OpenGL-dependant resources
  // before their context gets destroyed.
