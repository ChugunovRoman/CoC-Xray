...
MStatus CXRayCameraExport::reader(const MFileObject &file,
...
MStatus CXRayCameraExport::writer(const MFileObject &file,
                                  const MString &optionsString,
                                  FileAccessMode mode) {
...
CXRayCameraExport::identifyFile(const MFileObject &fileName, const char *buffer,
                                short size) const {
