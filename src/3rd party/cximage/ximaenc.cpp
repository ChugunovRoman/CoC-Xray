 ...
 * pointers. \param hFile: file handle. \param pImages: array of CxImage
 * pointers. \param pagecount: number of images. \param imagetype: can be
 * CXIMAGE_FORMAT_TIF or CXIMAGE_FORMAT_GIF. \return true if everything is ok
 */
bool CxImage::Encode(FILE *hFile, CxImage **pImages, int pagecount,
                     DWORD imagetype) {
  CxIOFile file(hFile);
...
/**
 * Saves to disk or memory pagecount images, referenced by an array of CxImage
 * pointers. \param hFile: file handle (CxMemFile or CxIOFile), with write
 * access. \param pImages: array of CxImage pointers. \param pagecount: number
 * of images. \param imagetype: can be CXIMAGE_FORMAT_TIF, CXIMAGE_FORMAT_GIF or
 * CXIMAGE_FORMAT_ICO. \return true if everything is ok
 */
bool CxImage::Encode(CxFile *hFile, CxImage **pImages, int pagecount,
                     DWORD imagetype) {
#if CXIMAGE_SUPPORT_TIF
  if (imagetype == CXIMAGE_FORMAT_TIF) {
    CxImageTIF newima;
 ...
 * hinstance returned by LoadLibray. \return true if everything is ok
 */
