...
public:
  ...
  xr_dsa(u8 const p[public_key_length], u8 const q[private_key_length],
  ...
  shared_str const sign(private_key_t const &priv_key, u8 const *data,
                        u32 const data_size);
  bool verify(public_key_t const &pub_key, u8 const *data, u32 const data_size,
