...
static StrScanFmt strscan_hex(const uint8_t *p, TValue *o, StrScanFmt fmt,
                              uint32_t opt, int32_t ex2, int32_t neg,
                              uint32_t dig) {
  uint64_t x = 0;
  uint32_t i;
...
/* Parse octal number. */
static StrScanFmt strscan_oct(const uint8_t *p, TValue *o, StrScanFmt fmt,
                              int32_t neg, uint32_t dig) {
  uint64_t x = 0;
...
static StrScanFmt strscan_dec(const uint8_t *p, TValue *o, StrScanFmt fmt,
                              uint32_t opt, int32_t ex10, int32_t neg,
                              uint32_t dig) {
...
int LJ_FASTCALL lj_strscan_num(GCstr *str, TValue *o) {
  StrScanFmt fmt =
      lj_strscan_scan((const uint8_t *)strdata(str), o, STRSCAN_OPT_TONUM);
...
int LJ_FASTCALL lj_strscan_number(GCstr *str, TValue *o) {
  StrScanFmt fmt =
      lj_strscan_scan((const uint8_t *)strdata(str), o, STRSCAN_OPT_TOINT);
