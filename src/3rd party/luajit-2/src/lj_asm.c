...
#define opisfusableload(o)                                                     \
  ((o) == IR_ALOAD || (o) == IR_HLOAD || (o) == IR_ULOAD || (o) == IR_FLOAD || \
   (o) == IR_XLOAD || (o) == IR_SLOAD || (o) == IR_VLOAD)
...
static LJ_AINLINE void checkmclim(ASMState *as) {
  ...
  if (as->mcp + MCLIM_REDZONE < as->mcp_prev) {
    ...
    fprintf(stderr, "RED ZONE OVERFLOW: %p IR %04d  %02d %04d %04d\n", as->mcp,
            as->curins + 1 - REF_BIAS, ir->o, ir->op1 - REF_BIAS,
            ir->op2 - REF_BIAS);
    lua_assert(0);
  }
#endif
...
static void asm_collectargs(ASMState *as, IRIns *ir, const CCallInfo *ci,
                            IRRef *args) {
...
static void asm_phi(ASMState *as, IRIns *ir) {
  RegSet allow =
      ((!LJ_SOFTFP && irt_isfp(ir->t)) ? RSET_FPR : RSET_GPR) & ~as->phiset;
