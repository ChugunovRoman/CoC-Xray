...
#define IRFPMDEF(_)                                                            \
  ...
  _(TRUNC) /* Must be first and in this order. */                              \
      _(SQRT) _(EXP) _(EXP2) _(LOG) _(LOG2) _(LOG10) _(SIN) _(COS) _(TAN)      \
          _(OTHER)
...
#define IRTDEF(_)                                                              \
  _(NIL, 4)                                                                    \
  _(FALSE, 4)                                                                  \
  _(TRUE, 4) _(LIGHTUD, LJ_64 ? 8 : 4) _(STR, 4) _(P32, 4) _(THREAD, 4)        \
      _(PROTO, 4) _(FUNC, 4) _(P64, 8) _(CDATA, 4) _(TAB, 4) _(UDATA, 4)       \
