...
static int ll_loadfunc(lua_State *L, const char *path, const char *name,
                       int r) {
...
static const luaL_Reg package_lib[] = {{"loadlib", lj_cf_package_loadlib},
...
LUALIB_API int luaopen_package(lua_State *L) {
  ...
  lua_createtable(L, sizeof(package_loaders) / sizeof(package_loaders[0]) - 1,
                  0);
