...
TEMPLATE_SPECIALIZATION
typename MEMORY_ALLOCATOR::pointer
MEMORY_ALLOCATOR::address(reference value) const {
  return (&value);
}

TEMPLATE_SPECIALIZATION
typename MEMORY_ALLOCATOR::const_pointer
MEMORY_ALLOCATOR::address(const_reference value) const {
  return (&value);
}

TEMPLATE_SPECIALIZATION
typename MEMORY_ALLOCATOR::pointer
MEMORY_ALLOCATOR::allocate(size_type const n, void const *const p = 0) const {
