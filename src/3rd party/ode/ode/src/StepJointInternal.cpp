...
#define DOT6(A, B)                                                             \
  (A[0] * B[0] + A[1] * B[1] + A[2] * B[2] + A[4] * B[4] + A[5] * B[5] +       \
   A[6] * B[6])
...
#define SZM 3
void dInternalStepJointContact(dxWorld *world, dxBody *body[2], dReal *GI[2],
                               dReal *GinvI[2], dxJoint *joint,
                               dxJoint::Info1 info, dxJoint::Info2 Jinfo,
                               dReal stepsize) {
  int i, j, k;
#ifdef TIMING
