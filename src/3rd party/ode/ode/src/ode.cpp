...
void dBodyAddForceAtPos(dBodyID b, dReal fx, dReal fy, dReal fz, dReal px,
                        dReal py, dReal pz) {
  dAASSERT(b);
  b->facc[0] += fx;
  b->facc[1] += fy;
...
void dBodyAddForceAtRelPos(dBodyID b, dReal fx, dReal fy, dReal fz, dReal px,
                           dReal py, dReal pz) {
  dAASSERT(b);
  dVector3 prel, f, p;
  f[0] = fx;
...
void dBodyAddRelForceAtPos(dBodyID b, dReal fx, dReal fy, dReal fz, dReal px,
                           dReal py, dReal pz) {
  dAASSERT(b);
  dVector3 frel, f;
  frel[0] = fx;
...
void dBodyAddRelForceAtRelPos(dBodyID b, dReal fx, dReal fy, dReal fz, dReal px,
                              dReal py, dReal pz) {
  dAASSERT(b);
...
void dJointAttach(dxJoint *joint, dxBody *body1, dxBody *body2) {
  ...
  dUASSERT(
      !((joint->flags & dJOINT_TWOBODIES) && ((body1 != 0) ^ (body2 != 0))),
...
void dWorldImpulseToForce(dWorldID w, dReal stepsize, dReal ix, dReal iy,
