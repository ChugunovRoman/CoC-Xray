...
template <class BaseClass> class Pointer {
public:
  ...
  template <class OtherBase> Pointer(const Pointer<OtherBase> &tc) {
  ...
  //@{
  /** Other type assignment. */
  template <class OtherBase> void operator=(const Pointer<OtherBase> &tc) {
