...
public:
  ...
  //! Access to results. mIndices is a list of indices in sorted order, i.e. in
  //! the order you may further process your data
  inline uint32 *indices() const { return mIndices; }

  //! mIndices2 gets trashed on calling the sort routine, but otherwise you can
  //! recycle it the way you want.
