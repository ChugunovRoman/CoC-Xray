...
NVIMAGE_API bool saveFloat(const char *fileName, const FloatImage *fimage,
...
NVIMAGE_API bool saveFloatTIFF(const char *fileName, const FloatImage *fimage,
                               uint base_component, uint num_components);
#endif
...
NVIMAGE_API bool saveFloatEXR(const char *fileName, const FloatImage *fimage,
                              uint base_component, uint num_components);
#endif
