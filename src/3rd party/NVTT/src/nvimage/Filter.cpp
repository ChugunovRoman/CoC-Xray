...
void Kernel2::initSobel() {
  if (m_windowSize == 3) {
    ...
    float elements[] = {-1, -2, -3, -4, 0,  4,  3,  2,  1,  -2, -3, -4, -5, 0,
                        5,  4,  3,  2,  -3, -4, -5, -6, 0,  6,  5,  4,  3,  -4,
                        -5, -6, -7, 0,  7,  6,  5,  4,  -5, -6, -7, -8, 0,  8,
                        7,  6,  5,  -4, -5, -6, -7, 0,  7,  6,  5,  4,  -3, -4,
                        -5, -6, 0,  6,  5,  4,  3,  -2, -3, -4, -5, 0,  5,  4,
                        3,  2,  -1, -2, -3, -4, 0,  4,  3,  2,  1};
...
void Kernel2::initBlendedSobel(const Vector4 &scale) {
  ...
  {
    const float elements[] = {-1, -2, 0,  2,  1, -2, -3, 0,  3,  2, -3, -4, 0,
                              4,  3,  -2, -3, 0, 3,  2,  -1, -2, 0, 2,  1};
...
PolyphaseKernel::PolyphaseKernel(const Filter &f, uint srcLength,
                                 uint dstLength, int samples /*= 32*/) {
  nvDebugCheck(samples > 0);
