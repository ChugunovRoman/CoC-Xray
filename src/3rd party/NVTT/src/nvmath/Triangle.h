...
NVMATH_API bool triBoxOverlap(Vector3::Arg boxcenter, Vector3::Arg boxhalfsize,
...
NVMATH_API bool rayTest_Moller(const Triangle &t, Vector3::Arg orig,
                               Vector3::Arg dir, float *out_t, float *out_u,
                               float *out_v);

inline bool rayTest(const Triangle &t, Vector3::Arg orig, Vector3::Arg dir,
