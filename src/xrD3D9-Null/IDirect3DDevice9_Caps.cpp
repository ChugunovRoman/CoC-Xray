...
HRESULT xrIDirect3DDevice9::GetDeviceCaps(D3DCAPS9 *pCaps) {
  ...
  pCaps->PresentationIntervals =
      D3DPRESENT_INTERVAL_IMMEDIATE; // see wglSwapIntervalEXT
  ...
  pCaps->RasterCaps =
      ...
      D3DPRASTERCAPS_ANISOTROPY | D3DPRASTERCAPS_WBUFFER | D3DPRASTERCAPS_WFOG |
  ...
  pCaps->SrcBlendCaps = D3DPBLENDCAPS_ZERO | D3DPBLENDCAPS_ONE |
  ...
  pCaps->TextureFilterCaps =
      ...
      D3DPTFILTERCAPS_MAGFPYRAMIDALQUAD | D3DPTFILTERCAPS_MAGFGAUSSIANQUAD;
  ...
  pCaps->FVFCaps = D3DFVFCAPS_TEXCOORDCOUNTMASK |
                   D3DFVFCAPS_DONOTSTRIPELEMENTS | D3DFVFCAPS_PSIZE;
  ...
  pCaps->DevCaps2 = D3DDEVCAPS2_STREAMOFFSET | D3DDEVCAPS2_DMAPNPATCH |
  ...
  pCaps->DeclTypes = D3DDTCAPS_UBYTE4 | D3DDTCAPS_UBYTE4N | D3DDTCAPS_SHORT2N |
                     D3DDTCAPS_SHORT4N | D3DDTCAPS_USHORT2N |
                     D3DDTCAPS_USHORT4N | D3DDTCAPS_UDEC3 | D3DDTCAPS_DEC3N |
  ...
  pCaps->PS20Caps.Caps =
      D3DPS20CAPS_ARBITRARYSWIZZLE | D3DPS20CAPS_GRADIENTINSTRUCTIONS |
