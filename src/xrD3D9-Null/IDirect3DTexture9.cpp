...
xrIDirect3DTexture9::xrIDirect3DTexture9(IDirect3DDevice9 *pIDirect3DDevice9,
                                         UINT iWidth, UINT iHeight,
                                         UINT iLevels, DWORD iUsage,
...
HRESULT xrIDirect3DTexture9::SetPrivateData(REFGUID refguid, CONST void *pData,
                                            DWORD SizeOfData, DWORD Flags) {
  APIDEBUG("xrIDirect3DTexture9::SetPrivateData");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DTexture9::GetPrivateData(REFGUID refguid, void *pData,
                                            DWORD *pSizeOfData) {
...
HRESULT
xrIDirect3DTexture9::SetAutoGenFilterType(D3DTEXTUREFILTERTYPE iFilterType) {
...
HRESULT
xrIDirect3DTexture9::GetSurfaceLevel(UINT Level,
...
HRESULT xrIDirect3DTexture9::LockRect(UINT Level, D3DLOCKED_RECT *pLockedRect,
