...
public:
  ...
  HRESULT __stdcall CheckDeviceType(UINT Adapter, D3DDEVTYPE DevType,
  ...
  HRESULT __stdcall CheckDeviceFormatConversion(UINT Adapter,
                                                D3DDEVTYPE DeviceType,
                                                D3DFORMAT SourceFormat,
                                                D3DFORMAT TargetFormat);
  HRESULT __stdcall GetDeviceCaps(UINT Adapter, D3DDEVTYPE DeviceType,
                                  D3DCAPS9 *pCaps);
