...
public:
  xrIDirect3DVertexBuffer9(IDirect3DDevice9 *pIDirect3DDevice9, UINT iLength,
                           DWORD iUsage, DWORD iFVF, D3DPOOL iPool);
  /*** IUnknown methods ***/
  ...
  HRESULT __stdcall Lock(UINT OffsetToLock, UINT SizeToLock, void **ppbData,
                         DWORD Flags);
