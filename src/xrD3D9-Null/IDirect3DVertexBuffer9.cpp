...
xrIDirect3DVertexBuffer9::xrIDirect3DVertexBuffer9(
    IDirect3DDevice9 *pIDirect3DDevice9, UINT iLength, DWORD iUsage, DWORD iFVF,
    D3DPOOL iPool)
    : m_refCount(0) {
...
HRESULT __stdcall xrIDirect3DVertexBuffer9::GetDevice(
...
HRESULT __stdcall xrIDirect3DVertexBuffer9::SetPrivateData(REFGUID refguid,
                                                           CONST void *pData,
                                                           DWORD SizeOfData,
                                                           DWORD Flags) {
...
HRESULT __stdcall xrIDirect3DVertexBuffer9::GetPrivateData(REFGUID refguid,
                                                           void *pData,
                                                           DWORD *pSizeOfData) {
...
HRESULT __stdcall xrIDirect3DVertexBuffer9::Lock(UINT OffsetToLock,
                                                 UINT SizeToLock,
...
HRESULT __stdcall xrIDirect3DVertexBuffer9::GetDesc(
