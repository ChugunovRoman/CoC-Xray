...
xrIDirect3DIndexBuffer9::xrIDirect3DIndexBuffer9(
    IDirect3DDevice9 *pIDirect3DDevice9, UINT iLength, DWORD iUsage,
...
HRESULT __stdcall xrIDirect3DIndexBuffer9::GetDevice(
...
HRESULT __stdcall xrIDirect3DIndexBuffer9::SetPrivateData(REFGUID refguid,
                                                          CONST void *pData,
                                                          DWORD SizeOfData,
                                                          DWORD Flags) {
...
HRESULT __stdcall xrIDirect3DIndexBuffer9::GetPrivateData(REFGUID refguid,
                                                          void *pData,
                                                          DWORD *pSizeOfData) {
...
HRESULT __stdcall xrIDirect3DIndexBuffer9::Lock(UINT OffsetToLock,
                                                UINT SizeToLock, void **ppbData,
                                                DWORD Flags) {
