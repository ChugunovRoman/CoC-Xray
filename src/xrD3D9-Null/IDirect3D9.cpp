...
HRESULT
xrIDirect3D9::GetAdapterIdentifier(UINT Adapter, DWORD Flags,
...
HRESULT xrIDirect3D9::EnumAdapterModes(UINT Adapter, D3DFORMAT Format,
                                       UINT Mode, D3DDISPLAYMODE *pMode) {
  APIDEBUG("xrIDirect3D9::EnumAdapterModes");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3D9::GetAdapterDisplayMode(UINT Adapter,
                                            D3DDISPLAYMODE *pMode) {
  APIDEBUG("xrIDirect3D9::GetAdapterDisplayMode");
  pMode->Format = D3DFMT_A8R8G8B8;
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3D9::CheckDeviceType(UINT Adapter, D3DDEVTYPE DevType,
...
HRESULT xrIDirect3D9::CheckDeviceFormat(UINT Adapter, D3DDEVTYPE DeviceType,
...
HRESULT xrIDirect3D9::CheckDeviceMultiSampleType(
...
HRESULT xrIDirect3D9::CheckDepthStencilMatch(UINT Adapter,
...
HRESULT xrIDirect3D9::CheckDeviceFormatConversion(UINT Adapter,
                                                  D3DDEVTYPE DeviceType,
...
HRESULT xrIDirect3D9::GetDeviceCaps(UINT Adapter, D3DDEVTYPE DeviceType,
                                    D3DCAPS9 *pCaps) {
...
HRESULT
xrIDirect3D9::CreateDevice(UINT Adapter, D3DDEVTYPE DeviceType,
