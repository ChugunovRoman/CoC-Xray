...
xrIDirect3DSurface9::xrIDirect3DSurface9(IDirect3DDevice9 *pIDirect3DDevice9,
                                         ...
                                         DWORD iMultisampleQuality)
    : Width(iWidth), Height(iHeight), Format(iFormat),
      MultiSampleType(iMultiSample), MultiSampleQuality(iMultisampleQuality),
      m_refCount(0) {
...
HRESULT xrIDirect3DSurface9::SetPrivateData(REFGUID refguid, CONST void *pData,
                                            DWORD SizeOfData, DWORD Flags) {
  APIDEBUG("xrIDirect3DSurface9::SetPrivateData");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DSurface9::GetPrivateData(REFGUID refguid, void *pData,
                                            DWORD *pSizeOfData) {
...
HRESULT xrIDirect3DSurface9::LockRect(D3DLOCKED_RECT *pLockedRect,
