...
xrIDirect3DDevice9::xrIDirect3DDevice9(
    IDirect3D9 *pDirect3D9, D3DPRESENT_PARAMETERS *pPresentationParameters)
    : m_refCount(0) {
  ...
  memcpy(&PresentParameters, pPresentationParameters,
...
HRESULT xrIDirect3DDevice9::QueryInterface(const IID &iid,
                                           void FAR *FAR *ppvObj) {
...
HRESULT xrIDirect3DDevice9::GetDisplayMode(UINT iSwapChain,
                                           D3DDISPLAYMODE *pMode) {
  APIDEBUG("xrIDirect3DDevice9::GetDisplayMode");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetCreationParameters(
    D3DDEVICE_CREATION_PARAMETERS *pParameters) {
  APIDEBUG("xrIDirect3DDevice9::GetCreationParameters");
  return HRESULT_Proc(S_OK);
};
HRESULT
xrIDirect3DDevice9::SetCursorProperties(UINT XHotSpot, UINT YHotSpot,
...
HRESULT xrIDirect3DDevice9::GetSwapChain(UINT iSwapChain,
                                         IDirect3DSwapChain9 **pSwapChain) {
...
HRESULT
xrIDirect3DDevice9::Reset(D3DPRESENT_PARAMETERS *pPresentationParameters) {
  APIDEBUG("xrIDirect3DDevice9::Reset");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::Present(CONST RECT *pSourceRect,
...
HRESULT xrIDirect3DDevice9::GetBackBuffer(UINT iSwapChain, UINT iBackBuffer,
                                          D3DBACKBUFFER_TYPE Type,
                                          IDirect3DSurface9 **ppBackBuffer) {
  APIDEBUG("xrIDirect3DDevice9::GetBackBuffer");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetRasterStatus(UINT iSwapChain,
...
void xrIDirect3DDevice9::SetGammaRamp(UINT iSwapChain, DWORD Flags,
...
HRESULT xrIDirect3DDevice9::CreateTexture(UINT Width, UINT Height, UINT Levels,
  ...
  *ppTexture = NULL;
  xrIDirect3DTexture9 *I =
      new xrIDirect3DTexture9(this, Width, Height, Levels, Usage, Format, Pool);
  *ppTexture = I;

  return HRESULT_Proc(S_OK);
};

HRESULT xrIDirect3DDevice9::CreateVolumeTexture(
...
HRESULT xrIDirect3DDevice9::CreateCubeTexture(
  ...
  *ppCubeTexture = NULL;
  xrIDirect3DCubeTexture9 *I = new xrIDirect3DCubeTexture9(
      this, EdgeLength, EdgeLength, Levels, Usage, Format, Pool);
  *ppCubeTexture = I;
...
HRESULT xrIDirect3DDevice9::CreateVertexBuffer(
  ...
  *ppVertexBuffer = NULL;
  xrIDirect3DVertexBuffer9 *I =
      new xrIDirect3DVertexBuffer9(this, Length, Usage, FVF, Pool);
  *ppVertexBuffer = I;

  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::CreateIndexBuffer(
    UINT Length, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool,
    IDirect3DIndexBuffer9 **ppIndexBuffer, HANDLE *pSharedHandle) {
  APIDEBUG("xrIDirect3DDevice9::CreateIndexBuffer");

  *ppIndexBuffer = NULL;
  xrIDirect3DIndexBuffer9 *I =
      new xrIDirect3DIndexBuffer9(this, Length, Usage, Format, Pool);
  *ppIndexBuffer = I;

  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::CreateRenderTarget(
...
HRESULT xrIDirect3DDevice9::CreateDepthStencilSurface(
    UINT Width, UINT Height, D3DFORMAT Format, D3DMULTISAMPLE_TYPE MultiSample,
...
HRESULT xrIDirect3DDevice9::UpdateSurface(
...
HRESULT
xrIDirect3DDevice9::UpdateTexture(IDirect3DBaseTexture9 *pSourceTexture,
                                  IDirect3DBaseTexture9 *pDestinationTexture) {
  APIDEBUG("xrIDirect3DDevice9::UpdateTexture");
  return HRESULT_Proc(S_OK);
};
HRESULT
xrIDirect3DDevice9::GetRenderTargetData(IDirect3DSurface9 *pRenderTarget,
                                        IDirect3DSurface9 *pDestSurface) {
  APIDEBUG("xrIDirect3DDevice9::GetRenderTargetData");
  return HRESULT_Proc(S_OK);
};
HRESULT
xrIDirect3DDevice9::GetFrontBufferData(UINT iSwapChain,
                                       IDirect3DSurface9 *pDestSurface) {
  APIDEBUG("xrIDirect3DDevice9::GetFrontBufferData");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::StretchRect(IDirect3DSurface9 *pSourceSurface,
...
HRESULT xrIDirect3DDevice9::ColorFill(IDirect3DSurface9 *pSurface,
...
HRESULT xrIDirect3DDevice9::SetRenderTarget(DWORD RenderTargetIndex,
                                            IDirect3DSurface9 *pRenderTarget) {
  APIDEBUG("xrIDirect3DDevice9::SetRenderTarget");
  return HRESULT_Proc(S_OK);
};
HRESULT
xrIDirect3DDevice9::GetRenderTarget(DWORD RenderTargetIndex,
                                    IDirect3DSurface9 **ppRenderTarget) {
  APIDEBUG("xrIDirect3DDevice9::GetRenderTarget");
  return HRESULT_Proc(S_OK);
};
HRESULT
xrIDirect3DDevice9::SetDepthStencilSurface(IDirect3DSurface9 *pNewZStencil) {
  APIDEBUG("xrIDirect3DDevice9::SetDepthStencilSurface");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetDepthStencilSurface(
    IDirect3DSurface9 **ppZStencilSurface) {
  APIDEBUG("xrIDirect3DDevice9::GetDepthStencilSurface");

  *ppZStencilSurface = NULL;
  xrIDirect3DSurface9 *I = new xrIDirect3DSurface9(this, 0, 0, D3DFORMAT(0),
                                                   D3DMULTISAMPLE_TYPE(0), 0);
  *ppZStencilSurface = I;
...
HRESULT xrIDirect3DDevice9::Clear(DWORD Count, CONST D3DRECT *pRects,
                                  DWORD Flags, D3DCOLOR Color, float Z,
                                  DWORD Stencil) {
  APIDEBUG("xrIDirect3DDevice9::Clear");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::SetTransform(D3DTRANSFORMSTATETYPE State,
                                         CONST D3DMATRIX *pMatrix) {
  APIDEBUG("xrIDirect3DDevice9::SetTransform");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetTransform(D3DTRANSFORMSTATETYPE State,
                                         D3DMATRIX *pMatrix) {
  APIDEBUG("xrIDirect3DDevice9::GetTransform");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::MultiplyTransform(D3DTRANSFORMSTATETYPE,
                                              CONST D3DMATRIX *) {
...
HRESULT xrIDirect3DDevice9::SetRenderState(D3DRENDERSTATETYPE State,
                                           DWORD Value) {
  APIDEBUG("xrIDirect3DDevice9::SetRenderState");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetRenderState(D3DRENDERSTATETYPE State,
                                           DWORD *pValue) {
  APIDEBUG("xrIDirect3DDevice9::GetRenderState");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::CreateStateBlock(D3DSTATEBLOCKTYPE Type,
...
HRESULT xrIDirect3DDevice9::GetTexture(DWORD Stage,
                                       IDirect3DBaseTexture9 **ppTexture) {
  APIDEBUG("xrIDirect3DDevice9::GetTexture");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::SetTexture(DWORD Stage,
                                       IDirect3DBaseTexture9 *pTexture) {
  APIDEBUG("xrIDirect3DDevice9::SetTexture");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetTextureStageState(DWORD Stage,
                                                 D3DTEXTURESTAGESTATETYPE Type,
                                                 DWORD *pValue) {
  APIDEBUG("xrIDirect3DDevice9::GetTextureStageState");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::SetTextureStageState(DWORD Stage,
                                                 D3DTEXTURESTAGESTATETYPE Type,
                                                 DWORD Value) {
  APIDEBUG("xrIDirect3DDevice9::SetTextureStageState");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetSamplerState(DWORD Sampler,
                                            D3DSAMPLERSTATETYPE Type,
                                            DWORD *pValue) {
  APIDEBUG("xrIDirect3DDevice9::GetSamplerState");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::SetSamplerState(DWORD Sampler,
                                            D3DSAMPLERSTATETYPE Type,
                                            DWORD Value) {
...
HRESULT xrIDirect3DDevice9::SetPaletteEntries(UINT PaletteNumber,
                                              CONST PALETTEENTRY *pEntries) {
  APIDEBUG("xrIDirect3DDevice9::SetPaletteEntries");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetPaletteEntries(UINT PaletteNumber,
...
HRESULT xrIDirect3DDevice9::DrawPrimitive(D3DPRIMITIVETYPE PrimitiveType,
                                          UINT StartVertex,
                                          UINT PrimitiveCount) {
...
HRESULT
xrIDirect3DDevice9::DrawIndexedPrimitive(D3DPRIMITIVETYPE, INT BaseVertexIndex,
                                         UINT MinVertexIndex, UINT NumVertices,
                                         UINT startIndex, UINT primCount) {
  APIDEBUG("xrIDirect3DDevice9::DrawIndexedPrimitive");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::DrawPrimitiveUP(D3DPRIMITIVETYPE PrimitiveType,
                                            UINT PrimitiveCount,
...
HRESULT xrIDirect3DDevice9::DrawIndexedPrimitiveUP(
...
HRESULT xrIDirect3DDevice9::ProcessVertices(
...
HRESULT
xrIDirect3DDevice9::SetVertexDeclaration(IDirect3DVertexDeclaration9 *pDecl) {
  APIDEBUG("xrIDirect3DDevice9::SetVertexDeclaration");
  return HRESULT_Proc(S_OK);
};
HRESULT
xrIDirect3DDevice9::GetVertexDeclaration(IDirect3DVertexDeclaration9 **ppDecl) {
...
HRESULT
xrIDirect3DDevice9::CreateVertexShader(CONST DWORD *pFunction,
...
HRESULT xrIDirect3DDevice9::SetVertexShaderConstantF(UINT StartRegister,
                                                     CONST float *pConstantData,
                                                     UINT Vector4fCount) {
  APIDEBUG("xrIDirect3DDevice9::SetVertexShaderConstantF");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetVertexShaderConstantF(UINT StartRegister,
                                                     float *pConstantData,
                                                     UINT Vector4fCount) {
  APIDEBUG("xrIDirect3DDevice9::GetVertexShaderConstantF");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::SetVertexShaderConstantI(UINT StartRegister,
                                                     CONST int *pConstantData,
                                                     UINT Vector4iCount) {
  APIDEBUG("xrIDirect3DDevice9::SetVertexShaderConstantI");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetVertexShaderConstantI(UINT StartRegister,
                                                     int *pConstantData,
                                                     UINT Vector4iCount) {
  APIDEBUG("xrIDirect3DDevice9::GetVertexShaderConstantI");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::SetVertexShaderConstantB(UINT StartRegister,
                                                     CONST BOOL *pConstantData,
                                                     UINT BoolCount) {
  APIDEBUG("xrIDirect3DDevice9::SetVertexShaderConstantB");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetVertexShaderConstantB(UINT StartRegister,
                                                     BOOL *pConstantData,
                                                     UINT BoolCount) {
  APIDEBUG("xrIDirect3DDevice9::GetVertexShaderConstantB");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::SetStreamSource(UINT StreamNumber,
...
HRESULT
xrIDirect3DDevice9::GetStreamSource(UINT StreamNumber,
                                    IDirect3DVertexBuffer9 **ppStreamData,
                                    UINT *pOffsetInBytes, UINT *pStride) {
  APIDEBUG("xrIDirect3DDevice9::GetStreamSource");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::SetStreamSourceFreq(UINT StreamNumber,
                                                UINT Setting) {
  APIDEBUG("xrIDirect3DDevice9::SetStreamSourceFreq");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetStreamSourceFreq(UINT StreamNumber,
                                                UINT *pSetting) {
...
HRESULT
xrIDirect3DDevice9::CreatePixelShader(CONST DWORD *pFunction,
...
HRESULT xrIDirect3DDevice9::SetPixelShaderConstantF(UINT StartRegister,
                                                    CONST float *pConstantData,
                                                    UINT Vector4fCount) {
  APIDEBUG("xrIDirect3DDevice9::SetPixelShaderConstantF");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetPixelShaderConstantF(UINT StartRegister,
                                                    float *pConstantData,
                                                    UINT Vector4fCount) {
  APIDEBUG("xrIDirect3DDevice9::GetPixelShaderConstantF");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::SetPixelShaderConstantI(UINT StartRegister,
                                                    CONST int *pConstantData,
                                                    UINT Vector4iCount) {
  APIDEBUG("xrIDirect3DDevice9::SetPixelShaderConstantI");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetPixelShaderConstantI(UINT StartRegister,
                                                    int *pConstantData,
                                                    UINT Vector4iCount) {
  APIDEBUG("xrIDirect3DDevice9::GetPixelShaderConstantI");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::SetPixelShaderConstantB(UINT StartRegister,
                                                    CONST BOOL *pConstantData,
                                                    UINT BoolCount) {
  APIDEBUG("xrIDirect3DDevice9::SetPixelShaderConstantB");
  return HRESULT_Proc(S_OK);
};
HRESULT xrIDirect3DDevice9::GetPixelShaderConstantB(UINT StartRegister,
                                                    BOOL *pConstantData,
                                                    UINT BoolCount) {
...
HRESULT
xrIDirect3DDevice9::DrawRectPatch(UINT Handle, CONST float *pNumSegs,
                                  CONST D3DRECTPATCH_INFO *pRectPatchInfo) {
  APIDEBUG("xrIDirect3DDevice9::DrawRectPatch");
  return HRESULT_Proc(S_OK);
};
HRESULT
xrIDirect3DDevice9::DrawTriPatch(UINT Handle, CONST float *pNumSegs,
...
HRESULT xrIDirect3DDevice9::CreateQuery(D3DQUERYTYPE Type,
